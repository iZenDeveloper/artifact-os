# Shared option definitions for the Artifact OS Home Manager and NixOS
...
in {
  enable = lib.mkEnableOption "Artifact OS — local-first design product daemon";
  ...
  package = lib.mkOption {
    ...
    description = "The Artifact OS daemon package providing the `od` binary.";
  };
  ...
  webFrontend = {
    # The Artifact OS web frontend is a static SPA built by
