  ...
  it('confirms a plugin share action before starting the GitHub repo task', async () => {
    mockedListPlugins.mockResolvedValue([
      ...
      makePlugin(
        ...
        'Creates a public GitHub repository for a local Artifact OS plugin using the GitHub CLI.',
      ),
      makePlugin(
        ...
        'Opens a pull request that adds a local Artifact OS plugin to the Artifact OS community catalog.',
      ),
    ]);
