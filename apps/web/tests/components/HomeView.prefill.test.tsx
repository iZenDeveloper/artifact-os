...
const AUTHORING_PLUGIN = {
  ...
  manifest: {
    ...
    od: {
      ...
      useCase: { query: 'Create an Artifact OS plugin for {{pluginGoal}}.' },
      inputs: [
        {
          name: 'pluginGoal',
          type: 'string',
...
const LIVE_ARTIFACT_PLUGIN = {
  ...
  manifest: {
    ...
    title: 'Live Artifact',
    description: 'Create refreshable, auditable Artifact OS artifacts.',
    od: {
      kind: 'scenario',
      taskKind: 'new-generation',
      mode: 'prototype',
      scenario: 'live',
      useCase: {
        query: 'Create refreshable, auditable Artifact OS artifacts backed by connector or local data.',
      },
      context: {
