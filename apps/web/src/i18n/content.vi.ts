...
export const VI_SKILL_COPY: Record<string, { description?: string; examplePrompt?: string }> = {
  'ad-variants-generator': {
    description:
      'Ma trận ads Content Pro v2.2: strategy, góc, headline/primary/CTA ready-to-paste, không fake stats, cờ compliance.',
    examplePrompt:
      'Ma trận 10+ biến thể ads (headline + primary + CTA). Platform + offer + proof thật:',
  },
  'social-content-factory': {
    description:
      'Batch social gốc Content Pro v2.2: strategy, pillars ≤3, lịch tuần, ready-to-post từng bài, TikTok peak 10/10.',
    examplePrompt:
      'Batch social 1 tuần (5–7 bài) + strategy + ready-to-post. Brief / pillars:',
  },
  'hook-engine': {
    description:
      'Phòng lab hook: cặp weak→strong, multi-surface (cover XHS, TikTok 0–3s, LinkedIn L1, subject email, ads). Chỉ hooks — không full pack.',
    examplePrompt:
      'Hook lab yếu→mạnh cho topic này. Surfaces: XHS/TT/LI/email/ads. Score ≥9.0.',
  },
  'content-repurposer': {
    description:
      'Biến một source thành Content Pack đa nền (XHS, TikTok, LinkedIn, Facebook, YouTube, Threads, Email) theo Content Pro v2.2: strategy (objective/funnel/persona/offer), hook paradox, stakes cá nhân, ready-to-post, score ≥9.0.',
    examplePrompt:
      'Tạo Content Pro pack đa nền + strategy + ready-to-post. Source / topic:',
  },
  ...
  'ad-creative': {
    description:
      'Tạo và iterate creative quảng cáo: headlines, descriptions, primary text cho paid social / search.',
    examplePrompt:
      'Sinh biến thể creative ads (headline, mô tả, primary text) từ brief:',
  },
  ...
  'card-xiaohongshu': {
    description:
      'Thiết kế carousel / card Xiaohongshu (XHS) 1080×1440, hook cover mạnh, không card giữa mềm.',
    examplePrompt:
      'Carousel XHS 5–7 thẻ, hook cover + twist + offer. Topic:',
  },
  'color-expert': {
    description:
  ...
  'marketing-psychology': {
    description:
      'Áp dụng đòn bẩy tâm lý marketing trung thực vào hook/offer/CTA. Không scarcity giả, không social proof bịa.',
    examplePrompt:
      'Viết lại hook và CTA với loss aversion + reciprocity trung thực. Copy:',
  },
  'minimalist-ui': {
    description:
  ...
  'ui-ux-pro-max': {
    description:
      'Entri UI/UX Pro Max khusus katalog. Template, data, dan alur kerja pencarian upstream lengkap tidak disertakan dalam Artifact OS.',
    examplePrompt:
...
export const VI_DESIGN_SYSTEM_SUMMARIES: Record<string, string> = {
  'personal-minimal': 'Brand cá nhân tối giản — sạch, calm, vẫn có punch.',
  'personal-bold': 'Brand cá nhân năng lượng cao — creator bold.',
  'professional-clean': 'Brand client / B2B an toàn — sạch, chuyên nghiệp.',
...
export const VI_PROMPT_TEMPLATE_COPY: Record<string, Partial<Pick<PromptTemplateSummary, 'summary' | 'title'>>> = {
