...
export const vi: Dict = {
  ...
  'chat.amrCard.switchBody': 'Switch to Artifact OS Cloud — no API key setup needed. After you sign in, authorize, and top up, this run retries automatically.',
  ...
  'chat.amrCard.switchCta': 'Switch to Artifact OS Cloud & retry',
  'chat.amrError.authMessage': 'Your Artifact OS Cloud account isn\'t authorized yet. Authorize it and this run retries automatically.',
  'chat.amrError.balanceMessage': 'Your Artifact OS Cloud balance has run out. Top up to keep this run going.',
  ...
  'chat.amrBalanceGate.benefitsTitle': 'What you get with Artifact OS Cloud',
  ...
  'chat.amrBalanceGate.signedOutMessage': 'You\'re using the Artifact OS Cloud agent — sign in and this task can start right away.',
  ...
  'chat.runError.signInMessage.amr': 'The Artifact OS Cloud agent isn\'t signed in yet — sign in to start using it.',
  'chat.runError.signInMessage.other': '{agent} isn\'t signed in. Check its sign-in status locally. We recommend the Artifact OS Cloud agent — steadier and better value.',
  ...
  'chat.contextPrompt.referenceProject': 'Use the Artifact OS project “{name}” as reference context. Its local path is: {path}. Before designing or modifying anything, search and read this directory when useful.',
  ...
  'settings.welcomeTitle': 'Welcome to Artifact OS',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'Start from a brief',
  'settings.onboardingCreateBody': 'Describe the site, app, deck, image, or video you want. Artifact OS will create a project and keep the work editable.',
  ...
  'settings.onboardingMemoryCalloutBody': 'These answers seed your Memory profile. Artifact OS reuses it on every task — and keeps learning as you work.',
  ...
  'settings.onboardingSystemsTitle': 'Bring your brand',
  ...
  'settings.onboardingAmrModelSourceLabel': 'Artifact OS Cloud',
  ...
  'settings.onboardingStepDesignSystem': 'Build brand',
  ...
  'settings.onboardingGateTooltipAmr': 'The next steps run on AI — sign in to Artifact OS Cloud to continue.',
  ...
  'settings.onboardingDesignTitle': 'Brand',
  ...
  'settings.onboardingDesignIntroGenerateBody': 'Upload your brand from GitHub, Figma, images, or other assets. Stored as design-systems/<slug>/DESIGN.md (+ assets/).',
  ...
  'settings.onboardingDesignIntroSkipBody': 'Skip this step if you want to start without a brand.',
  ...
  'settings.onboardingUseDesignSystem': '🧩 Brand',
  ...
  'settings.agentInstall.pathHint': 'If you installed a CLI with npm or Homebrew and it still shows as not installed, ensure the tool\'s bin directory is on the PATH the Artifact OS daemon inherits (Terminal vs GUI apps can differ on macOS). See QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Open Install or Docs for your preferred agent.',
  'settings.agentInstall.stepAuth': 'Authenticate with the vendor CLI (sign in or add API credentials) before returning to Artifact OS.',
  ...
  'settings.amrCloud': 'Artifact OS Cloud',
  ...
  'settings.amrWalletRefreshTitle': 'Refresh Artifact OS Cloud wallet balance',
  ...
  'settings.amrAccountStatus': 'Artifact OS Cloud account status',
  ...
  'settings.mcpServerHint': 'Expose Artifact OS as an MCP server for your coding agent.',
  ...
  'settings.privacyHint': 'What data is shared with the Artifact OS team',
  'settings.privacyConsentKicker': 'Help us improve Artifact OS',
  'settings.privacyConsentLead': 'Sharing usage data helps us understand how Artifact OS performs in real workflows, so we can improve the parts that matter most to your experience.',
  ...
  "settings.allowSilentUpdatesDesc": "When an in-app update is ready, install it automatically the next time Artifact OS starts. Does not upgrade the current session. Installer updates still ask first.",
  ...
  'settings.updateQuitFailed': 'The installer opened, but Artifact OS could not quit automatically.',
  ...
  'settings.mcpHint': 'Let coding agents (Cursor, Claude Code, VS Code…) read your Artifact OS projects directly.',
  'settings.mcpDaemonError': 'Couldn\'t reach the local daemon to resolve install paths ({error}). Make sure Artifact OS is running, then reopen this panel.',
  ...
  'settings.mcpCapabilityDefault': 'Default to the project and file you have open in Artifact OS, so you can say "build this in my app" without re-stating which design.',
  'settings.mcpRunningNote': 'Artifact OS must be running for MCP tool calls to succeed. If you started your coding agent before opening Artifact OS, restart the agent so it can reach the live daemon.',
  'entry.tabDesigns': 'Designs',
  'entry.tabTemplates': 'Templates',
  'entry.tabDesignSystems': 'Brands',
  ...
  'entry.discordAria': 'Join the Artifact OS Discord',
  'entry.discordAriaWithOnline': 'Join the Artifact OS Discord - {online}',
  'entry.discordOnlineLabel': '{count} online',
  'entry.followXLabel': 'Follow @OpenDesignHQ on X',
  'entry.followThreadsLabel': 'Follow Artifact OS on Threads',
  'entry.youtubeLabel': 'Artifact OS on YouTube',
  'entry.followInstagramLabel': 'Follow @opendesign.ai on Instagram',
  'entry.followLinkedinLabel': 'Follow Artifact OS on LinkedIn',
  'entry.followXiaohongshuLabel': 'Follow Artifact OS on Xiaohongshu',
  ...
  'entry.navDesignSystems': 'Brands',
  'entry.navBrands': 'Brands',
  'entry.navIntegrations': 'Integrations',
  'entry.nav.workspace': 'Workspace',
  'entry.nav.recent': 'Gần đây',
  'entry.nav.settings': 'Cài đặt',
  'entry.nav.help': 'Trợ giúp',
  'workspaceTabs.project': 'Project',
  'workspaceTabs.pluginDetails': 'Plugin details',
  'workspaceTabs.marketplace': 'Marketplace',
  'homeHero.title': 'Hôm nay bạn tạo gì?',
  'homeHero.badge': 'Tạo content bằng AI',
  'homeHero.meta.featured': 'Nổi bật',
  'homeHero.meta.popular': 'Phổ biến',
  'homeHero.meta.aiRecommended': 'AI gợi ý',
  'homeHero.meta.new': 'Mới',
  'homeHero.workflow.featured': 'Featured',
  'homeHero.workflow.quickCreate': 'Quick Create',
  'homeHero.workflow.publishScale': 'Publish & Scale',
  'homeHero.featured.templatesCount': '18 templates',
  'homeHero.startWithTemplate': 'Bắt đầu từ template',
  'homeHero.moreFormats': 'Thêm format',
  'homeHero.startBlankProject': 'Dự án trống',
  'homeHero.linkSkillsPlugins': 'Skills & Plugins',
  'homeHero.linkDesignSystems': 'Brand / Design Systems',
  ...
  'homeHero.expertPicker.label': 'Expert',
  'homeHero.expertPicker.none': 'Mặc định',
  'homeHero.expertPicker.noneSummary': 'Designer Artifact OS chung — không gắn chuyên gia.',
  'homeHero.expertPicker.searchPlaceholder': 'Tìm expert',
  'homeHero.expertPicker.clear': 'Xóa expert',
  'homeHero.templatesScrollHint': 'Scroll up to explore more templates',
  'homeHero.templatesCollapse': 'Collapse templates',
  'homeHero.subtitlePrefix': 'From one idea → multi-platform in minutes',
  'homeHero.placeholder': 'Dán source, chọn Brand, hoặc mô tả content bạn cần…',
  'homeHero.placeholderActive': 'Mô tả thêm hoặc gửi để bắt đầu…',
  'homeHero.usingContext': 'Đang dùng {designSystem} · {brandMode}',
  'homeHero.noDesignSystem': 'Chưa chọn Brand',
  'homeHero.brandMode.label': 'Brand',
  'homeHero.brandMode.personal': 'Cá nhân',
  'homeHero.brandMode.client': 'Client',
  'homeHero.quickStartHeading': 'Bắt đầu nhanh',
  'homeHero.quickStartHint': 'Chọn kết quả — prompt sẽ được điền sẵn',
  'homeHero.pinCategory': 'Ghim danh mục',
  'homeHero.unpinCategory': 'Bỏ ghim',
  'homeHero.popularHeading': 'Gói phổ biến cho creator',
  'homeHero.popularHint': 'Pack gợi ý — một chạm để seed prompt',
  'homeHero.pack.pmfFailTitle': 'Pack PMF Fail',
  'homeHero.pack.pmfFailDesc': 'Vì sao sản phẩm tốt kẹt — story đa nền',
  'homeHero.pack.pmfFailPrompt':
    'Content Pro pack: vì sao sản phẩm tốt vẫn kẹt PMF. Paradox hook, stakes cá nhân, ready-to-post XHS/TikTok/LinkedIn.\n\nProduct / audience:\n',
  'homeHero.pack.mythBustTitle': 'Pack phá myth',
  'homeHero.pack.mythBustDesc': 'Phá một myth phổ biến bằng proof + offer',
  'homeHero.pack.mythBustPrompt':
    'Content Pro pack phá myth. Hook paradox, proof, insight drama, offer CTA. Platform priority: XHS + TikTok + LinkedIn.\n\nMyth / topic:\n',
  'homeHero.pack.personalBrandTitle': 'Pack personal brand',
  'homeHero.pack.personalBrandDesc': 'Batch social 1 tuần cho authority',
  'homeHero.pack.personalBrandPrompt':
    'Batch social Content Pro 1 tuần (5–7 bài) xây authority. Pillars ≤3, ready-to-post, scores ≥9.0.\n\nNiche / persona:\n',
  'homeHero.pack.launchWeekTitle': 'Pack tuần launch',
  'homeHero.pack.launchWeekDesc': 'Content theo ngày cho product drop',
  'homeHero.pack.launchWeekPrompt':
    'Lịch content tuần launch (ngày-by-ngày). Strategy conversion/awareness, offer rõ, ready-to-post.\n\nProduct / launch date:\n',
  'homeHero.pack.hookLabTitle': 'Phòng lab Hook Engine',
  'homeHero.pack.hookLabDesc': 'Dòng stop-scroll yếu→mạnh',
  'homeHero.pack.hookLabPrompt':
    'Hook Engine lab (chỉ hooks).\n\nStrategy: objective / funnel / persona:\nSurfaces: XHS · TikTok 0–3s · LinkedIn · Email · Ads\n\nSource / topic:\n',
  'homeHero.pack.xhsHooksTitle': 'Lab hook XHS',
  'homeHero.pack.xhsHooksDesc': 'Carousel 5–7 thẻ từ một topic',
  'homeHero.pack.xhsHooksPrompt':
    'Carousel XHS 5–7 thẻ (1080×1440). Hook cover mạnh, không card giữa mềm, twist + offer thẻ cuối. Topic:\n',
  'homeHero.pack.adTestTitle': 'Lab biến thể ads',
  'homeHero.pack.adTestDesc': 'Hook + headline cho test paid',
  'homeHero.pack.adTestPrompt':
    'Ma trận ads Content Pro v2.2 (headline/primary/CTA ready-to-paste) cho A/B. Strategy: objective / funnel / persona. Nền + offer + proof thật:\n',
  'homeHero.carousel.hint': 'Dán source, chọn brand, hoặc mô tả content bạn muốn',
  ...
  'homeHero.clearActivePlugin': 'Bỏ plugin',
  'homeHero.clearActiveSkill': 'Bỏ skill',
  ...
  'homeHero.forNewLine': 'xuống dòng',
  'homeHero.run': 'Chạy',
  'homeHero.typeSomethingToRun': 'Type something to run',
  'homeHero.promptExamples': 'Ví dụ prompt',
  'homeHero.footer.designSystem': 'Style',
  'homeHero.footer.autoDesignSystem': 'Auto',
  'homeHero.footer.autoDesignSystemSummary': 'Automatically matches the best brand and visual style for the current prompt.',
  ...
  'homeHero.chip.createBrandKit': 'Tạo Brand',
  ...
  'homeHero.chip.createBrandKitHint': 'Trích brand từ website (DESIGN.md + assets), rồi áp dụng trong mọi chat.',
  'homeHero.chip.createPluginHint': 'Author a reusable Artifact OS plugin and add it to My plugins.',
  'homeHero.chip.figmaHint': 'Migrate a Figma frame into the active brand.',
  ...
  'homeHero.chip.contentPack': 'Content Pack',
  'homeHero.chip.socialContent': 'Social Content',
  'homeHero.chip.carousel': 'Carousel / XHS',
  'homeHero.chip.shortVideo': 'Video ngắn / TikTok',
  'homeHero.chip.linkedinPost': 'Bài LinkedIn',
  'homeHero.chip.facebookPost': 'Bài Facebook',
  'homeHero.chip.youtube': 'YouTube',
  'homeHero.chip.threads': 'Threads / X',
  'homeHero.chip.email': 'Email',
  'homeHero.chip.adCreative': 'Quảng cáo',
  'homeHero.chip.repurpose': 'Tái sử dụng',
  'homeHero.chip.hookEngine': 'Phòng lab Hook',
  ...
  'homeHero.chip.createBrandKitDesc': 'Trích brand (DESIGN.md + assets)',
  'homeHero.chip.contentPackDesc': 'One prompt → every platform',
  'homeHero.chip.socialContentDesc': 'Batch bài social',
  'homeHero.chip.carouselDesc': 'Turn ideas into visual stories',
  'homeHero.chip.shortVideoDesc': 'Script + shots + voiceover',
  'homeHero.chip.linkedinPostDesc': 'Authority post chuyển đổi',
  'homeHero.chip.facebookPostDesc': 'Engaging posts for your audience',
  'homeHero.chip.youtubeDesc': 'Long-form videos that rank',
  'homeHero.chip.threadsDesc': 'Chuỗi text ngắn',
  'homeHero.chip.emailDesc': 'Launch campaigns faster',
  'homeHero.chip.adCreativeDesc': 'High-converting ad variations',
  'homeHero.chip.repurposeDesc': '1 source → nhiều format',
  'homeHero.chip.hookEngineDesc': 'Generate 50+ scroll-stopping hooks',
  ...
  'homeHero.chip.contentPackNext': 'Pack đa nền: caption, carousel, script short-video + visual direction (không render video).',
  'homeHero.chip.socialContentNext': 'Batch 1 tuần Content Pro v2.2: strategy, lịch, ready-to-post từng bài.',
  'homeHero.chip.carouselNext': 'Thiết kế carousel 5–7 thẻ dọc với hook cover mạnh.',
  'homeHero.chip.shortVideoNext': 'Script short 15–25s: kill hook, peak frame, shot list.',
  'homeHero.chip.linkedinPostNext': 'Bài LinkedIn gọn: mở paradox, câu hỏi sắc, soft offer.',
  'homeHero.chip.facebookPostNext': 'Bài Facebook feed: hook trước See more, giọng peer, offer CTA.',
  'homeHero.chip.youtubeNext': 'Gói YouTube: title, mô tả, hướng thumbnail (optional script Shorts).',
  'homeHero.chip.threadsNext': 'Chuỗi Threads / X với stakes cá nhân và CTA offer.',
  'homeHero.chip.emailNext': 'Subject + body email với một CTA offer rõ.',
  'homeHero.chip.adCreativeNext': 'Ma trận ads Content Pro v2.2 (headline / primary / CTA copy-paste).',
  'homeHero.chip.repurposeNext': 'Biến một bài thành năm format theo từng nền.',
  'homeHero.chip.hookEngineNext': 'Sinh hook yếu→mạnh cho cover, TikTok 0–3s, LinkedIn L1, subject, ads.',
  'homeHero.chipSeed.threads': 'Viết chuỗi Threads / X (4–8 post). P1 là hook mạnh nhất + stakes cá nhân; post cuối = offer CTA.\n\nTopic:\n',
  'homeHero.chipSeed.email': 'Viết pack email: 3–4 subject (1 subject paradox), body 120–250 từ, một CTA offer.\n\nTopic / segment list:\n',
  'homeHero.chipSeed.linkedinPost': 'Viết bài LinkedIn gọn (900–1600 ký tự): dòng 1 paradox, scene ngắn, 2–3 proof, insight, câu hỏi sắc, soft offer CTA.\n\nTopic:\n',
  'homeHero.chipSeed.facebookPost':
    'Viết bài Facebook feed (ưu tiên visual 4:5 1080×1350).\nHook trong 125 ký tự đầu (trước “Xem thêm”). Giọng peer/trò chuyện — không clone LinkedIn.\nGồm caption + hướng ảnh + first comment (tuỳ chọn) + hashtag (0–3) + giờ đăng + offer CTA.\n\nTopic / brief:\n',
  'homeHero.chipSeed.youtube':
    'Tạo gói YouTube (MVP: text + visual direction + script — không render video).\nGiao: 2–3 title (≤70 ký tự), mô tả (hook 2 dòng đầu + bullets + offer + link), hướng thumbnail 16:9 (≤5 từ trên ảnh).\nNếu short-form: script Shorts 15–60s, kill hook 0–3s, peak frame, shot list (title native YouTube).\n\nTopic / brief:\n',
  'homeHero.chip.webClonePromptSeed': 'Website URL to clone: ',
  'homeHero.outcomesHeading': 'Bắt đầu với format',
  'homeHero.outcome.multiPlatformPack': 'Tạo Content Pack đa nền tảng',
  'homeHero.outcome.multiPlatformPackPrompt':
    'Tạo Content Pro pack đa nền (XHS · TikTok · LinkedIn · Facebook · YouTube · Threads · Email) kèm strategy + ready-to-post.\nMVP: text + visual direction + script (không render video/MP4).\n\nStrategy: objective / funnel_stage / persona+pains / offer:\n\nSource:\n',
  'homeHero.outcome.repurposeFive': 'Tái sử dụng 1 bài → đa nền',
  'homeHero.outcome.repurposeFivePrompt':
    'Repurpose thành đa nền (XHS · TikTok · LinkedIn · Facebook · YouTube · Threads · Email) kèm strategy block + ready-to-post (caption/hashtag/alt/giờ đăng) từng nền.\n\nStrategy: objective / funnel / persona / offer:\n\nSource:\n',
  'homeHero.outcome.socialBatch': 'Batch social 1 tuần',
  'homeHero.outcome.socialBatchPrompt':
    'Tạo batch social Content Pro v2.2 (5–7 bài) kèm strategy + ready-to-post cho XHS, TikTok, LinkedIn, Facebook, YouTube, Threads.\n\nStrategy: objective / funnel / persona+pains / offer:\nPillars (≤3):\n\nTopic / brief:\n',
  'homeHero.outcome.xhsCarousel': 'Carousel XHS từ topic',
  'homeHero.outcome.xhsCarouselPrompt':
    'Thiết kế carousel XHS 5–7 thẻ (1080×1440). Hook cover mạnh, không card giữa mềm, twist + offer CTA thẻ cuối.\n\nTopic:\n',
  'homeHero.outcome.shortVideo': 'Script TikTok / Reels',
  'homeHero.outcome.shortVideoPrompt':
    'Tạo short TikTok / Reels (15–25s): kill hook 0–3s, energy map không đều, peak 10/10 cinematic, spoken + on-screen + shot list, offer CTA.\n\nTopic:\n',
  'homeHero.outcome.facebookPost': 'Bài Facebook feed',
  'homeHero.outcome.facebookPostPrompt':
    'Viết bài Facebook feed (ưu tiên visual 4:5 1080×1350). Hook 125 ký tự đầu, giọng peer, offer CTA, ready-to-post.\n\nTopic / brief:\n',
  'homeHero.outcome.youtube': 'YouTube title + thumb + mô tả',
  'homeHero.outcome.youtubePrompt':
    'Tạo gói YouTube: 2–3 title, mô tả, hướng thumbnail 16:9 (+ optional script Shorts). Không render video.\n\nTopic / brief:\n',
  'homeHero.outcome.adVariants': 'Biến thể quảng cáo từ brief',
  'homeHero.outcome.adVariantsPrompt':
    'Tạo ma trận ads Content Pro v2.2 (headline, primary text, CTA ready-to-paste). Strategy: objective / funnel / persona. Nền + offer + proof thật:\n',
  'homeHero.outcome.hookLab': 'Phòng lab hook (yếu → mạnh)',
  'homeHero.outcome.hookLabPrompt':
    'Hook Engine lab (chỉ hooks — không full pack).\n\nStrategy: objective / funnel_stage / persona+pains / language:\nSurfaces: XHS cover · TikTok 0–3s · LinkedIn L1 · Threads P1 · Email subjects · Ad headlines\n\nDeliver: cặp weak→strong, tag framework, 1 primary mỗi surface, score hook ≥9.0.\n\nSource / draft yếu / topic:\n',
  'homeWorkingDir.trigger': 'Chọn thư mục làm việc',
  'homeWorkingDir.pick': 'Chọn folder',
  'homeWorkingDir.replace': 'Đổi thư mục làm việc',
  'homeWorkingDir.recent': 'Folder gần đây',
  'homeWorkingDir.recentEmpty': 'Chưa có folder gần đây',
  'homeWorkingDir.clear': 'Gỡ thư mục làm việc',
  'homeWorkingDir.hint': 'Cho agent đọc folder local này (không import vào Design Files)',
  ...
  'handoff.amrWebsite': 'Visit Artifact OS Cloud',
  ...
  'handoff.promptIntro': 'Continue from this local Artifact OS project folder:',
  ...
  'designSystemPicker.select': 'Choose brand',
  'designSystemPicker.loading': 'Loading brands…',
  'designSystemPicker.searchPlaceholder': 'Search brands (title / category / summary)',
  'designSystemPicker.searchCompactPlaceholder': 'Search brands',
  'designSystemPicker.noneTitle': 'No brand',
  'designSystemPicker.noneSummary': 'No brand — the model freely improvises the visual style from your prompt.',
  'designSystemPicker.empty': 'No matching brands',
  'designSystemPicker.openPreview': 'Open preview',
  'designSystemPicker.loadingPreview': 'Loading preview…',
  'designSystemPicker.noPreview': 'No preview page. Open Brands to view the full preview.',
  'designSystemPicker.previewHint': 'Hover a brand to preview it',
  ...
  'brandSwitcher.personal': 'Personal',
  'brandSwitcher.client': 'Client',
  ...
  'recentProjects.continue': 'Tiếp tục',
  'recentProjects.duplicate': 'Nhân bản',
  'pluginsHome.title': 'Community',
  'pluginsHome.subtitle': 'Ready-to-use Artifact OS workflows bundled with this runtime. Pick one to load a starter prompt, or browse the registry for more.',
  'pluginsHome.browseRegistry': 'Browse registry',
  'pluginsHome.count': '{filtered} of {total}',
  'pluginsHome.loadingCatalog': 'Loading catalog…',
  'pluginsHome.emptyCatalog': 'Catalog is empty. Bundled plugins ship with Artifact OS and should appear here automatically — try restarting the daemon if this persists.',
  ...
  'pluginCard.contributeAria': 'Contribute {title} to Artifact OS',
  'pluginCard.contributeTitle': 'Contribute plugin to Artifact OS with a pull request',
  ...
  'integrations.lede': 'Connect external systems, bring MCP tools into your agent loop, and use Artifact OS from other IDEs, scripts, and automations.',
  ...
  'mcpClient.daemonError': 'Could not reach the local daemon. Make sure Artifact OS is running, then reopen this panel.',
  'mcpClient.saveFailed': 'Save failed. Check that the daemon is running and try again.',
  'useEverywhere.modalAria': 'Use Artifact OS everywhere',
  'useEverywhere.modalTitle': 'Use Artifact OS everywhere',
  'useEverywhere.modalSubtitle': 'Drop Artifact OS into any IDE, agent, or script — CLI, HTTP, MCP, and Skills. Use “Copy guide for an agent” and paste into Claude Code, Codex, Cursor, openclaw, or hermes to set up everything.',
  ...
  'useEverywhere.section.overview.heading': 'Artifact OS works wherever your agent works',
  'useEverywhere.section.overview.intro': 'Artifact OS is more than a window — it is a local privileged daemon (`od`) plus a Skills + Design-Systems + Atoms registry. Once it is running on your machine, any code agent (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, your own script) can drive generations, inspect projects, and produce design artifacts through four interchangeable surfaces.',
  'useEverywhere.section.overview.bullet1': 'CLI — `od <command>` for headless scripts, CI, and shell automation.',
  'useEverywhere.section.overview.bullet2': 'MCP server — wires Artifact OS as a Model Context Protocol server so any MCP-capable agent can list skills, run scenarios, and read artifacts.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — drop-in `SKILL.md` packs (Claude-compatible) that any agent already on your PATH can invoke without Artifact OS at all.',
  ...
  'useEverywhere.section.cli.heading': 'Drive Artifact OS from any shell',
  ...
  'useEverywhere.section.mcp.heading': 'Expose Artifact OS as an MCP server to any coding agent',
  'useEverywhere.section.mcp.intro': 'Artifact OS ships with a Model Context Protocol server (`od mcp`) that lets any MCP-capable client — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — discover Artifact OS tools (list skills, render previews, generate media, run plugins) without shelling out manually. The daemon publishes a ready-to-paste install snippet via `GET /api/mcp/install-info` for each major client.',
  ...
  'useEverywhere.section.mcp.footer': 'In the Artifact OS app, open Settings → Integrations to copy a client-specific install command (Cursor, Claude Code, Antigravity, VS Code) instead of editing JSON by hand.',
  ...
  'useEverywhere.section.skills.heading': 'Drop-in Skills for any agent — even without Artifact OS running',
  'useEverywhere.section.skills.intro': 'A Skill is a directory with a Claude-compatible `SKILL.md` (YAML front-matter + body). Artifact OS extends the format with the `od:` namespace (`mode`, `preview`, `design_system`, `inputs`, …) so the same artifact can be used both inside Artifact OS and by a vanilla agent like Claude Code, Codex, openclaw, or hermes. Discovery follows a precedence chain so projects can override their own skills.',
  ...
  'useEverywhere.section.skills.snippet1': 'Minimal SKILL.md (Claude-compatible front matter + Artifact OS extras)',
  ...
  'entry.githubStarAria': 'Star Artifact OS on GitHub',
  ...
  'newproj.locationDefault': 'Artifact OS projects',
  ...
  'newproj.dsCategoryFallback': 'Brand',
  'newproj.dsSearch': 'Search brands…',
  ...
  'newproj.dsEmpty': 'No brands match “{query}”.',
  ...
  'designs.cardNoBrand': 'Không brand',
  'designs.cardBrandLinked': 'Brand',
  ...
  'designs.status.awaitingInput': 'Cần input',
  ...
  'designs.tagBrand': 'Brand',
  'designs.tagContentPack': 'Content Pack',
  'designs.tagSocial': 'Social',
  'designs.tagCarousel': 'Carousel',
  'designs.tagShortVideo': 'Short Video',
  'designs.tagLinkedin': 'LinkedIn',
  'designs.tagFacebook': 'Facebook',
  'designs.tagYoutube': 'YouTube',
  'designs.tagEmail': 'Email',
  'designs.tagAd': 'Ad',
  'designs.tagHookEngine': 'Hook Lab',
  'designs.tagDesignSystem': 'Design System',
  ...
  'examples.tagDesignSystem': 'Brand',
  ...
  'ds.searchPlaceholder': 'Search brands…',
  'ds.emptyNoMatch': 'No brands match your search.',
  'ds.badgeDefault': 'DEFAULT',
  'ds.preview': 'Preview full system',
  'ds.previewTitle': 'Preview the full brand',
  'ds.categoryAll': 'All',
  ...
  'avatar.amrConsole': 'Artifact OS Cloud',
  ...
  'socialShare.openDesignSection': 'Share Artifact OS',
  'socialShare.openDesignTitle': 'Artifact OS on GitHub',
  'socialShare.openDesignText': 'Artifact OS is an open-source workspace for creating, editing, deploying, and handing off design artifacts.',
  ...
  'socialShare.projectTitle': '{title} · Artifact OS',
  'socialShare.projectText': 'Built with Artifact OS: {title}. View the deployed artifact and star the repo: {repo}',
  'socialShare.projectCopyText': 'Built with Artifact OS: {title}\n{url}\nArtifact OS repo: {repo}',
  ...
  'project.brandReadyTitle': '{name} brand is ready',
  'project.brandReadyTitleGeneric': 'Your brand is ready',
  'project.brandReadyCta': 'Preview in Brands',
  ...
  'project.brandReadyPreviewOpened': 'Brand preview opened.',
  ...
  'brandEnrichment.body': "Artifact OS will run a deeper extraction in the background, apply the right design-system skills automatically, and update this system in place. This can take 10-20 minutes; you can keep working.",
  ...
  'brandExtractionTranscript.user': 'Extract a brand from {source}.',
  'brandExtractionTranscript.doneTitle': 'Programmatic extraction finished for {name}.',
  'brandExtractionTranscript.doneBody': 'I created and registered the {designSystemId} brand from {source} (DESIGN.md + assets). It is ready to preview and use in content.',
  'brandExtractionTranscript.next': 'Next: refine this brand with an agent pass, or create new content using it.',
  ...
  'chat.activeFilePlaceholder': 'Ask Artifact OS to change {file}...',
  ...
  'chat.mode.design.solves': 'Use it when you want Artifact OS to generate files, update the workspace, or turn a brief into multimodal deliverables.',
  ...
  'chat.importSkills': 'Skills and brands',
  'chat.importProject': 'Reference another project',
  'chat.importDesignSystemHeader': 'Choose a brand',
  'chat.importDesignSystemBack': 'Back',
  'chat.importDesignSystemSearch': 'Search brands…',
  'chat.importDesignSystemEmpty': 'No brands match "{query}"',
  ...
  'chat.importDesignSystemSwitched': 'Brand switched to {title}',
  'chat.importDesignSystemFailed': 'Couldn\'t switch brand. Please try again.',
  'chat.importDesignSystemLoadFailed': 'Couldn\'t load brands.',
  ...
  'designBrowser.reference.kicker': 'Artifact OS browser',
  ...
  'chat.designToolbox.context.designSystem': 'Brand',
  ...
  'preview.shareTextDefault': 'Artifact OS template: {title}',
  ...
  'preview.errorBody': 'The example HTML failed to fetch. Make sure Artifact OS is running and try again.',
  'preview.retry': 'Retry',
  ...
  'previewRunStatus.analyzing': 'Đang dựng kiến trúc thông tin',
  'previewRunStatus.generating': 'Đang xây giải pháp thiết kế',
  'previewRunStatus.verifying': 'Đang kiểm tra bản giao',
  'previewRunStatus.succeeded': 'Thiết kế đã sẵn sàng',
  'previewRunStatus.failed': 'Giao hàng cần xử lý · Thử lại trong Chat',
  'previewRunStatus.elapsed': 'Đã chạy {time}',
  'previewRunStatus.stagesAria': 'Các giai đoạn tiến trình thiết kế',
  'previewRunStatus.stageAnalyze': 'Lên kế hoạch',
  'previewRunStatus.stageBuild': 'Xây dựng',
  'previewRunStatus.stageVerify': 'Kiểm tra',
  'previewRunStatus.hintShort': 'Preview cập nhật khi file được ghi',
  'previewRunStatus.hint': 'Vẫn đang chạy — content pack đầy đủ thường mất 1–2 phút',
  'previewRunStatus.hintLong': 'Vẫn đang chạy — job phức tạp có thể mất vài phút. Theo dõi thêm trong Chat',
  ...
  'designFiles.documentTemplate.goalBody': 'Describe what Artifact OS should generate, edit, or decide from this document.',
  ...
  'designFiles.documentTemplate.capabilityAgent': 'The Artifact OS agent can read, edit, and use this file as project context.',
  ...
  'designFiles.documentTemplate.nextBody': 'Review and edit this document, then ask Artifact OS to generate, revise, or operate from it.',

  'designFiles.projectMenu': 'Project actions',
  'designFiles.createDesignSystemFromProject': 'Create brand from this project',
  ...
  'designFiles.usefulInfoTip4': 'Pick a brand to keep generated content on-brand.',
  ...
  'designFiles.usefulInfoTip7': 'Enjoying Artifact OS? Star us on GitHub.',
  ...
  'designFiles.usefulInfoTip18': 'Subscribe to Artifact OS on YouTube for tutorials and demos.',
  'designFiles.usefulInfoTip19': 'Follow Artifact OS on LinkedIn for product news.',
  'designFiles.usefulInfoTip20': 'Follow Artifact OS on Xiaohongshu for tips and inspiration.',
  ...
  'fileViewer.viewportXhs': 'XHS',
  'fileViewer.viewportXhsTitle': 'Xiaohongshu 3:4 (1080×1440)',
  'fileViewer.viewportTiktok': 'TikTok',
  'fileViewer.viewportTiktokTitle': 'TikTok 9:16 (1080×1920)',
  'fileViewer.viewportLinkedin': 'LinkedIn',
  'fileViewer.viewportLinkedinTitle': 'LinkedIn 1:1 (1080×1080)',
  'fileViewer.viewportFacebook': 'Facebook',
  'fileViewer.viewportFacebookTitle': 'Facebook 4:5 (1080×1350)',
  'fileViewer.viewportYoutube': 'YouTube',
  'fileViewer.viewportYoutubeTitle': 'YouTube 16:9 (1920×1080)',
  'fileViewer.viewportPlatformSection': 'Platform preview',
  ...
  'fileViewer.exportClientPackage': 'Xuất Client Package',
  'fileViewer.exportClientPackageEmpty':
    'Không có caption hoặc HTML để đóng gói. Mở pack Content Pro trước.',
  ...
  'assistant.shareToOpenDesign': 'Share to Artifact OS',
  ...
  'assistant.feedbackReasonPositiveDesignSystem': 'Followed the brand',
  ...
  'assistant.feedbackReasonNegativeDesignSystem': 'Did not follow the brand',
  ...
  'nextStep.title': 'Bước tiếp theo',
  'nextStep.subtitle': 'Gợi ý tiếp theo — bấm để nháp vào chat (không tự chạy)',
  'nextStep.more': 'Thêm',
  'nextStep.moreBody': 'Chia sẻ, tải xuống, tạo brand, hoặc mở thêm công cụ thiết kế',
  'nextStep.share': 'Chia sẻ',
  'nextStep.download': 'Tải xuống',
  'nextStep.createDesignSystemTitle': 'Tạo brand',
  'nextStep.createDesignSystemBody': 'Nhân bản project thành workspace design-system và chạy agent từ toàn bộ file/reference hiện có.',
  'nextStep.createDesignSystemBusy': 'Đang tạo brand...',
  'nextStep.contribute': 'Đóng góp',
  ...
  'nextStep.projectContinueTitle': 'Tiếp tục làm',
  'nextStep.projectContinueBody': 'Tiếp từ lượt bị dừng và thực hiện bước cụ thể tiếp theo cho project này.',
  'nextStep.projectGenerateArtifactTitle': 'Tạo artifact',
  'nextStep.projectGenerateArtifactBody': 'Tạo deliverable preview chính còn thiếu từ hội thoại hiện tại.',
  'nextStep.designSystemAiRefineTitle': 'AI tinh chỉnh brand',
  'nextStep.designSystemAiRefineBody': 'Đo lại nguồn và củng cố token, giọng brand, chất lượng kit ngay tại chỗ.',
  'nextStep.designSystemAuditKitTitle': 'Audit token & kit',
  'nextStep.designSystemAuditKitBody': 'Kiểm tra tương phản, typography, spacing, độ phủ kit — rồi sửa các lỗ hổng quan trọng.',

  'nextStep.brandAiOptimizeTitle': 'Refine extracted brand',
  'nextStep.brandAiOptimizeBody': 'Starts an agent pass that re-extracts the source and updates this brand (DESIGN.md + assets) in place.',
  'nextStep.brandCreateDesignTitle': 'Create with this brand',
  'nextStep.brandCreateDesignBody': 'Start a new design using the extracted colors, type, assets, and system guidance.',
  'nextStep.brandCreateDesignPrompt': 'Create new content with the {designSystem} brand.',
  ...
  'qf.choose': 'Chọn…',
  'qf.customLabel': 'Câu trả lời tùy chỉnh',
  'qf.customPlaceholder': 'Nhập câu trả lời của bạn...',
  'qf.otherOption': 'Khác',
  ...
  'qf.submitDisabledTitle': 'Điền các mục bắt buộc trước',
  ...
  'pet.tabBuiltInHint': 'Curated companions bundled with Artifact OS — pick one and adopt.',
  ...
  'pet.codexBundledTitle': 'Ships with Artifact OS — no download needed.',
  ...
  'settings.designSystems': 'Brands',
  'settings.designSystemsHint': 'Manage which brands appear in the home gallery',
  'settings.designSystemsInstalled': 'Installed',
  'settings.designSystemsAdd': 'Add brand',
  ...
  'settings.designSystemsViewImported': 'View imported brand',
  ...
  'settings.projectLocationsDescription': 'Add work bases that can contain multiple Artifact OS project folders. New projects are saved as one folder inside the selected base.',
  ...
  'settings.libraryDesignSystems': 'Brands',
  ...
  'settings.memoryStarterProjectDesc': 'Artifact OS v0.5 — chat-driven design editor',
  ...
  'updater.availableBody': 'Artifact OS {version} is available. It will download before the installer can open.',
  ...
  'updater.installerOpenBody': 'The installer is open. Artifact OS is quitting so you can finish the update.',
  ...
  'updater.payloadReadyGeneric': 'A new Artifact OS update is ready. Artifact OS will close and restart automatically.',
  'updater.payloadReadyVersion': 'Artifact OS {version} is ready. Artifact OS will close and restart automatically.',
  'updater.quitButton': 'Quit Artifact OS',
  'updater.quitFailedBody': 'The installer is open, but Artifact OS could not quit. Quit Artifact OS before replacing the app.',
  'updater.quitFailedTitle': 'Could not quit',
  'updater.quitting': 'Quitting...',
  'updater.ready': 'Update ready',
  'updater.readyGeneric': 'A new version is ready. Artifact OS will close and open the installer.',
  'updater.readyVersion': 'Artifact OS {version} is ready. Artifact OS will close and open the installer.',
  ...
  'automations.proposalTargetDesignSystem': 'Brand',
  ...
  'automations.filterDesignSystems': 'Brands',
  ...
  'dsManager.createTitle': 'Create new brand',
  'dsManager.createBody': 'Teach Artifact OS your brand, product, code, assets, and design references.',
  'dsManager.createAction': 'Create',
  'dsManager.emptyMine': 'No brands yet. Create one from your product context (DESIGN.md + assets/), review the draft, then publish it for future content.',
  ...
  'dsManager.downloadTitle': 'Download brand (.zip)',
  'dsManager.downloadAria': 'Download {title} as a .zip',
  'dsManager.downloadFailed': 'Could not download the brand. Please try again.',
  ...
  'settings.customInstructionsDesc': 'Fixed instructions Artifact OS follows in every chat. These are not saved memories; use Memory for facts, preferences, and project context.',
  ...
  'brand.librarySubtitle': 'Teach Artifact OS your design systems — extract one from a website, then apply it in any chat.',
  ...
  'onboarding.buildBody': 'Artifact OS turns your brand into a reusable design system — then keeps everything you build on-brand and consistent.',
  ...
  'dsCreate.sourceSectionBody': 'Start with a GitHub repo, website, DESIGN.md, or files that show your style. Artifact OS first creates a usable system quickly, then AI can refine it inside the project.',
  ...
  'ds.extractionRunningBody': 'Artifact OS is updating this system in place.',
  ...
  'ds.repoConnectBannerBody': 'Connect GitHub so Artifact OS can read your repository and pull colors, type, and components into this design system.',
