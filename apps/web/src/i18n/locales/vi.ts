...
export const vi: Dict = {
  ...
  'homeHero.title': 'Bạn muốn tạo gì hôm nay?',
  ...
  'homeHero.chip.contentPackDesc': 'Gói đa nền tảng',
  'homeHero.chip.socialContentDesc': 'Batch bài social',
  'homeHero.chip.carouselDesc': '5–7 thẻ dọc',
  'homeHero.chip.shortVideoDesc': 'Script 15–25s + shot',
  'homeHero.chip.linkedinPostDesc': 'Authority post chuyển đổi',
  'homeHero.chip.facebookPostDesc': 'Caption feed + visual 4:5',
  'homeHero.chip.youtubeDesc': 'Title · thumb · mô tả',
  'homeHero.chip.threadsDesc': 'Chuỗi text ngắn',
  'homeHero.chip.emailDesc': 'Subject + body + 1 offer',
  'homeHero.chip.adCreativeDesc': 'Biến thể ads quy mô lớn',
  'homeHero.chip.repurposeDesc': '1 source → nhiều format',
  'homeHero.chip.hookEngineDesc': 'Chỉ dòng stop-scroll',
