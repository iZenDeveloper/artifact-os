...
export const zhCN: Dict = {
  ...
  'chat.amrPreflight.body': '当前模型配置不可用。可改用 Open Design 官方 AMR 模型继续当前任务，无需配置 API Key。',
  ...
  'chat.amrPreflight.meta': '按用量计费，登录并充值后任务会自动发送；底层运行 Claude Code、Codex 等官方代理。',
  'chat.amrPreflight.signInUseAmrCta': '登录并使用 AMR',
  'chat.amrPreflight.pendingNotice': '登录 AMR 后将自动发送当前任务。',
  'settings.amrRescueHint': '也可以使用 Open Design 官方 AMR 模型能力继续，无需配置 API Key。',
  'settings.amrRescueCta': '使用 AMR 官方模型能力',
