...
export const zhCN: Dict = {
  ...
  "handoff.download": "下载",
  "handoff.downloadFailed": "下载失败，请稍后重试。",
  "handoff.remoteOpen": "远程打开",
  "handoff.remoteOpenTitle": "在 Web 文件工作区中打开此项目",
  "handoff.webActionsTitle": "导出与打开选项",
  "handoff.openFolderUnavailable": "当前环境无法打开本机文件夹——项目位于远程或容器中的守护进程上。可改用复制路径、下载 .zip，或在 Web 工作区中打开。",
