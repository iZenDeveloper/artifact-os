...
export const zhCN: Dict = {
  ...
  "assistant.compactionActiveTitle": "正在压缩上下文",
  "assistant.compactionActiveDetail": "保留任务目标、关键决策和最近进度",
  "assistant.compactionCompletedTitle": "上下文已压缩",
  "assistant.compactionFailedTitle": "上下文压缩失败",
