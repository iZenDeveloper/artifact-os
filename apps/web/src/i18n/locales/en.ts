...
export const en: Dict = {
  ...
  'homeHero.title': 'What content will you create today?',
  ...
  'homeHero.chip.contentPackDesc': 'Multi-platform pack',
  'homeHero.chip.socialContentDesc': 'Batch posts across platforms',
  'homeHero.chip.carouselDesc': '5–7 vertical cards',
  'homeHero.chip.shortVideoDesc': '15–25s script + shots',
  'homeHero.chip.linkedinPostDesc': 'Authority posts that convert',
  'homeHero.chip.facebookPostDesc': 'Feed caption + 4:5 visual',
  'homeHero.chip.youtubeDesc': 'Title · thumb · description',
  'homeHero.chip.threadsDesc': 'Short-form text chains',
  'homeHero.chip.emailDesc': 'Subjects + body + one offer',
  'homeHero.chip.adCreativeDesc': 'Paid ad variants at scale',
  'homeHero.chip.repurposeDesc': '1 source → many formats',
  'homeHero.chip.hookEngineDesc': 'Stop-scroll lines only',
