...
export const en: Dict = {
  ...
  'homeHero.title': 'What are you creating today?',
  'homeHero.badge': 'AI-Powered Content Creation',
  'homeHero.meta.featured': 'Featured',
  'homeHero.meta.popular': 'Popular',
  'homeHero.meta.aiRecommended': 'AI Recommended',
  'homeHero.meta.new': 'New',
  ...
  'homeHero.expertPicker.none': 'Default',
  'homeHero.expertPicker.noneSummary': 'General Artifact OS designer — no specialist lens.',
  'homeHero.expertPicker.searchPlaceholder': 'Search experts',
  'homeHero.expertPicker.clear': 'Clear expert',
  ...
  'homeHero.placeholder': 'e.g. Turn this article into a Content Pack for XHS + TikTok + LinkedIn + Facebook + YouTube…',
  'homeHero.placeholderActive': 'Edit the starter or write your own brief…',
  'homeHero.usingContext': 'Using {designSystem} · {brandMode}',
  'homeHero.noDesignSystem': 'No brand',
  'homeHero.brandMode.label': 'Brand mode',
  'homeHero.brandMode.personal': 'Personal',
  'homeHero.brandMode.client': 'Client',
  'homeHero.quickStartHeading': 'Quick start',
  'homeHero.quickStartHint': 'Pick an outcome — prompt seeds itself',
  'homeHero.pinCategory': 'Pin favorite',
  'homeHero.unpinCategory': 'Unpin',
  'homeHero.popularHeading': 'For creators',
  'homeHero.popularHint': 'Ready-to-run packs with strong hooks',
  'homeHero.pack.pmfFailTitle': 'PMF Fail Pack',
  'homeHero.pack.pmfFailDesc': 'Why good products stall — multi-platform story',
  'homeHero.pack.pmfFailPrompt':
    'Create a Content Pack on “PMF fails when…” — personal stakes for founders, paradox hooks, XHS + TikTok + LinkedIn + Threads + Email. Content Pro v2.1.\n\nAngle / product context:\n',
  'homeHero.pack.mythBustTitle': 'Myth Bust Pack',
  'homeHero.pack.mythBustDesc': 'Kill a common myth with proof + offer',
  'homeHero.pack.mythBustPrompt':
    'Create a Myth-bust Content Pack. Lead with the wrong belief, then personal cost, then portable insight. XHS carousel + TikTok peak frame + LinkedIn question. Myth to bust:\n',
  'homeHero.pack.personalBrandTitle': 'Personal Brand Pack',
  'homeHero.pack.personalBrandDesc': '1-week social batch for authority',
  'homeHero.pack.personalBrandPrompt':
    'Create a 1-week personal brand social batch (5–7 pieces) for LinkedIn, XHS, TikTok, Threads. Paradox hooks, personal stakes, soft offer CTAs. Niche / positioning:\n',
  'homeHero.pack.launchWeekTitle': 'Launch Week Pack',
  'homeHero.pack.launchWeekDesc': 'Day-by-day content for a product drop',
  'homeHero.pack.launchWeekPrompt':
    'Create a Launch Week Content Pack (day-by-day). Multi-platform, offer CTA on every piece, TikTok peak 10/10. Product + launch date:\n',
  'homeHero.pack.hookLabTitle': 'Hook Engine Lab',
  'homeHero.pack.hookLabDesc': 'Weak→strong stop-scroll lines',
  ...
  'homeHero.pack.xhsHooksTitle': 'XHS Hook Lab',
  'homeHero.pack.xhsHooksDesc': '5–7 card carousel from one topic',
  'homeHero.pack.xhsHooksPrompt':
    'Design a 5–7 card XHS carousel (1080×1440). Strong cover hook, no soft middle cards, twist + offer on last card. Topic:\n',
  'homeHero.pack.adTestTitle': 'Ad Variant Lab',
  'homeHero.pack.adTestDesc': 'Hooks + headlines for paid tests',
  'homeHero.pack.adTestPrompt':
    'Create a Content Pro v2.2 paid ad variant matrix (ready-to-paste headlines, primary text, CTAs) for A/B testing. Strategy: objective / funnel / persona. Platform + offer + real proof only:\n',
  'homeHero.carousel.hint': 'Paste a source, pick a brand, or describe the content you want',
  ...
  'homeHero.chip.createBrandKit': 'Create Brand',
  ...
  'homeHero.chip.createBrandKitHint': 'Extract a brand from a website (DESIGN.md + assets), then apply it in any chat.',
  ...
  'homeHero.chip.shortVideo': 'Short Video / TikTok',
  'homeHero.chip.linkedinPost': 'LinkedIn Post',
  'homeHero.chip.facebookPost': 'Facebook Post',
  'homeHero.chip.youtube': 'YouTube',
  'homeHero.chip.threads': 'Threads / X',
  'homeHero.chip.email': 'Email',
  'homeHero.chip.adCreative': 'Ad Creative',
  'homeHero.chip.repurpose': 'Repurpose',
  'homeHero.chip.hookEngine': 'Hook Lab',
  ...
  'homeHero.chip.contentPackNext': 'Multi-platform pack: captions, carousel copy, short-video script + visual direction (no video render).',
  'homeHero.chip.socialContentNext': 'Batch a Content Pro v2.2 week: strategy block, calendar, ready-to-post per piece.',
  'homeHero.chip.carouselNext': 'Design a 5–7 card vertical carousel with a strong cover hook.',
  'homeHero.chip.shortVideoNext': 'Script a 15–25s short with kill hook, peak frame, and shot list.',
  'homeHero.chip.linkedinPostNext': 'Write a tight LinkedIn post: paradox open, sharp question, soft offer.',
  'homeHero.chip.facebookPostNext': 'Write a Facebook feed post: hook before See more, peer tone, offer CTA.',
  'homeHero.chip.youtubeNext': 'Package YouTube titles, description, and thumbnail direction (optional Shorts script).',
  'homeHero.chip.threadsNext': 'Write a Threads / X chain with personal stakes and an offer CTA.',
  'homeHero.chip.emailNext': 'Draft email subjects + body with a single clear offer CTA.',
  'homeHero.chip.adCreativeNext': 'Build a Content Pro v2.2 paid ad matrix (ready-to-paste headlines, primary text, CTAs).',
  'homeHero.chip.repurposeNext': 'Turn one piece into five platform-native formats.',
  'homeHero.chip.hookEngineNext': 'Generate weak→strong hooks for cover, TikTok 0–3s, LinkedIn L1, subjects, and ads.',
  'homeHero.chipSeed.threads': 'Write a Threads / X chain (4–8 posts). P1 is the strongest hook with personal stakes; last post = offer CTA. Topic:\n',
  'homeHero.chipSeed.email': 'Write an email pack: 3–4 subject lines (one paradox-led), 120–250 word body, one offer CTA. Topic / list segment:\n',
  'homeHero.chipSeed.linkedinPost': 'Write a tight LinkedIn post (900–1600 chars): paradox first line, short scene, 2–3 proofs, insight, sharp question, soft offer CTA. Topic:\n',
  ...
  'homeHero.chipSeed.youtube':
    'Create a YouTube package (MVP: text + visual direction + script — no rendered video).\nDeliver: 2–3 title options (≤70 chars prefer), description (hook in first 2 lines + bullets + offer + links), thumbnail direction (16:9 · ≤5 words on-image).\nIf short-form: Shorts script 15–60s with 0–3s kill hook, peak frame, shot list (YT-native title).\n\nTopic / brief:\n',
  'homeHero.chip.webClonePromptSeed': 'Website URL to clone: ',
  'homeHero.outcomesHeading': 'Start with a format',
  'homeHero.outcome.multiPlatformPack': 'Create multi-platform Content Pack',
  'homeHero.outcome.multiPlatformPackPrompt':
    'Create a Content Pro multi-platform pack (XHS · TikTok · LinkedIn · Facebook · YouTube · Threads · Email) with strategy + ready-to-post.\nMVP: text + visual direction + scripts only (no rendered video).\n\nStrategy: objective / funnel_stage / persona+pains / offer:\n\nSource:\n',
  'homeHero.outcome.repurposeFive': 'Repurpose 1 post into multi-platform formats',
  'homeHero.outcome.repurposeFivePrompt':
    'Repurpose into multi-platform formats (XHS · TikTok · LinkedIn · Facebook · YouTube · Threads · Email) with strategy block + ready-to-post (caption/hashtags/alt/best time) each platform.\n\nStrategy: objective / funnel / persona / offer:\n\nSource:\n',
  'homeHero.outcome.socialBatch': 'Batch a week of social posts',
  'homeHero.outcome.socialBatchPrompt':
    'Create a Content Pro v2.2 social batch (5–7 pieces) with strategy + ready-to-post for XHS, TikTok, LinkedIn, Facebook, YouTube, Threads.\n\nStrategy: objective / funnel / persona+pains / offer:\nPillars (≤3):\n\nTopic / brief:\n',
  'homeHero.outcome.xhsCarousel': 'XHS carousel from a topic',
  'homeHero.outcome.xhsCarouselPrompt':
    'Design a 5–7 card XHS carousel (1080×1440). Strong cover hook, no soft middle cards, twist + offer CTA on the last card.\n\nTopic:\n',
  'homeHero.outcome.shortVideo': 'TikTok / Reels short script',
  'homeHero.outcome.shortVideoPrompt':
    'Create a TikTok / Reels short (15–25s): 0–3s kill hook, uneven energy map, peak 10/10 cinematic frame, spoken + on-screen text + shot list, offer CTA.\n\nTopic:\n',
  'homeHero.outcome.facebookPost': 'Facebook feed post',
  'homeHero.outcome.facebookPostPrompt':
    'Write a Facebook feed post (prefer 4:5 visual 1080×1350). Hook in first 125 chars, peer tone, offer CTA, ready-to-post fields.\n\nTopic / brief:\n',
  'homeHero.outcome.youtube': 'YouTube title + thumb + description',
  'homeHero.outcome.youtubePrompt':
    'Create a YouTube package: 2–3 titles, description, 16:9 thumbnail direction (+ optional Shorts script). No rendered video.\n\nTopic / brief:\n',
  'homeHero.outcome.adVariants': 'Ad creative variants from a brief',
  'homeHero.outcome.adVariantsPrompt':
    'Create a Content Pro v2.2 paid ad variant matrix (ready-to-paste headlines, primary text, CTAs). Strategy: objective / funnel / persona. Platform + offer + real proof only:\n',
  'homeHero.outcome.hookLab': 'Hook lab (weak → strong)',
  ...
  'recentProjects.continue': 'Continue',
  'recentProjects.duplicate': 'Duplicate',
  ...
  'designs.status.awaitingInput': 'Need input',
  ...
  'previewRunStatus.stagesAria': 'Design progress stages',
  'previewRunStatus.stageAnalyze': 'Plan',
  'previewRunStatus.stageBuild': 'Build',
  'previewRunStatus.stageVerify': 'Check',
  'previewRunStatus.hintShort': 'Preview updates as files are written',
  'previewRunStatus.hint': 'Still working — full packs often take 1–2 minutes',
  'previewRunStatus.hintLong': 'Still working — complex runs can take a few minutes. Progress continues in Chat',
  ...
  'fileViewer.exportClientPackage': 'Export Client Package',
  ...
  'nextStep.subtitle': 'Suggested follow-ups — click to draft in chat (does not auto-run)',
  'nextStep.more': 'More',
  'nextStep.moreBody': 'Share, download, create a brand, or open more design tools',
  'nextStep.share': 'Share',
  'nextStep.download': 'Download',
  'nextStep.createDesignSystemTitle': 'Create brand',
  ...
  'nextStep.createDesignSystemBusy': 'Creating brand...',
  ...
  'nextStep.projectContinueBody': 'Resume from the stopped turn and take the next concrete step on this project.',
  'nextStep.projectGenerateArtifactTitle': 'Generate artifact',
  'nextStep.projectGenerateArtifactBody': 'Create the missing primary previewable deliverable from the current conversation.',
  'nextStep.designSystemAiRefineTitle': 'AI refine brand',
  'nextStep.designSystemAiRefineBody': 'Re-measure sources and strengthen tokens, voice, and kit quality in place.',
  'nextStep.designSystemAuditKitTitle': 'Audit tokens & kit',
  'nextStep.designSystemAuditKitBody': 'Check contrast, typography, spacing, and kit coverage — then fix high-impact gaps.',
