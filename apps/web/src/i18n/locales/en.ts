...
export const en: Dict = {
  ...
  'chat.amrPreflight.body': 'The current model setup is not usable. Continue this task with the official Open Design AMR models instead — no API key required.',
  ...
  'chat.amrPreflight.meta': 'Billed by usage; after sign-in and top-up this task is sent automatically. Powered by official agents like Claude Code and Codex.',
  ...
  'settings.amrRescueHint': 'You can also continue with the official Open Design AMR models — no API key setup required.',
  'settings.amrRescueCta': 'Use official AMR models',
