...
export const zhTW: Dict = {
  ...
  "chat.amrCard.switchBody":
    "可切換到 Artifact OS Cloud 官方模型服務，無需設定 API Key。完成登入、授權與儲值後，將自動重試目前任務。",
  "chat.amrCard.chipOfficial": "官方代管",
  "chat.amrCard.chipNoKey": "無需 API Key",
  "chat.amrCard.chipAutoRetry": "授權後自動重試",
  "chat.amrCard.switchCta": "切換到 Artifact OS Cloud 並重試",
  "chat.amrError.authMessage":
    "Artifact OS Cloud 帳號尚未授權。完成授權後將自動重試目前任務。",
  "chat.amrError.balanceMessage":
    "Artifact OS Cloud 帳戶餘額不足。儲值後即可繼續執行目前任務。",
  "chat.amrError.authorizeCta": "授權並重試",
  "chat.amrError.rechargeCta": "為 Artifact OS Cloud 儲值",
  "chat.amrBalanceGate.title": "升級方案，繼續創作",
  "chat.amrBalanceGate.message": "餘額不足（目前 {balance}），升級方案或儲值後，任務馬上就能開始。",
  "chat.amrBalanceGate.benefitsTitle": "Artifact OS Cloud 為你提供",
  ...
  "chat.amrBalanceGate.signedOutTitle": "登入 Artifact OS Cloud，開始創作",
  "chat.amrBalanceGate.signedOutMessage": "目前使用的是 Artifact OS Cloud 智能體，登入後這個任務馬上就能開始。",
  ...
  "chat.runError.signInMessage.amr":
    "Artifact OS Cloud 智慧體尚未登入，前往登入即可正常使用",
  "chat.runError.signInMessage.other":
    "{agent}尚未登入，請在本機檢查登入狀態。推薦使用 Artifact OS Cloud 智慧體，更穩定划算",
  ...
  "chat.contextPrompt.referenceProject":
    "請把 Artifact OS 專案「{name}」作為參考上下文。它的本機路徑是：{path}。在設計或修改前，如有幫助請先搜尋並讀取這個目錄。",
  ...
  "settings.welcomeTitle": "歡迎使用 Artifact OS",
  "settings.welcomeSubtitle": "",
  "settings.onboardingCreateTitle": "從一句需求開始",
  "settings.onboardingCreateBody":
    "描述你想做的網站、應用、Deck、圖片或影片，Artifact OS 會建立專案，並保留可繼續編輯的產出。",
  ...
  "settings.onboardingMemoryCalloutBody":
    "這些回答會構成你的記憶檔案。Artifact OS 會在每個任務中重複使用它，並在你工作時持續學習。",
  ...
  "settings.onboardingCloudTitle": "登入 Artifact OS",
  "settings.onboardingCloudBody":
    "登入後可直接用雲端 AI 開始設計，無需任何複雜設定。",
  "settings.onboardingCloudSignIn": "登入 Artifact OS 雲端",
  ...
  "settings.onboardingGateTooltipAmr":
    "後續流程由 AI 執行，請先登入 Artifact OS Cloud。",
  ...
  "settings.agentInstall.pathHint":
    "如果你透過 npm 或 Homebrew 安裝了 CLI，但仍顯示為未安裝，請確認該工具的 bin 目錄已加入 Artifact OS daemon 繼承的 PATH（在 macOS 上，Terminal 與 GUI 應用的 PATH 可能不同）。請參閱 QUICKSTART.md（「Local agent CLI and PATH」章節）。",
  "settings.agentInstall.stepOpenLinks":
    "在目標代理卡片上開啟「安裝」或「文件」連結。",
  "settings.agentInstall.stepAuth":
    "返回 Artifact OS 前，請先在對應 CLI 完成驗證（登入或新增 API 憑證）。",
  ...
  "settings.amrWalletRefreshTitle": "重新整理 Artifact OS Cloud 錢包餘額",
  ...
  "settings.amrAccountStatus": "Artifact OS Cloud 帳戶狀態",
  "settings.amrConsole": "管理",
  "settings.amrLoginErrorCompact": "Artifact OS Cloud 登入失敗。",
  ...
  "settings.mcpServerHint":
    "將 Artifact OS 作為 MCP 伺服器暴露給你的編碼代理。",
  ...
  "settings.privacy": "隱私",
  "settings.privacyHint": "與 Artifact OS 團隊共享哪些資料",
  "settings.privacyConsentKicker": "協助我們改進 Artifact OS",
  "settings.privacyConsentLead":
    "分享使用資料後，我們能更了解 Artifact OS 在真實工作流裡的表現，並優先改進真正影響體驗的地方。",
  ...
  "settings.mcpHint":
    "讓其他專案中的程式碼代理（Claude Code、Cursor、VS Code、Antigravity、Zed、Windsurf）讀取您的 Artifact OS 專案。您可以直接將設計匯入應用程式，無需先匯出 zip。",
  "settings.mcpDaemonError":
    "無法連線到本地守護程序以解析安裝路徑（{error}）。請確認 Artifact OS 正在執行，然後重新開啟此面板。",
  ...
  "settings.mcpCapabilityDefault":
    "預設使用您在 Artifact OS 中開啟的專案與檔案，因此您可以說「在我的應用程式中建置這個」，無需重新說明是哪個設計。",
  "settings.mcpRunningNote":
    "Artifact OS 必須正在執行，MCP 工具呼叫才能成功。如果您在開啟 Artifact OS 之前就已啟動 coding agent，請重新啟動 agent，使其能夠連線到正在執行的守護行程。",
  "entry.tabDesigns": "我的設計",
  "entry.tabTemplates": "範本",
  "entry.tabDesignSystems": "品牌",
  "entry.tabConnectors": "連接器",
  "entry.openSettingsTitle": "設定",
  "entry.openSettingsAria": "開啟設定",
  "entry.discordLabel": "加入 Discord",
  "entry.discordAria": "加入 Artifact OS Discord",
  "entry.discordAriaWithOnline": "加入 Artifact OS Discord - {online}",
  ...
  "entry.followLinkedinLabel": "在 LinkedIn 上追蹤 Artifact OS",
  "entry.followXiaohongshuLabel": "在小紅書上追蹤 Artifact OS",
  ...
  "entry.navTasks": "自動化",
  "entry.navPlugins": "外掛",
  "entry.navDesignSystems": "品牌",
  "entry.navBrands": "品牌",
  "entry.navIntegrations": "整合",
  'entry.nav.workspace': '工作区',
  'entry.nav.recent': '最近',
  ...
  "homeHero.title": "今天在创造什么？",
  'homeHero.badge': 'AI 驅動的內容創作',
  'homeHero.meta.featured': '精选',
  'homeHero.meta.popular': '热门',
  'homeHero.meta.aiRecommended': 'AI 推荐',
  'homeHero.meta.new': '新',
  ...
  "homeHero.expertPicker.label": "專家",
  "homeHero.expertPicker.none": "預設",
  "homeHero.expertPicker.noneSummary": "通用 Artifact OS 設計師 — 不套用專家視角。",
  "homeHero.expertPicker.searchPlaceholder": "搜尋專家",
  "homeHero.expertPicker.clear": "清除專家",
  "homeHero.templatesScrollHint": "向上捲動以探索更多範本",
  "homeHero.templatesCollapse": "收合範本",
  "homeHero.subtitlePrefix": "从一个想法 → 几分钟内覆盖多平台",
  "homeHero.placeholder": "例如：把这篇文章改成小红书 + TikTok + LinkedIn 的 Content Pack…",
  "homeHero.placeholderActive": "编辑示例，或写下你自己的 brief…",
  ...
  "homeHero.chip.createBrandKit": "创建品牌",
  ...
  "homeHero.chip.createPluginHint":
    "編寫可重複使用的 Artifact OS 外掛並將其加入「我的外掛」。",
  ...
  "recentProjects.duplicate": "复制",
  "recentProjects.continue": "继续",
  "homeHero.chip.repurposeNext": "Turn one piece into five platform-native formats.",
  "homeHero.chip.hookEngine": "钩子实验室",
  "homeHero.chip.hookEngineDesc": "Generate 50+ scroll-stopping hooks",
  "homeHero.chip.hookEngineNext": "生成封面 / 前3秒 / LinkedIn首行 / 邮件主题 / 广告标题的弱→强钩子。",
  ...
  "homeHero.outcome.hookLab": "钩子实验室（弱→强）",
  ...
  "homeHero.pack.hookLabTitle": "钩子引擎实验室",
  "homeHero.pack.hookLabDesc": "弱→强停滑开场句",
  ...
  "homeHero.popularHint": "可直接开跑的内容包",
  "homeHero.popularHeading": "创作者精选",
  "homeHero.unpinCategory": "取消固定",
  "homeHero.pinCategory": "固定到顶部",
  "homeHero.quickStartHint": "选结果 — 自动预填提示词",
  "homeHero.quickStartHeading": "快速开始",
  "homeHero.brandMode.client": "客户",
  "homeHero.brandMode.personal": "个人",
  "homeHero.brandMode.label": "品牌模式",
  "homeHero.noDesignSystem": "未选择品牌",
  "homeHero.usingContext": "正在使用 {designSystem} · {brandMode}",
  "homeHero.linkDesignSystems": "品牌",
  "homeHero.linkSkillsPlugins": "技能与插件",
  "homeHero.moreFormats": "更多格式（演示稿、原型、网站…）",
  "homeHero.chip.contentPack": "內容包",
  "homeHero.chip.socialContent": "社群內容",
  "homeHero.chip.carousel": "轮播 / 小红书",
  "homeHero.chip.shortVideo": "短视频 / TikTok",
  "homeHero.chip.linkedinPost": "LinkedIn 帖",
  "homeHero.chip.facebookPost": "Facebook Post",
  "homeHero.chip.youtube": "YouTube",
  "homeHero.chip.email": "郵件",
  "homeHero.chip.adCreative": "廣告創意",
  "homeHero.chip.contentPackDesc": "One prompt → every platform",
  "homeHero.chip.socialContentDesc": "跨平台批量帖文",
  "homeHero.chip.carouselDesc": "Turn ideas into visual stories",
  "homeHero.chip.shortVideoDesc": "Script + shots + voiceover",
  "homeHero.chip.linkedinPostDesc": "有说服力的权威帖",
  ...
  "homeHero.chip.contentPackNext": "从一份素材生成多平台内容包（小红书、TikTok、LinkedIn、Threads、邮件）。",
  "homeHero.chip.socialContentNext": "按 Content Pro 标准批量创作社媒内容。",
  "homeHero.chip.carouselNext": "设计 5–7 张竖版轮播，封面强钩子。",
  "homeHero.chip.shortVideoNext": "写 15–25 秒短视频脚本：杀钩、高潮镜头、分镜。",
  "homeHero.chip.linkedinPostNext": "写紧凑 LinkedIn 帖：悖论开场、锐利提问、轻转化。",
  ...
  "homeHero.chip.emailNext": "写邮件主题 + 正文，单一明确 offer CTA。",
  "homeHero.chip.adCreativeNext": "从一个 brief 生成付费广告多版本。",
  "homeHero.outcomesHeading": "從格式開始",
  "homeHero.outcome.multiPlatformPack": "建立多平台 Content Pack",
  "homeHero.outcome.multiPlatformPackPrompt": "从这份素材创建多平台 Content Pack（小红书轮播、TikTok 短视频、LinkedIn 帖、Threads、邮件）。Content Pro v2.1：悖论钩子、个人利害、TikTok 高潮 10/10、带 offer 的 CTA。\n\n素材：\n",
  "homeHero.outcome.repurposeFive": "1 篇改寫成 5 種格式",
  "homeHero.outcome.repurposeFivePrompt": "把这一篇改写成 5 种格式：小红书轮播、TikTok 脚本、LinkedIn 帖、Threads 串、邮件。同一主线，平台原生钩子，每端都有 offer CTA。\n\n素材：\n",
  "homeHero.outcome.socialBatch": "批量一週社群內容",
  "homeHero.outcome.socialBatchPrompt": "创建一周 Content Pro 社媒批量（5–7 条），覆盖小红书、TikTok、LinkedIn、Threads。悖论钩子、个人利害、offer CTA。\n\n主题 / brief：\n",
  "homeHero.outcome.xhsCarousel": "從一個主題做小紅書輪播",
  "homeHero.outcome.xhsCarouselPrompt": "设计 5–7 张小红书轮播（1080×1440）。封面强钩子，中后卡不塌，最后一张 twist + offer CTA。\n\n主题：\n",
  "homeHero.outcome.shortVideo": "TikTok / Reels 短影音腳本",
  "homeHero.outcome.shortVideoPrompt": "写 TikTok / Reels 短视频（15–25 秒）：0–3 秒杀钩、能量起伏图、高潮 10/10 电影感镜头、口播 + 字幕 + 分镜、offer CTA。\n\n主题：\n",
  ...
  "homeHero.outcome.adVariants": "從一個 brief 出廣告多版本",
  "homeHero.outcome.adVariantsPrompt": "从 brief 生成付费广告多版本（钩子、主文案、标题、视觉方向）。\n\n平台 + offer：\n",
  ...
  "handoff.amrWebsite": "開啟 Artifact OS Cloud 官網",
  ...
  "handoff.promptIntro": "請基於這個 Artifact OS 專案的本機資料夾繼續實作：",
  ...
  "designSystemPicker.select": "选择品牌",
  "designSystemPicker.loading": "加载品牌…",
  "designSystemPicker.searchPlaceholder": "搜索品牌（名称 / 分类 / 摘要）",
  "designSystemPicker.searchCompactPlaceholder": "搜索品牌",
  "designSystemPicker.noneTitle": "无品牌",
  "designSystemPicker.noneSummary": "无品牌 — 模型将根据提示自由发挥视觉风格。",
  "designSystemPicker.empty": "没有匹配的品牌",
  "designSystemPicker.openPreview": "開啟預覽",
  "designSystemPicker.loadingPreview": "正在載入預覽…",
  "designSystemPicker.noPreview":
    "暂无预览。打开品牌库查看完整预览。",
  "designSystemPicker.previewHint": "悬停品牌以预览",
  ...
  "pluginsHome.subtitle":
    "隨附於此執行環境、可立即使用的 Artifact OS 工作流程。挑選一個以載入起始提示，或瀏覽登錄檔取得更多。",
  ...
  "pluginsHome.emptyCatalog":
    "目錄是空的。內建外掛隨 Artifact OS 一同提供，應會自動出現在此處 — 若問題持續發生，請嘗試重新啟動 daemon。",
  ...
  "pluginCard.contributeAria": "將 {title} 貢獻至 Artifact OS",
  "pluginCard.contributeTitle": "透過 pull request 將外掛貢獻至 Artifact OS",
  ...
  "integrations.lede":
    "連接外部系統，把 MCP 工具帶入智能體迴圈，並在其他 IDE、腳本與自動化流程中使用 Artifact OS。",
  ...
  "mcpClient.daemonError":
    "無法連線到本機 daemon。請確認 Artifact OS 正在執行，然後重新開啟此面板。",
  "mcpClient.saveFailed": "儲存失敗。請確認 daemon 正在執行後再試一次。",
  "useEverywhere.modalAria": "隨處使用 Artifact OS",
  "useEverywhere.modalTitle": "隨處使用 Artifact OS",
  "useEverywhere.modalSubtitle":
    "將 Artifact OS 接入任何 IDE、Agent 或指令碼 — CLI、HTTP、MCP 及 Skills。使用「複製 Agent 指南」並貼到 Claude Code、Codex、Cursor、openclaw 或 hermes 中，即可設定一切。",
  ...
  "useEverywhere.section.overview.heading":
    "你的 Agent 在哪裡運作，Artifact OS 就在哪裡運作",
  "useEverywhere.section.overview.intro":
    "Artifact OS 不只是一個視窗 — 它是一個本機特權 daemon（`od`），外加一個 Skills + Design-Systems + Atoms 登錄。一旦它在您的機器上執行，任何程式碼 Agent（Claude Code、Codex、Cursor、OpenCode/openclaw、Hermes、您自己的指令碼）都能透過四個可互換的介面來驅動產生作業、檢視專案並產出設計成品。",
  "useEverywhere.section.overview.bullet1":
    "CLI — 以 `od <command>` 用於無頭指令碼、CI 及 shell 自動化。",
  "useEverywhere.section.overview.bullet2":
    "MCP server — 將 Artifact OS 接成 Model Context Protocol 伺服器，讓任何支援 MCP 的 Agent 都能列出技能、執行情境並讀取成品。",
  ...
  "useEverywhere.section.overview.bullet4":
    "Skills — 隨插即用的 `SKILL.md` 套件（相容於 Claude），任何已在您 PATH 上的 Agent 完全無需 Artifact OS 即可調用。",
  ...
  "useEverywhere.section.cli.heading": "從任何 shell 操作 Artifact OS",
  ...
  "useEverywhere.section.mcp.heading":
    "將 Artifact OS 以 MCP 伺服器形式開放給任何程式設計 Agent",
  "useEverywhere.section.mcp.intro":
    "Artifact OS 隨附一個 Model Context Protocol 伺服器（`od mcp`），讓任何支援 MCP 的用戶端 — Cursor、Claude Code、Antigravity、VS Code Copilot Chat、openclaw、hermes — 都能探索 Artifact OS 工具（列出技能、算繪預覽、產生媒體、執行外掛），而無需手動使用 shell。daemon 透過 `GET /api/mcp/install-info` 為每個主要用戶端發布可直接貼上的安裝程式碼片段。",
  ...
  "useEverywhere.section.mcp.footer":
    "在 Artifact OS 應用程式中，開啟「設定 → 整合」即可複製特定用戶端的安裝指令（Cursor、Claude Code、Antigravity、VS Code），而無需手動編輯 JSON。",
  ...
  "useEverywhere.section.skills.heading":
    "適用於任何 Agent 的隨插即用 Skills — 即使 Artifact OS 未在執行也行",
  "useEverywhere.section.skills.intro":
    "Skill 是一個包含相容於 Claude 的 `SKILL.md`（YAML 前置資料 + 內文）的目錄。Artifact OS 以 `od:` 命名空間（`mode`、`preview`、`design_system`、`inputs`、…）擴充此格式，因此同一個成品既能在 Artifact OS 內使用，也能被像 Claude Code、Codex、openclaw 或 hermes 這類原生 Agent 使用。探索作業遵循一條優先順序鏈，因此專案可覆寫自己的技能。",
  ...
  "useEverywhere.section.skills.snippet1":
    "最精簡的 SKILL.md（Claude 相容的前置資料 + Artifact OS 額外設定）",
  ...
  "entry.githubStarAria": "在 GitHub 為 Artifact OS 點亮 Star",
  ...
  "newproj.locationDefault": "Artifact OS 專案",
  ...
  "ds.surfaceVideo": "影片",
  "ds.surfaceAudio": "音訊",
  "ds.searchPlaceholder": "搜索品牌…",
  "ds.emptyNoMatch": "没有匹配的品牌。",
  "ds.badgeDefault": "預設",
  "ds.preview": "預覽完整系統",
  ...
  "avatar.amrConsole": "Artifact OS Cloud 帳戶",
  ...
  "socialShare.openDesignSection": "分享 Artifact OS",
  "socialShare.openDesignTitle": "GitHub 上的 Artifact OS",
  "socialShare.openDesignText":
    "Artifact OS 是開源的設計智慧工作區，可以生成、編輯、部署並交付設計產物。",
  ...
  "socialShare.projectText":
    "我用 Artifact OS 做了 {title}。查看已部署產物，也推薦收藏倉庫：{repo}",
  "socialShare.projectCopyText":
    "我用 Artifact OS 做了 {title}\n{url}\nArtifact OS 倉庫：{repo}",
  ...
  "chat.brandBrowserAssistDesktopOnly":
    "瀏覽器輔助需要桌面應用，Artifact OS 才能讀取即時瀏覽器頁面。",
  "chat.brandBrowserAssistReadFailed":
    "無法讀取瀏覽器頁面。請確認品牌網站已開啟並完整載入。",
  "chat.brandBrowserAssistMessage":
    "Artifact OS 需要瀏覽器輔助才能完成這次品牌擷取。請先在 Browser 分頁清除頁面攔截，然後在下方確認。",
  "brandEnrichment.title": "AI 優化",
  "brandEnrichment.body":
    "Artifact OS 會在背景執行更深度的抽取，自動套用合適的設計系統 skills，並就地更新這個系統。通常需要 10-20 分鐘，你可以繼續做其他事。",
  ...
  "chat.activeFilePlaceholder": "讓 Artifact OS 修改 {file}...",
  ...
  "chat.mode.design.solves":
    "當你希望 Artifact OS 產生檔案、更新 workspace，或把需求變成多模態可交付結果時使用。",
  ...
  "chat.importDesignSystemHeader": "选择品牌",
  ...
  "designBrowser.reference.kicker": "Artifact OS 浏览器",
  ...
  "preview.shareTextDefault": "Artifact OS 模板：{title}",
  ...
  "preview.errorBody":
    "範例 HTML 載入失敗。請確認 Artifact OS 正在執行後重試。",
  "preview.retry": "重試",
  ...
  "designFiles.documentTemplate.goalBody":
    "說明希望 Artifact OS 基於這份文件生成、修改或判斷什麼。",
  ...
  "designFiles.documentTemplate.capabilityAgent":
    "Artifact OS agent 可以讀取、編輯這份檔案，並把它作為專案上下文。",
  ...
  "designFiles.documentTemplate.nextBody":
    "檢查並編輯這份文件，然後讓 Artifact OS 基於它生成、修改或執行操作。",
  ...
  "designFiles.usefulInfoTip18":
    "在 YouTube 上訂閱 Artifact OS，觀看教學和示範。",
  "designFiles.usefulInfoTip19":
    "在 LinkedIn 上追蹤 Artifact OS，了解產品動態。",
  "designFiles.usefulInfoTip20":
    "在小紅書上追蹤 Artifact OS，獲取技巧和靈感。",
  ...
  "fileViewer.exportClientPackage": "匯出客戶交付包",
  "fileViewer.exportClientPackageEmpty": "沒有可打包的文案或 HTML。請先開啟 Content Pro 內容包。",
  ...
  "assistant.shareToOpenDesign": "分享到 Artifact OS",
  ...
  "pet.navHint": "領養與自訂",
  "pet.tabBuiltIn": "內建",
  "pet.tabBuiltInHint": "Artifact OS 內建的精選寵物 — 一鍵領養。",
  "pet.builtInEmpty":
  ...
  "pet.codexBundled": "內建",
  "pet.codexBundledTitle": "Artifact OS 內建寵物，無需下載。",
  ...
  "settings.projectLocationsDescription":
    "新增可包含多個 Artifact OS 專案資料夾的工作基目錄。新專案會儲存為所選基目錄中的一個資料夾。",
  ...
  "settings.customInstructionsHint":
    "Artifact OS 在每次聊天中都應遵循的固定指示。將事實、偏好與專案脈絡儲存為記憶。",
  ...
  "artifact.odCardBrandAssistBody":
    "在瀏覽器中開啟品牌網站，讓 Artifact OS 繼續擷取此設計體系。",
  ...
  "updater.availableBody":
    "Artifact OS {version} 可用。下載完成後即可開啟安裝器。",
  ...
  "updater.installerOpenBody":
    "安裝器已開啟。Artifact OS 正在結束，以便你完成更新。",
  ...
  "updater.payloadReadyGeneric":
    "A new Artifact OS update is ready. Artifact OS will close and restart automatically.",
  "updater.payloadReadyVersion":
    "Artifact OS {version} is ready. Artifact OS will close and restart automatically.",
  "updater.quitButton": "結束 Artifact OS",
  "updater.quitFailedBody":
    "安裝器已開啟，但 Artifact OS 無法結束。替換應用程式前請先結束 Artifact OS。",
  "updater.quitFailedTitle": "無法結束",
  "updater.quitting": "正在結束…",
  "updater.ready": "更新已就緒",
  "updater.readyGeneric": "新版本已就緒。Artifact OS 會關閉並開啟安裝器。",
  "updater.readyVersion":
    "Artifact OS {version} 已就緒。Artifact OS 會關閉並開啟安裝器。",
  ...
  'settings.updateQuitFailed': '安裝程式已開啟，但 Artifact OS 未能自動結束。',
  ...
  "dsManager.eyebrowDesignSystems": "品牌",
  ...
  "dsManager.createTitle": "创建新品牌",
  "dsManager.createBody":
    "把你的品牌、產品、程式碼、素材與設計參考教給 Artifact OS。",
  ...
  "settings.customInstructionsDesc":
    "Artifact OS 在每次對話中都會遵循的固定指令。它們不是儲存的記憶；事實、偏好與專案脈絡請使用「記憶」。",
  ...
  "brand.librarySubtitle":
    "把你的品牌套件教給 Artifact OS——從網站擷取一個品牌套件，然後在任意對話中套用它。",
  ...
  "onboarding.buildBody":
    "Artifact OS 將你的品牌沉澱為可重用的設計系統,讓你之後打造的一切都保持品牌一致。",
  ...
  "dsCreate.sourceSectionBody":
    "從 GitHub repo、網站、DESIGN.md 或能體現風格的檔案開始。Artifact OS 會先快速建立一套可用系統，之後 AI 可在專案中繼續細化。",
  ...
  "ds.extractionRunningBody": "Artifact OS 正在就地更新此體系。",
  ...
  "ds.repoConnectBannerBody":
    "連接 GitHub 後，Artifact OS 可以讀取你的儲存庫，並把顏色、字體和元件擷取到此設計體系中。",
