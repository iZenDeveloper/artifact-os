...
export const zhTW: Dict = {
  ...
  'chat.amrPreflight.body': '目前模型設定不可用。可改用 Open Design 官方 AMR 模型繼續目前任務，無需設定 API Key。',
  ...
  'chat.amrPreflight.meta': '按用量計費，登入並儲值後任務會自動傳送；底層執行 Claude Code、Codex 等官方代理。',
  'chat.amrPreflight.signInUseAmrCta': '登入並使用 AMR',
  'chat.amrPreflight.pendingNotice': '登入 AMR 後將自動傳送目前任務。',
  'settings.amrRescueHint': '也可以使用 Open Design 官方 AMR 模型能力繼續，無需設定 API Key。',
