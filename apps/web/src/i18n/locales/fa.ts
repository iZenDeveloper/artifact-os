...
export const fa: Dict = {
  ...
  'handoff.download': 'دانلود',
  'handoff.downloadFailed': 'دانلود ناموفق بود. کمی بعد دوباره تلاش کنید.',
  'handoff.remoteOpen': 'باز کردن از راه دور',
  'handoff.remoteOpenTitle': 'باز کردن این پروژه در فضای فایل‌های وب',
  'handoff.webActionsTitle': 'گزینه‌های خروجی گرفتن و باز کردن',
  'handoff.openFolderUnavailable': 'در اینجا نمی‌توان پوشهٔ محلی را باز کرد — پروژه روی یک دیمن راه دور یا داخل کانتینر قرار دارد. مسیر را کپی کنید، فایل ‎.zip را دانلود کنید یا آن را در فضای کاری وب باز کنید.',
