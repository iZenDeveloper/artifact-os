...
export const fa: Dict = {
  ...
  'assistant.compactionActiveTitle': 'در حال فشرده‌سازی زمینه',
  'assistant.compactionActiveDetail': 'حفظ وظیفه، تصمیم‌ها و پیشرفت اخیر',
  'assistant.compactionCompletedTitle': 'زمینه فشرده شد',
  'assistant.compactionFailedTitle': 'فشرده‌سازی زمینه ناموفق بود',
