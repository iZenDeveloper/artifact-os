...
export const fa: Dict = {
  ...
  'whatsNew.updatedTitle': 'تازه‌های Open Design {version}',
  'whatsNew.genericBody': 'Open Design با بهبودها و رفع اشکال‌ها به‌روزرسانی شد. برای جزئیات، یادداشت‌های انتشار را ببینید.',
