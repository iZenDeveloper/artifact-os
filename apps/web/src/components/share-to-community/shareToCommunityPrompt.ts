// Trigger prompt for the post-completion "Share to Artifact OS" submission
...
export const SHARE_TO_COMMUNITY_PROMPT = [
  'Package the work I just finished in this project as an Artifact OS plugin so I can install it into My plugins and open a PR to the Artifact OS community catalog.',
  '',
