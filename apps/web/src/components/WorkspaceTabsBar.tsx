...
function displayTabFor(
  ...
  const entryTitle: Record<EntryHomeView, string> = {
    ...
    drafts: t('demo.WorkspaceTabsBar.tsx.drafts'),
    'all-projects': t('demo.WorkspaceTabsBar.tsx.allProjects'),
    'content-plan': t('demo.WorkspaceTabsBar.tsx.contentPlan'),
    members: t('demo.WorkspaceTabsBar.tsx.members'),
    dashboard: t('demo.WorkspaceTabsBar.tsx.dashboard'),
    'workspace-settings': t('demo.WorkspaceTabsBar.tsx.workspaceSettings'),
