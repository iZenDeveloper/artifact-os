...
export function WorkspaceSettingsView({ hasActiveSubscription = false }: WorkspaceSettingsViewProps) {
  const t = useT();
  const [workspaceName, setWorkspaceName] = useState(t('demo.WorkspaceSettingsView.tsx.workspaceName'));
  ...
  return (
    <div className="entry-section workspace-settings">
      ...
      <section className="workspace-settings__danger" aria-label={t('demo.WorkspaceSettingsView.tsx.dangerZoneAria')}>
        <div className="workspace-settings__danger-copy">
          <span className="workspace-settings__danger-icon" aria-hidden>
            <Icon name="alert-triangle" size={18} />
          </span>
          <div>
            <h2>{t('demo.WorkspaceSettingsView.tsx.dangerZoneTitle')}</h2>
            <p>{t('demo.WorkspaceSettingsView.tsx.dangerZoneDesc')}</p>
          </div>
        </div>
        <button
          type="button"
        ...
        <div className="workspace-settings__modal-backdrop" role="presentation">
          ...
          >
            ...
            {subscriptionActive ? (
              ...
              <>
                <p>{t('demo.WorkspaceSettingsView.tsx.confirmPrefix')} <strong>{workspaceName}</strong> {t('demo.WorkspaceSettingsView.tsx.confirmSuffix')}</p>
                <input
                  className="workspace-settings__input"
                  value={deleteText}
