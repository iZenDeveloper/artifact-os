...
// Names/initials/times are stable ids resolved to display text via t().
const MOCK_MEMBERS: Array<{ id: string; nameKey: keyof Dict; initialKey: keyof Dict; img: string }> = [
  { id: 'me', nameKey: 'demo.RecentProjectsStrip.tsx.member-me', initialKey: 'demo.RecentProjectsStrip.tsx.member-me-initial', img: '/team-avatars/a2.png' },
  { id: 'zhangwei', nameKey: 'demo.RecentProjectsStrip.tsx.member-zhangwei', initialKey: 'demo.RecentProjectsStrip.tsx.member-zhangwei-initial', img: '/team-avatars/a1.png' },
  { id: 'lina', nameKey: 'demo.RecentProjectsStrip.tsx.member-lina', initialKey: 'demo.RecentProjectsStrip.tsx.member-lina-initial', img: '/team-avatars/a3.png' },
  { id: 'wangfang', nameKey: 'demo.RecentProjectsStrip.tsx.member-wangfang', initialKey: 'demo.RecentProjectsStrip.tsx.member-wangfang-initial', img: '/team-avatars/a4.png' },
  { id: 'chenming', nameKey: 'demo.RecentProjectsStrip.tsx.member-chenming', initialKey: 'demo.RecentProjectsStrip.tsx.member-chenming-initial', img: '/team-avatars/a6.png' },
  { id: 'liuyang', nameKey: 'demo.RecentProjectsStrip.tsx.member-liuyang', initialKey: 'demo.RecentProjectsStrip.tsx.member-liuyang-initial', img: '/team-avatars/a7.png' },
];
const MOCK_TIME_KEYS: Array<keyof Dict> = [
  'demo.RecentProjectsStrip.tsx.time-just-now',
  'demo.RecentProjectsStrip.tsx.time-12-min',
  'demo.RecentProjectsStrip.tsx.time-1-hour',
  'demo.RecentProjectsStrip.tsx.time-3-hour',
  'demo.RecentProjectsStrip.tsx.time-yesterday',
  'demo.RecentProjectsStrip.tsx.time-2-day',
  'demo.RecentProjectsStrip.tsx.time-last-week',
  'demo.RecentProjectsStrip.tsx.time-3-week',
];
...
const ME: { id: string; nameKey: keyof Dict; initialKey: keyof Dict; img: string } = { id: 'me', nameKey: 'demo.RecentProjectsStrip.tsx.member-me', initialKey: 'demo.RecentProjectsStrip.tsx.member-me-initial', img: '/team-avatars/a2.png' };
type SpaceKind = 'recent' | 'drafts' | 'team';
const OWNER_FILTER_OPTIONS: Array<{ id: OwnerFilter; labelKey: keyof Dict }> = [
  { id: 'all', labelKey: 'demo.RecentProjectsStrip.tsx.owner-filter-all' },
  { id: 'mine', labelKey: 'demo.RecentProjectsStrip.tsx.owner-filter-mine' },
  { id: 'others', labelKey: 'demo.RecentProjectsStrip.tsx.owner-filter-others' },
];
const KIND_FILTER_OPTIONS: Array<{ id: ProjectKindFilter; labelKey?: keyof Dict; label?: string }> = [
  { id: 'all', labelKey: 'demo.RecentProjectsStrip.tsx.kind-filter-all' },
  { id: 'prototype', label: 'Prototype' },
  { id: 'deck', label: 'Slides' },
  { id: 'media', label: 'Media' },
  { id: 'other', label: 'Other' },
];
function kindFilterLabel(option: { labelKey?: keyof Dict; label?: string }, t: ReturnType<typeof useT>): string {
  return option.labelKey ? t(option.labelKey) : (option.label ?? '');
}
function mockCardMeta(index: number, space: SpaceKind) {
  const timeKey = MOCK_TIME_KEYS[index % MOCK_TIME_KEYS.length] ?? 'demo.RecentProjectsStrip.tsx.time-just-now';
  if (space === 'team') {
...
const NO_PROJECT_MUTATION_TITLE_KEY = 'demo.RecentProjectsStrip.tsx.no-mutation-title';
...
export function RecentProjectsStrip({
  ...
  const visibleProjectCards = useMemo(
    () => displayProjects
      ...
      .filter(({ project, meta }) => {
        ...
        const ownerMatches =
          ownerFilter === 'all'
          || (ownerFilter === 'mine' && meta.ownerId === 'me')
          || (ownerFilter === 'others' && meta.ownerId !== 'me');
  ...
  const selectedMutationTitle = selectedContainsReadonlyProject
    ? t('demo.RecentProjectsStrip.tsx.selection-contains-readonly')
    : selectedProjectNames.join(t('demo.RecentProjectsStrip.tsx.name-join-separator'));
    ...
    <section className="recent-projects" data-testid="recent-projects-strip">
      <header className="recent-projects__head">
        <div className="recent-projects__title-block">
          <h2 className="recent-projects__heading">{heading ?? t('demo.RecentProjectsStrip.tsx.heading-default')}</h2>
          {description ? (
        ...
        <div className="recent-projects__controls">
          {collaborationEnabled && space === 'team' && canAssignInviteRoles ? (
            ...
            >
              <Icon name="share" size={15} /> {t('demo.RecentProjectsStrip.tsx.invite-colleagues')}
            </button>
          ) : null}
          {canManageProjectCollection ? (
            ...
            >
              {t('demo.RecentProjectsStrip.tsx.multi-select')}
            </button>
          ) : null}
          <div className="recent-projects__filter-wrap">
            ...
            >
              {(() => {
                ...
                return active ? t(active.labelKey) : t('demo.RecentProjectsStrip.tsx.owner-filter-all');
              })()}
          ...
          <div className="recent-projects__filter-wrap">
            ...
            >
              {(() => {
                ...
                return active ? kindFilterLabel(active, t) : t('demo.RecentProjectsStrip.tsx.kind-filter-all');
              })()}
              <Icon name="chevron-down" size={13} />
            </button>
            {openHeaderMenu === 'kind' ? (
          ...
          <button type="button" className="recent-projects__view-btn" aria-label={t('demo.RecentProjectsStrip.tsx.sort-aria')}>
      ...
      {activeSelectionMode ? (
        <div className="recent-projects__bulkbar" role="toolbar" aria-label={t('demo.RecentProjectsStrip.tsx.bulk-actions-aria')}>
          <span className="recent-projects__bulkbar-count">
            {t('demo.RecentProjectsStrip.tsx.selected-count-prefix')} <strong>{selectedCount}</strong> {t('demo.RecentProjectsStrip.tsx.selected-count-suffix')}
          </span>
          <div className="recent-projects__bulkbar-actions">
            {canMoveToTeam ? (
              ...
              >
                <Icon name="import" size={13} /> {t('demo.RecentProjectsStrip.tsx.move-to-team')}
              </button>
            ) : null}
            {canMoveToPersonal ? (
              <button
              ...
              >
                <Icon name="log-out" size={13} /> {t('demo.RecentProjectsStrip.tsx.move-to-personal')}
              </button>
            ) : null}
            <button
              type="button"
            ...
            >
              <Icon name="trash" size={13} /> {t('demo.RecentProjectsStrip.tsx.bulk-delete')}
            </button>
            ...
            >
              {activeSelectionMode ? (
                <button
                  ...
                  aria-label={selected ? t('demo.RecentProjectsStrip.tsx.deselect-project', { name: project.name }) : t('demo.RecentProjectsStrip.tsx.select-project', { name: project.name })}
                  onClick={(event) => {
                ...
                >
                  ...
                  {collaborationEnabled && space !== 'team' && meta.badge === 'shared' ? (
                    <span className="recent-projects__card-badge recent-projects__card-badge--shared">
                      ...
                      {t('demo.RecentProjectsStrip.tsx.badge-shared')}
                    </span>
                  ) : null}
                </div>
                <div className="recent-projects__card-meta">
                  ...
                  <div className="recent-projects__card-footer">
                    <div className="recent-projects__card-time">
                      ...
                      <span>{t('demo.RecentProjectsStrip.tsx.created-by', { name: t(meta.ownerNameKey) })}</span>
                    ...
                    >
                      {collaborationEnabled ? (
                        ...
                        >
                          ...
                          <span>{projectMoveAction === 'to-team' ? t('demo.RecentProjectsStrip.tsx.move-to-team') : t('demo.RecentProjectsStrip.tsx.move-to-personal')}</span>
                        </button>
                      ) : null}
                      {onRename ? (
                        <button
      ...
      {confirmTarget ? (
        ...
        >
          ...
          <DialogDescription>
            {t('demo.RecentProjectsStrip.tsx.delete-confirm', { name: confirmTarget.name })}
          </DialogDescription>
          <DialogFooter className="row">
      ...
      {moveTarget ? (
        ...
        >
          <DialogTitle id={moveTitleId}>
            {moveTarget.action === 'to-team' ? t('demo.RecentProjectsStrip.tsx.move-to-team') : t('demo.RecentProjectsStrip.tsx.move-to-personal')}
          </DialogTitle>
          <DialogDescription>
            {moveTarget.action === 'to-team' ? (
              <>
                {t('demo.RecentProjectsStrip.tsx.move-to-team-desc-before')}<strong>{t('demo.RecentProjectsStrip.tsx.move-to-team-desc-bold')}</strong>{t('demo.RecentProjectsStrip.tsx.move-to-team-desc-after')}
              </>
            ) : (
              <>
                {t('demo.RecentProjectsStrip.tsx.move-to-personal-desc-before')}<strong>{t('demo.RecentProjectsStrip.tsx.move-to-personal-desc-bold')}</strong>{t('demo.RecentProjectsStrip.tsx.move-to-personal-desc-after')}
              </>
            )}
          </DialogDescription>
          <DialogFooter className="row">
            ...
            >
              ...
              />
              {t('demo.RecentProjectsStrip.tsx.dont-remind')}
            </label>
            ...
            >
              {moveTarget.action === 'to-team' ? t('demo.RecentProjectsStrip.tsx.confirm-move-to-team') : t('demo.RecentProjectsStrip.tsx.confirm-move-to-personal')}
            </button>
          </DialogFooter>
        </Dialog>
      ) : null}
