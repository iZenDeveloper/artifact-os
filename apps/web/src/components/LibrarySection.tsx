...
// zero-config — it connects automatically whenever Artifact OS is running
      ...
      <header className="entry-section__head">
        ...
        <div className={styles.clipperHint}>
          ...
          >
            ...
            Get the Artifact OS Web Clipper
          </a>
        </div>
      </header>
      ...
      {loading && assets.length === 0 ? (
        ...
        <div className={styles.empty}>
          ...
          <p className={styles.emptyHint}>
            Clip from any page with the Artifact OS Web Clipper, run{' '}
