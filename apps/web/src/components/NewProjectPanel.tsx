...
export interface CreateInput {
  ...
  /** Expert persona/methodology id (optional; Home Expert picker). */
  ...
  async function handlePickWorkingDir() {
    ...
    try {
      if (isOpenDesignHostAvailable()) {
        ...
        setWorkingDirError({
          message: `Couldn't open the folder picker (${'reason' in result ? result.reason : 'host unavailable'}). Please update Artifact OS and try again.`,
        });
        return;
      }
      try {
