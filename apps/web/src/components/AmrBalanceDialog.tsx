...
interface Props {
  ...
  /** Artifact OS Cloud profile from the blocking snapshot; picks the console origin. */
  profile: string | null;
...
// HARD pre-run blocker for Artifact OS Cloud tasks: the run cannot possibly
...
//
//   signed_out — Artifact OS Cloud selected but no account session. The CTA
...
export function AmrBalanceDialog({
  ...
  const openWallet = () => {
    ...
    // Same attribution handshake as the other Artifact OS Cloud handoffs
