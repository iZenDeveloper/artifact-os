...
const WORKSPACE = {
  nameKey: 'demo.InviteAcceptanceFlow.tsx.workspace.name' as keyof Dict,
  logo: 'N',
  inviterKey: 'demo.InviteAcceptanceFlow.tsx.workspace.inviter' as keyof Dict,
  inviterInitialKey: 'demo.InviteAcceptanceFlow.tsx.workspace.inviterInitial' as keyof Dict,
  members: 12,
  projects: 8,
...
export function InviteAcceptanceFlow({ open, role, onClose, onJoined, onDeclined }: Props) {
  ...
  function renderStepper() {
    ...
    return (
      <ol className="invite-accept__steps" aria-label={t('demo.InviteAcceptanceFlow.tsx.stepper.aria')}>
        {STEP_ORDER.map((s, i) => {
  ...
  return createPortal(
    <div className="invite-accept" role="dialog" aria-modal="true" aria-label={t('demo.InviteAcceptanceFlow.tsx.dialog.aria')}>
      <div className="invite-accept__bg" aria-hidden />
      <button type="button" className="invite-accept__dismiss" onClick={onClose} aria-label={t('demo.InviteAcceptanceFlow.tsx.dismiss.aria')}>
      ...
      <div className="invite-accept__stage">
        ...
        {step === 'landing' ? (
          <div className="invite-accept__card invite-accept__card--landing">
            <p className="invite-accept__from-mail">
              <Icon name="info" size={14} /> {t('demo.InviteAcceptanceFlow.tsx.landing.fromMail')}
            </p>
            ...
            <div className="invite-accept__ws-meta">
              ...
              <span><Icon name="folder" size={14} /> {WORKSPACE.projects} {t('demo.InviteAcceptanceFlow.tsx.landing.projectsUnit')}</span>
            </div>
        ...
        {step === 'auth' ? (
          <div className="invite-accept__card">
            ...
            <p className="invite-accept__subtitle">
              {t('demo.InviteAcceptanceFlow.tsx.auth.sentToPrefix')} <strong>{WORKSPACE.invitedEmail}</strong>{t('demo.InviteAcceptanceFlow.tsx.auth.sentToSuffix')}
            </p>
            <div className="invite-accept__tabs" role="tablist" aria-label={t('demo.InviteAcceptanceFlow.tsx.auth.tablistAria')}>
              <button
                type="button"
                role="tab"
        ...
        {step === 'confirm' ? (
          <div className="invite-accept__card">
            ...
            <p className="invite-accept__seat-note">
              <Icon name="info" size={14} /> {t('demo.InviteAcceptanceFlow.tsx.confirm.seatNote')}
            </p>
            <div className="invite-accept__actions">
        ...
        {step === 'declined' ? (
          <div className="invite-accept__card invite-accept__card--declined">
            ...
            <p className="invite-accept__subtitle">
              {t('demo.InviteAcceptanceFlow.tsx.declined.descPrefix')}<strong>{t('demo.InviteAcceptanceFlow.tsx.declined.descPending')}</strong>{t('demo.InviteAcceptanceFlow.tsx.declined.descSuffix')}
            </p>
            <div className="invite-accept__actions">
