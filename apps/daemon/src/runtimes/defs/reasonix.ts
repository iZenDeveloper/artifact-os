...
// REASONIX_ACP_SYSTEM_APPEND. This ensures the model follows Artifact OS's
// design workflow (artifact output, design system, skill instructions)
// instead of treating every request as a pure coding task.
const DESIGN_INSTRUCTIONS = `# Artifact OS integration — MUST follow

You are running inside Artifact OS, a design tool. The user message contains
