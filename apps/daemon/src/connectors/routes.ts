...
<html lang="en">
  <head>
    ...
    <title>${connectorLabelHtml} connected · Artifact OS</title>
    <style>
      :root {
        --bg: #faf9f7;
        --bg-panel: #ffffff;
  ...
  <body>
    <main aria-labelledby="callback-title">
      <div class="chrome" aria-label="Artifact OS">
        <span class="brand-mark" aria-hidden="true">OD</span>
        <span class="brand-title">Artifact OS</span>
      </div>
      <section class="content">
        ...
        <div>
          ...
          <p>Your connector is ready to use in Artifact OS.</p>
        </div>
    ...
    <script>
      (() => {
        ...
        function showManualCloseHint() {
          ...
          hint.textContent = 'Your browser blocked automatic closing. You can close this tab and return to Artifact OS.';
        }
        ...
        try {
          if (hasLiveOpener()) {
            ...
            hint.textContent = 'You can close this tab and return to Artifact OS.';
          }
        } catch {
          hint.textContent = 'You can close this tab and return to Artifact OS.';
        }
