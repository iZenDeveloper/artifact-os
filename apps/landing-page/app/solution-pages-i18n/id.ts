...
export const ID: SolutionLocaleCopy = {
  prototype: {
    title: 'Bangun prototipe interaktif dengan Artifact OS + Claude Code',
    description:
      'Ubah sebuah prompt menjadi prototipe multi-layar yang bisa diklik tanpa keluar dari terminal Anda. Artifact OS memberi coding agent Anda keterampilan desain, templat, dan sistem desain untuk menghasilkan prototipe nyata yang bisa Anda buka di browser.',
    ...
    tldrBody:
      'Artifact OS adalah lapisan desain untuk coding agent yang sudah Anda pakai. Untuk pembuatan prototipe, itu berarti beranjak dari ide satu paragraf menjadi prototipe bergaya yang bisa dinavigasi dalam satu sesi — tanpa alat desain, tanpa langkah ekspor, tanpa celah serah terima.',
    stepsTitle: 'Cara kerja pembuatan prototipe dengan Artifact OS',
    steps: [
      {
        title: 'Jelaskan alurnya',
        body: 'Beri tahu agent apa yang Anda bangun dengan bahasa biasa — “alur onboarding dengan layar sambutan, pemilih paket, dan konfirmasi”. Artifact OS memuat keterampilan prototipe sehingga agent tahu harus menghasilkan layar, bukan satu halaman.',
        imageAlt:
      ...
      },
      {
        ...
        body: 'Agent menerapkan sistem desain dan templat prototipe dari Artifact OS, sehingga setiap layar berbagi tipografi, jarak, dan komponen alih-alih terlihat seperti draf kasar. Anda mendapatkan satu set layar yang koheren, bukan mockup yang terpisah-pisah.',
        imageAlt:
    ...
    tableTitle: 'Pembuatan prototipe dengan Artifact OS vs. cara lama',
    tableColCapability: 'Yang Anda butuhkan',
    tableColWithOd: 'Dengan Artifact OS',
    ...
    galleryTitle: 'Prototipe yang dibangun orang dengan Artifact OS',
    galleryLead:
    ...
    faq: [
      {
        q: 'Apakah saya butuh alat desain seperti Figma untuk membuat prototipe dengan Artifact OS?',
        a: 'Tidak. Artifact OS berjalan di dalam coding agent Anda dan merender prototipe ke HTML. Anda menjelaskan alur dengan bahasa; agent menghasilkan layar. Tidak ada alat kanvas terpisah untuk dipelajari atau dibayar.',
      },
      {
      ...
      },
      {
        ...
        a: 'Artifact OS bekerja dengan Claude Code, Codex, Cursor Agent, Gemini CLI, dan belasan adapter resmi lainnya. Anda membawa kunci penyedia Anda sendiri; tidak ada yang dihosting untuk Anda.',
      },
      {
    ...
    ctaBody:
      'Beri bintang pada repo, pasang Artifact OS, dan ubah “bagaimana jika” Anda berikutnya menjadi sesuatu yang bisa Anda klik — di agent yang sudah Anda pakai.',
  },
  dashboard: {
    title: 'Hasilkan dashboard data dengan Artifact OS + Claude Code',
    description:
    ...
    lead: 'Beri tahu agent apa yang harus ditampilkan dan bagaimana seharusnya terasa. Artifact OS menyediakan pola grafik, sistem tata letak, dan bahasa visual sehingga Anda mendapatkan dashboard yang koheren dan layak presentasi — bukan tembok widget bergaya bawaan.',
    heroImageAlt:
    ...
    tldrTitle: 'Dalam satu kalimat',
    tldrBody:
      'Artifact OS mengubah spesifikasi metrik Anda dalam bahasa biasa menjadi dashboard bergaya yang dirender agent ke HTML — diversikan di repo Anda, bisa dihosting di mana saja, tanpa langganan BI per kursi.',
    stepsTitle: 'Cara kerja dashboard dengan Artifact OS',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'Artifact OS menyertakan templat grafik dan tata letak, sehingga tren menjadi grafik garis, rincian menjadi batang, dan rasio menjadi visual yang tepat — tipografi dan jarak yang konsisten di seluruh bagian alih-alih bawaan yang tak serasi.',
    ...
    tableTitle: 'Dashboard dengan Artifact OS vs. cara lama',
    tableColCapability: 'Yang Anda butuhkan',
    tableColWithOd: 'Dengan Artifact OS',
    ...
    galleryTitle: 'Dashboard yang dibangun orang dengan Artifact OS',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Tidak. Artifact OS merender dashboard ke HTML di dalam coding agent Anda. Anda menjelaskan metrik dan mengarahkannya ke data Anda; tidak ada platform BI terpisah untuk dilisensikan atau dipelajari.',
      },
      {
    ...
    ctaBody:
      'Beri bintang pada repo, pasang Artifact OS, dan ubah metrik Anda menjadi dashboard yang bisa Anda hosting di mana saja — di agent yang sudah Anda pakai.',
  },
  slides: {
    title: 'Hasilkan dek presentasi dengan Artifact OS + Claude Code',
    description:
      'Ubah sebuah kerangka menjadi dek slide yang dirancang dan sesuai merek tanpa membuka aplikasi presentasi. Artifact OS memberi coding agent Anda templat dek dan sistem visual, merender slide ke HTML yang bisa Anda presentasikan, ekspor, atau bagikan.',
    breadcrumb: 'Slide',
    label: 'Kasus penggunaan · Slide',
    heading: 'Dek yang terlihat dirancang, ditulis oleh sebuah prompt',
    lead: 'Serahkan kerangka dan nada kepada agent Anda. Artifact OS menerapkan templat dek dan sistem visual sehingga setiap slide tertata, terketik, dan sesuai merek — bukan daftar poin pada latar kosong.',
    heroImageAlt:
    ...
    tldrTitle: 'Dalam satu kalimat',
    tldrBody:
      'Artifact OS mengubah kerangka menjadi dek HTML yang dirancang dan dirender agent dalam satu sesi — presentasikan di browser, ekspor ke PDF atau PPTX, dan simpan sumbernya di repo Anda.',
    stepsTitle: 'Cara kerja dek dengan Artifact OS',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'Artifact OS menyertakan templat dek — editorial, Swiss-internasional, teknis gelap, dan lainnya. Agent menerapkan salah satunya sehingga tipografi, kisi, dan aksen tetap konsisten di setiap slide.',
    ...
    tableTitle: 'Dek dengan Artifact OS vs. cara lama',
    tableColCapability: 'Yang Anda butuhkan',
    tableColWithOd: 'Dengan Artifact OS',
    ...
    galleryTitle: 'Dek yang dibangun orang dengan Artifact OS',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Tidak. Artifact OS merender dek ke HTML di dalam coding agent Anda dan bisa mengekspor ke PDF atau PPTX. Anda presentasikan dari browser atau serahkan sebuah berkas — tanpa aplikasi presentasi untuk membangunnya.',
      },
      {
    ...
    ctaBody:
      'Beri bintang pada repo, pasang Artifact OS, dan ubah kerangka Anda menjadi dek yang dirancang — di agent yang sudah Anda pakai.',
  },
  image: {
    title: 'Hasilkan grafik sesuai merek dengan Artifact OS + Claude Code',
    description:
    ...
    lead: 'Jelaskan kartu atau sampul yang Anda perlukan. Artifact OS menyusunnya dengan tipe, kisi, dan warna merek Anda yang nyata — lalu merender ke HTML yang bisa Anda ekspor sebagai gambar, alih-alih bergumul dengan aplikasi desain atau templat generik.',
    heroImageAlt:
    ...
    tldrTitle: 'Dalam satu kalimat',
    tldrBody:
      'Artifact OS mengubah sebuah prompt menjadi grafik yang terketik dan sesuai merek yang dirender agent ke HTML dan diekspor ke PNG — bisa diulang, diversikan, dan bebas dari alat desain per kursi.',
    stepsTitle: 'Cara kerja grafik dengan Artifact OS',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'Artifact OS menarik warna, tipe, dan jarak Anda dari sistem desain yang dapat dipakai ulang, sehingga setiap kartu cocok dengan sisa merek Anda alih-alih terlihat seperti sekali pakai.',
    ...
    tableTitle: 'Grafik dengan Artifact OS vs. cara lama',
    tableColCapability: 'Yang Anda butuhkan',
    tableColWithOd: 'Dengan Artifact OS',
    ...
    galleryTitle: 'Grafik yang dibangun orang dengan Artifact OS',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Tidak. Artifact OS menyusun grafik dengan tata letak dan tipografi nyata — judul Anda, merek Anda, dimensi persis — dan merender ke HTML yang Anda ekspor sebagai PNG. Ini komposisi desain, bukan pembuatan piksel.',
      },
      {
    ...
    ctaBody:
      'Beri bintang pada repo, pasang Artifact OS, dan ubah sebuah prompt menjadi grafik sesuai merek — di agent yang sudah Anda pakai.',
  },
  video: {
    title: 'Hasilkan grafik gerak dan video pendek dengan Artifact OS + Claude Code',
    description:
    ...
    lead: 'Jelaskan momen yang Anda inginkan — sebuah penyingkapan judul, animasi data, outro logo. Artifact OS menyusun bingkai beranimasi dengan sistem merek Anda dan merendernya ke video, tanpa perlu suite grafik gerak.',
    heroImageAlt:
      'Ilustrasi bergaya editorial tentang sebuah naskah yang berubah menjadi rangkaian bingkai video beranimasi',
    tldrTitle: 'Dalam satu kalimat',
    tldrBody:
      'Artifact OS mengubah sebuah naskah menjadi bingkai beranimasi yang sesuai merek yang dirender agent ke video format pendek — disusun dari HTML, diversikan di repo Anda, tanpa editor linimasa untuk dipelajari.',
    stepsTitle: 'Cara kerja gerak dengan Artifact OS',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'Artifact OS menyediakan templat bingkai — light leak sinematik, judul glitch, outro logo — dan menerapkan warna serta tipe Anda, sehingga geraknya terlihat disengaja dan sesuai merek.',
    ...
    tableTitle: 'Gerak dengan Artifact OS vs. cara lama',
    tableColCapability: 'Yang Anda butuhkan',
    tableColWithOd: 'Dengan Artifact OS',
    ...
    galleryTitle: 'Gerak yang dibangun orang dengan Artifact OS',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Tidak. Artifact OS menyusun bingkai beranimasi dalam HTML dan merendernya ke video di dalam coding agent Anda. Tidak ada editor linimasa untuk dipelajari atau dilisensikan.',
      },
      {
    ...
    ctaBody:
      'Beri bintang pada repo, pasang Artifact OS, dan ubah sebuah naskah menjadi gerak — di agent yang sudah Anda pakai.',
  },
  designSystem: {
    title: 'Bangun dan terapkan sistem desain dengan Artifact OS + Claude Code',
    description:
    ...
    lead: 'Definisikan merek Anda sekali dan Artifact OS membawanya ke setiap keluaran — prototipe, dek, dashboard, grafik. Sistem hidup di repo Anda sebagai DESIGN.md yang dibaca agent, sehingga konsistensi bersifat otomatis, bukan manual.',
    heroImageAlt:
      'Ilustrasi bergaya editorial tentang sebuah sistem desain tunggal yang memancar menjadi banyak artefak sesuai merek',
    tldrTitle: 'Dalam satu kalimat',
    tldrBody:
      'Artifact OS menangkap merek Anda sebagai sistem desain portabel yang diterapkan agent ke setiap artefak — didefinisikan sekali di repo Anda, ditegakkan di mana-mana, tanpa alat desain pusat yang menjaganya.',
    stepsTitle: 'Cara kerja sistem desain dengan Artifact OS',
    steps: [
      {
        title: 'Tangkap sistemnya',
        body: 'Jelaskan merek Anda — warna, tipe, jarak, suara — atau arahkan agent ke situs yang ada untuk mengekstraknya. Artifact OS menuliskannya ke dalam DESIGN.md yang hidup di proyek Anda.',
        imageAlt: 'Ilustrasi sebuah merek yang ditangkap ke dalam satu berkas sistem desain',
      },
      {
        title: 'Mulai dari basis yang terbukti',
        body: 'Artifact OS menyertakan 140+ sistem desain referensi — dari Apple dan Linear hingga editorial dan brutalis. Fork salah satu yang dekat dengan merek Anda alih-alih mulai dari halaman kosong.',
    ...
    tableTitle: 'Sistem desain dengan Artifact OS vs. cara lama',
    tableColCapability: 'Yang Anda butuhkan',
    tableColWithOd: 'Dengan Artifact OS',
    ...
    galleryTitle: 'Sistem desain di Artifact OS',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Sebuah berkas DESIGN.md di repo Anda yang menangkap warna, tipe, jarak, komponen, dan suara. Setiap keterampilan Artifact OS membacanya, sehingga merek Anda diterapkan otomatis ke apa pun yang dihasilkan agent.',
      },
      {
        q: 'Apakah saya harus mulai dari nol?',
        a: 'Tidak. Artifact OS menyertakan 140+ sistem desain referensi yang bisa Anda fork — dari Apple dan Linear hingga editorial dan brutalis — lalu sesuaikan dengan merek Anda.',
      },
      {
    ...
    ctaBody:
      'Beri bintang pada repo, pasang Artifact OS, dan beri agent Anda satu merek untuk diterapkan di mana-mana — di agent yang sudah Anda pakai.',
  },
  roleSoloBuilder: {
    title: 'Artifact OS untuk solo builder & indie hacker',
    description:
      'Rilis layaknya satu tim, padahal seorang diri. Artifact OS mengubah coding agent Anda menjadi separuh sisi desain dari startup Anda — prototipe, halaman arahan, dasbor, dan visual merek, semuanya dari satu prompt, semuanya sesuai merek, semuanya di dalam repo Anda.',
    ...
    tldrTitle: 'Dalam satu kalimat',
    tldrBody:
      'Artifact OS adalah departemen desain yang tidak pernah dimiliki seorang founder tunggal: dari prompt menjadi artefak di setiap permukaan yang dibutuhkan produk Anda, dalam satu merek, tanpa serah terima dan tanpa alat tambahan.',
    stepsTitle: 'Cara solo builder memakai Artifact OS',
    steps: [
      {
    ...
    tableTitle: 'Membangun seorang diri dengan Artifact OS vs cara yang berat',
    tableColCapability: 'Yang Anda butuhkan',
    tableColWithOd: 'Dengan Artifact OS',
    ...
    galleryTitle: 'Dibangun seorang diri dengan Artifact OS',
    galleryLead:
    ...
    ctaBody:
      'Beri bintang pada repo, pasang Artifact OS, dan biarkan satu agent menjadi tim desain Anda — di dalam agent yang sudah Anda pakai.',
  },
  roleDesigner: {
    title: 'Artifact OS untuk desainer',
    description:
      'Habiskan waktu Anda untuk selera, bukan kerja melelahkan. Artifact OS membiarkan agent Anda menangani pekerjaan produksi berulang — varian, status, sistem desain lengkap — sementara Anda mengarahkan tampilan dan memegang keputusan akhir.',
    breadcrumb: 'Desainer',
    ...
    tldrTitle: 'Dalam satu kalimat',
    tldrBody:
      'Artifact OS adalah asisten produksi yang tak pernah lelah: Anda mendefinisikan sistem desain dan menentukan seleranya; agent menghasilkan sisanya, sesuai sistem, di dalam repo Anda.',
    stepsTitle: 'Cara desainer memakai Artifact OS',
    steps: [
      {
    ...
    tableTitle: 'Mendesain dengan Artifact OS vs cara manual',
    tableColCapability: 'Yang Anda butuhkan',
    tableColWithOd: 'Dengan Artifact OS',
    ...
    galleryTitle: 'Diarahkan dengan Artifact OS',
    galleryLead:
    ...
    ctaBody:
      'Beri bintang pada repo, pasang Artifact OS, dan biarkan agent menangani produksi sementara Anda menentukan seleranya — di dalam agent yang sudah Anda pakai.',
  },
  roleEngineering: {
    title: 'Artifact OS untuk engineer',
    description:
      'Lewati serah terima desain. Artifact OS mengubah sebuah DESIGN.md menjadi front-end nyata yang ditulis langsung oleh coding agent Anda — UI sesuai sistem, prototipe, dan dasbor, di dalam repo, tanpa bolak-balik ke Figma.',
    breadcrumb: 'Teknik',
    label: 'Untuk · Teknik',
    ...
    tldrTitle: 'Dalam satu kalimat',
    tldrBody:
      'Artifact OS menutup jurang dari desainer ke engineer dengan membuat sistem desain dapat dibaca mesin: agent yang sama yang menulis kode Anda menerapkan sistem dan merender UI nyata.',
    stepsTitle: 'Cara engineer memakai Artifact OS',
    steps: [
      {
    ...
    tableTitle: 'Front-end dengan Artifact OS vs cara serah terima',
    tableColCapability: 'Yang Anda butuhkan',
    tableColWithOd: 'Dengan Artifact OS',
    ...
    galleryTitle: 'Dibangun oleh engineer dengan Artifact OS',
    galleryLead:
    ...
    ctaBody:
      'Beri bintang pada repo, pasang Artifact OS, dan ubah sebuah DESIGN.md menjadi front-end — di dalam agent yang sudah Anda pakai.',
  },
  roleProductManagers: {
    title: 'Artifact OS untuk product manager',
    description:
      'Berhenti menunggu kapasitas desain untuk mengomunikasikan sebuah ide. Artifact OS memungkinkan seorang PM mengubah sebuah prompt menjadi prototipe yang dapat diklik atau wireframe — untuk menyelaraskan pemangku kepentingan dan memberi brief ke tim, tanpa tiket desain.',
    ...
    tldrTitle: 'Dalam satu kalimat',
    tldrBody:
      'Artifact OS memberi PM cara tanpa desain untuk membuat ide menjadi nyata: dari prompt ke prototipe untuk penyelarasan dan brief, tanpa menghabiskan anggaran desain tim.',
    stepsTitle: 'Cara seorang PM memakai Artifact OS',
    steps: [
      {
        title: 'Jelaskan alurnya',
    ...
    tableTitle: 'Kerja PM dengan Artifact OS vs menunggu desain',
    tableColCapability: 'Yang Anda butuhkan',
    tableColWithOd: 'Dengan Artifact OS',
    ...
    galleryTitle: 'Diprototipekan oleh PM dengan Artifact OS',
    galleryLead:
    ...
    ctaBody:
      'Beri bintang pada repo, pasang Artifact OS, dan ubah spesifikasi Anda berikutnya menjadi sesuatu yang bisa diklik orang — di dalam agent yang sudah Anda pakai.',
  },
  roleMarketing: {
    title: 'Artifact OS untuk tim pemasaran',
    description:
      'Rilis kampanye secepat konten. Artifact OS memungkinkan agent Anda menghasilkan halaman arahan, kartu sosial, dan visual kampanye dari sebuah prompt — sesuai merek, sesuai permintaan, tanpa mengantre desain.',
    ...
    tldrTitle: 'Dalam satu kalimat',
    tldrBody:
      'Artifact OS adalah sumber daya desain yang selalu siap untuk pemasaran: dari prompt ke aset untuk halaman arahan dan media sosial, sesuai merek, sehingga kampanye dirilis secepat Anda menulis naskah.',
    stepsTitle: 'Cara tim pemasaran memakai Artifact OS',
    steps: [
      {
    ...
    tableTitle: 'Pemasaran dengan Artifact OS vs kalang kabut seperti biasa',
    tableColCapability: 'Yang Anda butuhkan',
    tableColWithOd: 'Dengan Artifact OS',
    tableColWithout: 'Tanpa itu saat ini',
    tableRows: [
    ...
    galleryTitle: 'Dirilis oleh pemasaran dengan Artifact OS',
    galleryLead:
    ...
    ctaBody:
      'Beri bintang pada repo, pasang Artifact OS, dan ubah brief menjadi aset yang sesuai merek — di dalam agent yang sudah Anda pakai.',
  },
};
