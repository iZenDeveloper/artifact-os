...
export const PT_BR: SolutionLocaleCopy = {
  aiWireframeGenerator: {
    title: 'Gerador de wireframes com IA — do prompt ao wireframe com o Artifact OS',
    description:
      'Um gerador de wireframes com IA gratuito e de código aberto que transforma um prompt em wireframes editáveis de várias telas — e os leva até o código pronto para entregar. O Artifact OS roda dentro do agente de programação que você já usa, então o wireframe e o produto real compartilham uma única fonte.',
    ...
    tldrBody:
      'A maioria dos geradores de wireframes com IA entrega uma imagem que você reconstrói depois. O Artifact OS gera o wireframe dentro do seu agente de programação e o leva do prompt ao código pronto — sem etapa de exportação, sem lacuna na entrega, sem cobrança por assento.',
    stepsTitle: 'Como funciona o gerador de wireframes com IA',
    steps: [
      {
        title: 'Descreva a tela',
        body: 'Diga ao seu agente o que deseja transformar em wireframe em linguagem simples — «um dashboard com barra lateral, uma linha de estatísticas e uma tabela de atividade recente». O Artifact OS carrega a habilidade de wireframe para que o agente defina estrutura e hierarquia, não apenas uma única imagem estática.',
    ...
    tableTitle: 'Artifact OS vs. geradores de wireframes com IA tradicionais',
    tableColCapability: 'O que você precisa',
    tableColWithOd: 'Com o Artifact OS',
    ...
    galleryTitle: 'Wireframes feitos com o Artifact OS',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Sim. O Artifact OS é de código aberto e roda dentro do agente de programação que você já usa com as suas próprias chaves de provedor — não há cobrança por assento ou por crédito sobre o gerador de wireframes em si.',
      },
      {
      ...
      },
      {
        ...
        a: 'O Artifact OS funciona com Claude Code, Codex, Cursor Agent, Gemini CLI e mais de uma dezena de adaptadores nativos. Você traz as suas próprias chaves de provedor; nada é hospedado para você.',
      },
    ],
    ctaTitle: 'Gere seu primeiro wireframe hoje à noite',
    ctaBody:
      'Dê uma estrela ao repositório, instale o Artifact OS e transforme sua próxima ideia de tela em um wireframe editável — e depois em código pronto para entregar — no agente que você já usa.',
    relatedTitle: 'Ferramentas e guias relacionados',
    related: [
      { href: '/solutions/ai-ui-generator/', label: 'Gerador de UI com IA' },
      { href: '/solutions/design-to-code/', label: 'Do design ao código com o Artifact OS' },
      { href: '/blog/design-to-code-tools/', label: 'Melhores ferramentas de design para código' },
      { href: '/solutions/prototype/', label: 'Prototipagem com o Artifact OS' },
    ],
  },
  aiUiGenerator: {
    title: 'Gerador de UI com IA — do prompt à UI de produção com o Artifact OS',
    description:
      'Um gerador de UI com IA gratuito e de código aberto que transforma um prompt em uma interface real baseada em componentes — e a leva até o código pronto para entregar. O Artifact OS roda dentro do agente de programação que você já usa, então a UI gerada e o código de produção são o mesmo artefato.',
    ...
    tldrTitle: 'Em uma linha',
    tldrBody:
      'A maioria dos geradores de UI com IA entrega uma maquete ou um trecho de React descartável. O Artifact OS gera a UI dentro do seu agente de programação e a leva do prompt ao código pronto — componentes reais, o seu sistema de design, sem etapa de exportação, sem cobrança por assento.',
    stepsTitle: 'Como funciona o gerador de UI com IA',
    steps: [
      {
        title: 'Descreva a interface',
        body: 'Diga ao seu agente o que construir em linguagem simples — «uma página de configurações com barra lateral, seções em abas e uma barra de salvar». O Artifact OS carrega a habilidade de UI para que o agente recorra a componentes reais e a um sistema de design, não a uma tela avulsa.',
    ...
    tableTitle: 'Artifact OS vs. geradores de UI com IA tradicionais',
    tableColCapability: 'O que você precisa',
    tableColWithOd: 'Com o Artifact OS',
    ...
    galleryTitle: 'UI construída com o Artifact OS',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Sim. O Artifact OS é de código aberto e roda dentro do agente de programação que você já usa com as suas próprias chaves de provedor — não há cobrança por assento ou por crédito sobre o gerador de UI em si.',
      },
      {
    ...
    ctaBody:
      'Dê uma estrela ao repositório, instale o Artifact OS e transforme sua próxima ideia de interface em uma UI real baseada em componentes — e depois em código pronto para entregar — no agente que você já usa.',
    relatedTitle: 'Ferramentas e guias relacionados',
    related: [
      ...
      { href: '/solutions/designer/', label: 'Artifact OS para designers' },
    ],
  },
  designToCode: {
    title: 'Do design ao código — transforme um design em código entregue com o Artifact OS',
    description:
    ...
    tldrTitle: 'Em uma linha',
    tldrBody:
      'A maioria das ferramentas de design para código exporta um instantâneo único que você depois fica babá. O Artifact OS mantém o design e o código como um único artefato vivo dentro do seu agente — itere conversando, entregue código que é seu, sem cobrança por assento.',
    stepsTitle: 'Como funciona o design para código',
    steps: [
      {
        title: 'Comece a partir de um prompt ou de um design',
        body: 'Descreva a tela em linguagem simples ou aponte seu agente para uma direção de design. O Artifact OS carrega a habilidade certa para que o agente construa estrutura e componentes, não uma conversão avulsa e frágil.',
    ...
    tableTitle: 'Artifact OS vs. ferramentas de design para código tradicionais',
    tableColCapability: 'O que você precisa',
    tableColWithOd: 'Com o Artifact OS',
    ...
    galleryTitle: 'Entregue a partir do design com o Artifact OS',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Sim. O Artifact OS é de código aberto e roda dentro do agente de programação que você já usa com as suas próprias chaves de provedor — não há cobrança por assento ou por crédito sobre o fluxo de design para código em si.',
      },
      {
    ...
    ctaBody:
      'Dê uma estrela ao repositório, instale o Artifact OS e transforme sua próxima tela — prompt, wireframe ou design — em código limpo e pronto para entregar no agente que você já usa.',
    relatedTitle: 'Ferramentas e guias relacionados',
    related: [
      { href: '/solutions/ai-wireframe-generator/', label: 'Gerador de wireframes com IA' },
      { href: '/solutions/ai-ui-generator/', label: 'Gerador de UI com IA' },
      { href: '/blog/design-to-code-tools/', label: 'Melhores ferramentas de design para código' },
      { href: '/solutions/engineering/', label: 'Artifact OS para engenharia' },
    ],
  },
  aiLandingPageGenerator: {
    title: 'Gerador de landing page com IA — do prompt a uma landing page que você entrega',
    description:
      'Um gerador de landing page com IA gratuito e de código aberto que transforma um prompt em uma landing page real e responsiva — e a leva até o código pronto para entregar. O Artifact OS roda dentro do agente de programação que você já usa, então a página gerada e a página publicada são o mesmo artefato que é seu.',
    ...
    tldrTitle: 'Em uma linha',
    tldrBody:
      'A maioria dos construtores de landing page com IA prende a sua página dentro do editor deles e cobra por assento. O Artifact OS gera a landing page dentro do seu agente de programação e a leva do prompt ao código pronto — seções reais, a sua marca, sem etapa de exportação, sem cobrança por assento.',
    stepsTitle: 'Como funciona o gerador de landing page com IA',
    steps: [
      {
        title: 'Descreva a página',
        body: 'Diga ao seu agente o que construir em linguagem simples — «uma página de lançamento para um app de anotações: hero, três recursos, preços e um formulário de lista de espera». O Artifact OS carrega a habilidade de landing page para que o agente disponha seções reais com hierarquia clara.',
    ...
    tableTitle: 'Artifact OS vs. construtores de landing page com IA tradicionais',
    tableColCapability: 'O que você precisa',
    tableColWithOd: 'Com o Artifact OS',
    ...
    galleryTitle: 'Landing pages feitas com o Artifact OS',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Sim. O Artifact OS é de código aberto e roda dentro do agente de programação que você já usa com as suas próprias chaves de provedor — não há cobrança por assento ou por página sobre o gerador de landing page em si.',
      },
      {
    ...
    ctaBody:
      'Dê uma estrela ao repositório, instale o Artifact OS e transforme sua próxima ideia de lançamento em uma landing page real e responsiva — e depois em código pronto para entregar — no agente que você já usa.',
    relatedTitle: 'Ferramentas e guias relacionados',
    related: [
      { href: '/solutions/ai-ui-generator/', label: 'Gerador de UI com IA' },
      { href: '/solutions/design-to-code/', label: 'Do design ao código com o Artifact OS' },
  ...
  figmaToCode: {
    title: 'Do Figma ao código — transforme designs do Figma em código entregue com o Artifact OS',
    description:
    ...
    tldrTitle: 'Em uma linha',
    tldrBody:
      'A maioria dos plugins de Figma para código exporta um instantâneo único de marcação com posicionamento absoluto que você depois reescreve. O Artifact OS mantém o design e o código como um único artefato vivo dentro do seu agente — puxe frames pelo Figma MCP, itere conversando, entregue código que é seu.',
    stepsTitle: 'Como funciona o Figma para código',
    steps: [
      {
        title: 'Conecte o Figma ao seu agente',
        body: 'Com o Figma MCP configurado, seu agente de programação — Claude Code, Codex, Cursor Agent — pode ler um arquivo do Figma ou um frame selecionado diretamente. O Artifact OS carrega a habilidade certa para que o agente transforme a intenção de design em estrutura, não em uma cópia frágil de pixels.',
    ...
    tableTitle: 'Artifact OS vs. ferramentas de Figma para código tradicionais',
    tableColCapability: 'O que você precisa',
    tableColWithOd: 'Com o Artifact OS',
    ...
    galleryTitle: 'Entregue a partir do Figma com o Artifact OS',
    galleryLead:
    ...
    faq: [
      {
        q: 'Como o Artifact OS transforma o Figma em código?',
      ...
      {
        q: 'É gratuito?',
        a: 'Sim. O Artifact OS é de código aberto e roda dentro do agente de programação que você já usa com as suas próprias chaves de provedor — não há cobrança por assento ou por exportação sobre o fluxo de Figma para código em si.',
      },
      {
        q: 'Com quais agentes ele funciona?',
        a: 'O Artifact OS funciona com Claude Code, Codex, Cursor Agent, Gemini CLI e mais de uma dezena de adaptadores nativos. Você traz as suas próprias chaves de provedor e a sua própria configuração do Figma MCP; nada é hospedado para você.',
      },
    ],
    ctaTitle: 'Transforme seu próximo frame do Figma em código hoje à noite',
    ctaBody:
      'Dê uma estrela ao repositório, instale o Artifact OS, conecte o Figma MCP e transforme seu próximo design do Figma em código limpo e pronto para entregar no agente que você já usa.',
    relatedTitle: 'Ferramentas e guias relacionados',
    related: [
      { href: '/solutions/design-to-code/', label: 'Do design ao código com o Artifact OS' },
      { href: '/solutions/ai-ui-generator/', label: 'Gerador de UI com IA' },
  ...
  screenshotToCode: {
    title: 'Screenshot para código — transforme uma captura de tela em código com o Artifact OS',
    description:
    ...
    tldrTitle: 'Em uma linha',
    tldrBody:
      'A maioria das ferramentas de screenshot para código cospe uma marcação única de posicionamento absoluto que você depois reescreve. O Artifact OS reconstrói a captura de tela dentro do seu agente de programação como código limpo e baseado em componentes — estrutura real, o seu sistema de design, sem etapa de exportação, sem cobrança por assento.',
    stepsTitle: 'Como o screenshot para código funciona',
    steps: [
      {
        title: 'Solte a captura de tela',
        body: 'Entregue ao seu agente uma imagem da tela que você quer — uma captura de tela de um app, de um site ou de um design. O Artifact OS carrega a habilidade certa para que o agente leia o layout e a intenção, não apenas os pixels.',
    ...
    tableTitle: 'Artifact OS vs. ferramentas típicas de screenshot para código',
    tableColCapability: 'O que você precisa',
    tableColWithOd: 'Com o Artifact OS',
    ...
    galleryTitle: 'Reconstruído a partir de uma captura de tela com o Artifact OS',
    galleryLead:
    ...
    faq: [
      {
        q: 'Como o Artifact OS transforma uma captura de tela em código?',
        a: 'Você entrega ao seu agente de programação uma imagem da tela e o Artifact OS carrega a habilidade certa para que o agente a reconstrua como código limpo e baseado em componentes — lendo o layout e a intenção, não apenas traçando pixels.',
      },
      {
        q: 'Que tipo de código ele produz?',
      ...
      {
        q: 'É gratuito?',
        a: 'Sim. O Artifact OS é de código aberto e roda dentro do agente de programação que você já usa com as suas próprias chaves de provedor — não há cobrança por assento ou por crédito sobre o fluxo de screenshot para código em si.',
      },
      {
        q: 'Com quais agentes ele funciona?',
        a: 'O Artifact OS funciona com Claude Code, Codex, Cursor Agent, Gemini CLI e mais de uma dezena de adaptadores nativos. Você traz as suas próprias chaves de provedor; nada é hospedado para você.',
    ...
    ctaBody:
      'Dê uma estrela ao repositório, instale o Artifact OS e transforme uma captura de tela da tela que você quer em código limpo e pronto para entregar no agente que você já usa.',
    relatedTitle: 'Ferramentas e guias relacionados',
    related: [
      { href: '/solutions/figma-to-code/', label: 'Do Figma ao código com o Artifact OS' },
      { href: '/solutions/design-to-code/', label: 'Do design ao código com o Artifact OS' },
      { href: '/solutions/ai-ui-generator/', label: 'Gerador de UI com IA' },
      { href: '/solutions/engineering/', label: 'Artifact OS para engenharia' },
    ],
  ...
  htmlToPpt: {
    title: 'HTML to PPT — transforme HTML em um PowerPoint editável com o Artifact OS',
    description:
    ...
    tldrTitle: 'Em uma linha',
    tldrBody:
      'A maioria dos conversores HTML-to-PPT achata sua página em imagens estáticas de slides que você não pode editar. O Artifact OS monta a apresentação como HTML dentro do seu agente de programação e exporta um .pptx real e editável — texto e formas nativos, o seu sistema de design, sem medidor por licença, sem dependência do fornecedor.',
    stepsTitle: 'Como funciona o HTML to PPT',
    steps: [
      {
        title: 'Comece de um HTML, um documento ou um prompt',
        body: 'Aponte seu agente para uma página HTML, um documento markdown ou apenas descreva a apresentação. O Artifact OS carrega a habilidade certa para que o agente leia estrutura e intenção — títulos, seções, dados — não apenas a marcação bruta.',
      ...
      },
      {
        ...
        body: 'O pptx-generator do Artifact OS transforma a apresentação HTML em um PowerPoint real — formas nativas, texto editável e gráficos que você ainda pode alterar — com uma auditoria de fidelidade de HTML-to-PPTX, não uma imagem estática por slide.',
    ...
    tableTitle: 'Artifact OS vs. conversores HTML-to-PPT típicos',
    tableColCapability: 'O que você precisa',
    tableColWithOd: 'Com o Artifact OS',
    ...
    galleryLead:
      'Apresentações reais renderizadas pelo Artifact OS, prontas para exportar para um .pptx editável. Escolha um tema próximo do seu conteúdo, descreva sua variação e o agente monta a apresentação — depois entrega o PowerPoint que é seu.',
    gallery: [
    ...
    faq: [
      {
        q: 'Como o Artifact OS transforma HTML em PPT?',
        a: 'Seu agente de programação monta o conteúdo em uma apresentação HTML limpa e, então, a habilidade pptx-generator do Artifact OS a exporta para um .pptx real e editável — formas e texto nativos, auditados quanto à fidelidade de HTML-to-PPTX, não uma imagem estática por slide.',
      },
      {
      ...
      {
        q: 'É gratuito?',
        a: 'Sim. O Artifact OS é de código aberto e roda dentro do agente de programação que você já usa com suas próprias chaves — não há medidor por arquivo ou por crédito no fluxo HTML-to-PPT.',
      },
      {
        q: 'Qual a diferença em relação a gerar slides?',
        a: 'Gerar uma apresentação normalmente parte de um prompt ou de um roteiro; o HTML to PPT parte de HTML ou markdown que você já tem e foca na exportação de um .pptx editável. Ambos usam o mesmo motor de apresentações do Artifact OS — veja o caso de uso de slides para o fluxo que começa pelo roteiro.',
      },
    ],
    ctaTitle: 'Transforme sua próxima apresentação HTML em um PPT editável',
    ctaBody:
      'Dê uma estrela ao repositório, instale o Artifact OS e transforme HTML — ou um prompt — em uma apresentação limpa e um .pptx real e editável, no agente que você já usa.',
    relatedTitle: 'Ferramentas e guias relacionados',
    related: [
  ...
  aiPrototypeGenerator: {
    ...
    lead: 'Descreva o fluxo e deixe seu agente gerar um protótipo real e clicável — telas conectadas, estilos consistentes, interações funcionais. Diferente dos geradores de protótipos que param no mockup, o Artifact OS leva o mesmo artefato até o código entregue, no agente que você já executa.',
    heroImageAlt:
    ...
    tldrTitle: 'Em uma linha',
    tldrBody:
      'A maioria dos geradores de protótipos com IA (Figma, Cursor, Penpot) para em um mockup clicável que você depois reconstrói. O Artifact OS gera o protótipo dentro do seu agente de programação e o leva do prompt até o código entregue — sem etapa de exportação, sem lacuna de handoff, sem cobrança por assento.',
    stepsTitle: 'Como o gerador de protótipos com IA funciona',
    steps: [
      {
        title: 'Descreva o fluxo',
        body: 'Conte ao seu agente a jornada em linguagem simples — "um fluxo de onboarding: cadastro, seletor de plano e um dashboard". O Artifact OS carrega a habilidade de protótipo para que o agente disponha telas conectadas, não um único frame estático.',
    ...
    tableTitle: 'Artifact OS vs. geradores típicos de protótipos com IA',
    tableColCapability: 'O que você precisa',
    tableColWithOd: 'Com o Artifact OS',
    ...
    galleryTitle: 'Protótipos criados com o Artifact OS',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Sim. O Artifact OS é de código aberto e roda dentro do agente de programação que você já usa com as suas próprias chaves de provedor — não há cobrança por assento ou por crédito sobre o gerador de protótipos em si.',
      },
      {
        q: 'Como ele difere dos geradores de protótipos do Figma, Cursor ou Penpot?',
        a: 'Esses param em um mockup clicável dentro do app deles. O Artifact OS gera o protótipo no seu agente de programação e leva o mesmo artefato até o código entregue que você possui — sem exportação, sem reconstrução para produção.',
      },
      {
    ...
    ctaBody:
      'Dê uma estrela ao repositório, instale o Artifact OS e transforme seu próximo fluxo em um protótipo clicável — e depois em código entregue — no agente que você já usa.',
    relatedTitle: 'Ferramentas e guias relacionados',
    related: [
      { href: '/solutions/prototype/', label: 'Prototipagem com o Artifact OS' },
      { href: '/solutions/ai-wireframe-generator/', label: 'Gerador de wireframes com IA' },
  ...
  prototype: {
    title: 'Crie protótipos interativos com Artifact OS + Claude Code',
    description:
      'Transforme um prompt em um protótipo clicável de várias telas sem sair do terminal. O Artifact OS dá ao seu agente de programação as habilidades de design, os modelos e o sistema de design para entregar protótipos reais que você abre no navegador.',
    ...
    tldrTitle: 'Em uma linha',
    tldrBody:
      'O Artifact OS é a camada de design para o agente de programação que você já usa. Para prototipagem, isso significa ir de uma ideia de um parágrafo a um protótipo navegável e estilizado em uma única sessão — sem ferramenta de design, sem etapa de exportação, sem lacuna na entrega.',
    stepsTitle: 'Como funciona a prototipagem com o Artifact OS',
    steps: [
      {
        title: 'Descreva o fluxo',
        body: 'Diga ao seu agente o que você está construindo em linguagem simples — «um fluxo de onboarding com tela de boas-vindas, seletor de planos e confirmação». O Artifact OS carrega a habilidade de protótipo para que o agente saiba que deve produzir telas, não uma única página.',
        imageAlt:
      ...
      },
      {
        ...
        body: 'O agente aplica um sistema de design e modelos de protótipo do Artifact OS, então cada tela compartilha tipografia, espaçamento e componentes em vez de parecer um rascunho. Você obtém um conjunto coerente de telas, não maquetes desconexas.',
        imageAlt:
    ...
    tableTitle: 'Prototipagem com Artifact OS vs. o jeito antigo',
    tableColCapability: 'O que você precisa',
    tableColWithOd: 'Com o Artifact OS',
    ...
    galleryTitle: 'Protótipos que as pessoas criaram com o Artifact OS',
    galleryLead:
    ...
    faq: [
      {
        q: 'Preciso de uma ferramenta de design como o Figma para prototipar com o Artifact OS?',
        a: 'Não. O Artifact OS roda dentro do seu agente de programação e renderiza protótipos em HTML. Você descreve o fluxo em palavras; o agente produz as telas. Não há uma ferramenta de canvas separada para aprender ou pagar.',
      },
      {
      ...
      },
      {
        ...
        a: 'O Artifact OS funciona com Claude Code, Codex, Cursor Agent, Gemini CLI e mais uma dúzia de adaptadores nativos. Você usa suas próprias chaves de provedor; nada é hospedado por você.',
      },
      {
    ...
    ctaBody:
      'Dê uma estrela ao repositório, instale o Artifact OS e transforme seu próximo «e se...» em algo que você pode clicar — no agente que você já usa.',
  },
  dashboard: {
    title: 'Gere painéis de dados com Artifact OS + Claude Code',
    description:
    ...
    lead: 'Diga ao seu agente o que mostrar e como deve parecer. O Artifact OS fornece os padrões de gráfico, o sistema de layout e a linguagem visual para que você obtenha um painel coerente e apresentável — não uma parede de widgets com estilo padrão.',
    heroImageAlt:
      'Ilustração editorial de números brutos à esquerda fluindo para um painel limpo de gráficos e cartões de KPI à direita',
    tldrTitle: 'Em uma linha',
    tldrBody:
      'O Artifact OS transforma uma especificação em linguagem simples das suas métricas em um painel estilizado que seu agente renderiza em HTML — versionado no seu repositório, hospedável onde quiser, sem assinatura de BI por licença.',
    stepsTitle: 'Como funcionam os painéis com o Artifact OS',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'O Artifact OS traz modelos de gráfico e layout, então tendências viram gráficos de linha, divisões viram barras e proporções viram a visualização certa — tipografia e espaçamento consistentes em tudo, em vez de padrões desencontrados.',
    ...
    tableTitle: 'Painéis com Artifact OS vs. o jeito antigo',
    tableColCapability: 'O que você precisa',
    tableColWithOd: 'Com o Artifact OS',
    ...
    galleryTitle: 'Painéis que as pessoas criaram com o Artifact OS',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Não. O Artifact OS renderiza painéis em HTML dentro do seu agente de programação. Você descreve as métricas e o aponta para os seus dados; não há uma plataforma de BI separada para licenciar ou aprender.',
      },
      {
    ...
    ctaBody:
      'Dê uma estrela ao repositório, instale o Artifact OS e transforme suas métricas em um painel que você pode hospedar onde quiser — no agente que você já usa.',
  },
  slides: {
    title: 'Gere apresentações com Artifact OS + Claude Code',
    description:
      'Transforme um roteiro em uma apresentação projetada e fiel à marca sem abrir um app de apresentações. O Artifact OS dá ao seu agente de programação modelos de slides e um sistema visual, renderizando os slides em HTML que você apresenta, exporta ou compartilha.',
    breadcrumb: 'Slides',
    label: 'Caso de uso · Slides',
    heading: 'Apresentações com cara de projetadas, escritas por um prompt',
    lead: 'Entregue ao seu agente um roteiro e um tom. O Artifact OS aplica um modelo de apresentação e um sistema visual para que cada slide fique disposto, composto e fiel à marca — não uma lista de tópicos sobre um fundo em branco.',
    heroImageAlt:
      'Ilustração editorial de um roteiro à esquerda virando uma sequência de slides de apresentação projetados à direita',
    tldrTitle: 'Em uma linha',
    tldrBody:
      'O Artifact OS transforma um roteiro em uma apresentação HTML projetada que seu agente renderiza em uma única sessão — apresente no navegador, exporte para PDF ou PPTX e mantenha a fonte no seu repositório.',
    stepsTitle: 'Como funcionam as apresentações com o Artifact OS',
    steps: [
      {
        title: 'Dê o roteiro',
      ...
      },
      {
        ...
        body: 'O Artifact OS traz modelos de apresentação — editorial, suíço-internacional, técnico escuro e mais. O agente aplica um para que tipografia, grade e acentos fiquem consistentes em cada slide.',
    ...
    tableTitle: 'Apresentações com Artifact OS vs. o jeito antigo',
    tableColCapability: 'O que você precisa',
    tableColWithOd: 'Com o Artifact OS',
    ...
    galleryTitle: 'Apresentações que as pessoas criaram com o Artifact OS',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Não. O Artifact OS renderiza apresentações em HTML dentro do seu agente de programação e pode exportar para PDF ou PPTX. Você apresenta pelo navegador ou entrega um arquivo — não é preciso um app de apresentações para criá-la.',
      },
      {
    ...
    ctaBody:
      'Dê uma estrela ao repositório, instale o Artifact OS e transforme seu roteiro em uma apresentação projetada — no agente que você já usa.',
    relatedTitle: 'Ferramentas e guias relacionados',
    related: [
      { href: '/solutions/html-to-ppt/', label: 'HTML to PPT com o Artifact OS' },
      { href: '/solutions/design-to-code/', label: 'Do design ao código com o Artifact OS' },
      { href: '/plugins/templates/', label: 'Explorar modelos de apresentação' },
      { href: '/solutions/marketing/', label: 'Artifact OS para marketing' },
    ],
  ...
  image: {
    title: 'Gere gráficos fiéis à marca com Artifact OS + Claude Code',
    description:
    ...
    lead: 'Descreva o cartão ou a capa que você precisa. O Artifact OS o compõe com tipografia, grade e as cores da sua marca reais — depois renderiza em HTML que você exporta como imagem, em vez de brigar com um app de design ou um modelo genérico.',
    heroImageAlt:
      'Ilustração editorial de um prompt virando um conjunto de cartões para redes e capas de artigos dispostos',
    tldrTitle: 'Em uma linha',
    tldrBody:
      'O Artifact OS transforma um prompt em um gráfico composto e fiel à marca que seu agente renderiza em HTML e exporta para PNG — repetível, versionado e livre de ferramentas de design por licença.',
    stepsTitle: 'Como funcionam os gráficos com o Artifact OS',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'O Artifact OS puxa suas cores, tipografia e espaçamento de um sistema de design reutilizável, então cada cartão combina com o restante da sua marca em vez de parecer algo avulso.',
    ...
    tableTitle: 'Gráficos com Artifact OS vs. o jeito antigo',
    tableColCapability: 'O que você precisa',
    tableColWithOd: 'Com o Artifact OS',
    ...
    galleryTitle: 'Gráficos que as pessoas criaram com o Artifact OS',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Não. O Artifact OS compõe gráficos com layout e tipografia reais — sua manchete, sua marca, dimensões exatas — e renderiza em HTML que você exporta como PNG. É composição de design, não geração de pixels.',
      },
      {
    ...
    ctaBody:
      'Dê uma estrela ao repositório, instale o Artifact OS e transforme um prompt em um gráfico fiel à marca — no agente que você já usa.',
  },
  video: {
    title: 'Gere motion graphics e vídeo curto com Artifact OS + Claude Code',
    description:
    ...
    lead: 'Descreva o momento que você quer — uma revelação de título, uma animação de dados, um encerramento com logo. O Artifact OS compõe quadros animados com o seu sistema de marca e os renderiza em vídeo, sem suíte de motion graphics.',
    heroImageAlt:
      'Ilustração editorial de um roteiro virando uma sequência de quadros de vídeo animados',
    tldrTitle: 'Em uma linha',
    tldrBody:
      'O Artifact OS transforma um roteiro em quadros animados e fiéis à marca que seu agente renderiza em vídeo de formato curto — compostos a partir de HTML, versionados no seu repositório, sem editor de linha do tempo para aprender.',
    stepsTitle: 'Como funciona o movimento com o Artifact OS',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'O Artifact OS fornece modelos de quadro — vazamentos de luz cinematográficos, títulos com glitch, encerramentos com logo — e aplica suas cores e tipografia, então o movimento parece intencional e fiel à marca.',
    ...
    tableTitle: 'Movimento com Artifact OS vs. o jeito antigo',
    tableColCapability: 'O que você precisa',
    tableColWithOd: 'Com o Artifact OS',
    ...
    galleryTitle: 'Movimento que as pessoas criaram com o Artifact OS',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Não. O Artifact OS compõe quadros animados em HTML e os renderiza em vídeo dentro do seu agente de programação. Não há editor de linha do tempo para aprender ou licenciar.',
      },
      {
    ...
    ctaBody:
      'Dê uma estrela ao repositório, instale o Artifact OS e transforme um roteiro em movimento — no agente que você já usa.',
  },
  designSystem: {
    title: 'Crie e aplique um sistema de design com Artifact OS + Claude Code',
    description:
    ...
    lead: 'Defina sua marca uma vez e o Artifact OS a leva para cada saída — protótipos, apresentações, painéis, gráficos. O sistema vive no seu repositório como um DESIGN.md que o agente lê, então a consistência é automática, não manual.',
    heroImageAlt:
      'Ilustração editorial de um único sistema de design irradiando para muitos artefatos fiéis à marca',
    tldrTitle: 'Em uma linha',
    tldrBody:
      'O Artifact OS captura sua marca como um sistema de design portátil que seu agente aplica a cada artefato — definido uma vez no seu repositório, aplicado em todo lugar, sem uma ferramenta de design central para controlar o acesso.',
    stepsTitle: 'Como funcionam os sistemas de design com o Artifact OS',
    steps: [
      {
        title: 'Capture o sistema',
        body: 'Descreva sua marca — cores, tipografia, espaçamento, voz — ou aponte o agente para um site existente para extraí-la. O Artifact OS a escreve em um DESIGN.md que vive no seu projeto.',
      ...
      },
      {
        ...
        body: 'O Artifact OS traz mais de 140 sistemas de design de referência — de Apple e Linear a editoriais e brutalistas. Faça um fork de um próximo da sua marca em vez de começar de uma página em branco.',
    ...
    tableTitle: 'Sistemas de design com Artifact OS vs. o jeito antigo',
    tableColCapability: 'O que você precisa',
    tableColWithOd: 'Com o Artifact OS',
    ...
    galleryTitle: 'Sistemas de design no Artifact OS',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Um arquivo DESIGN.md no seu repositório que captura cores, tipografia, espaçamento, componentes e voz. Cada habilidade do Artifact OS o lê, então sua marca é aplicada automaticamente ao que o agente produzir.',
      },
      {
        q: 'Tenho que começar do zero?',
        a: 'Não. O Artifact OS traz mais de 140 sistemas de design de referência que você pode forkear — de Apple e Linear a editoriais e brutalistas — e depois adaptar à sua marca.',
      },
      {
    ...
    ctaBody:
      'Dê uma estrela ao repositório, instale o Artifact OS e dê ao seu agente uma única marca para aplicar em todo lugar — no agente que você já usa.',
  },
  roleSoloBuilder: {
    title: 'Artifact OS para criadores solo e indie hackers',
    description:
      'Entregue como um time de uma pessoa só. O Artifact OS transforma seu agente de código na metade de design da sua startup — protótipos, landing pages, dashboards e peças de marca, tudo a partir de um prompt, tudo dentro da marca, tudo no seu repositório.',
    ...
    tldrTitle: 'Em uma linha',
    tldrBody:
      'O Artifact OS é o departamento de design que um fundador solo nunca teve: do prompt ao artefato em cada superfície que seu produto precisa, dentro de uma só marca, com zero repasse e sem ferramentas extras.',
    stepsTitle: 'Como um criador solo usa o Artifact OS',
    steps: [
      {
    ...
    tableTitle: 'Construir solo com o Artifact OS vs. fazer do jeito difícil',
    tableColCapability: 'O que você precisa',
    tableColWithOd: 'Com o Artifact OS',
    ...
    galleryTitle: 'Feito solo com o Artifact OS',
    galleryLead:
    ...
    ctaBody:
      'Dê uma estrela ao repositório, instale o Artifact OS e deixe um agente ser seu time de design — dentro do agente que você já usa.',
  },
  roleDesigner: {
    title: 'Artifact OS para designers',
    description:
      'Gaste seu tempo com bom gosto, não com trabalho braçal. O Artifact OS deixa seu agente cuidar do trabalho de produção repetitivo — variações, estados, design systems inteiros — enquanto você dirige o visual e mantém a palavra final.',
    breadcrumb: 'Designer',
    ...
    tldrTitle: 'Em uma linha',
    tldrBody:
      'O Artifact OS é o assistente de produção que nunca se cansa: você define o design system e aplica o bom gosto; o agente gera o resto, dentro do sistema, no seu repositório.',
    stepsTitle: 'Como um designer usa o Artifact OS',
    steps: [
      {
    ...
    tableTitle: 'Desenhar com o Artifact OS vs. o jeito manual',
    tableColCapability: 'O que você precisa',
    tableColWithOd: 'Com o Artifact OS',
    ...
    galleryTitle: 'Dirigido com o Artifact OS',
    galleryLead:
    ...
    ctaBody:
      'Dê uma estrela ao repositório, instale o Artifact OS e deixe o agente cuidar da produção enquanto você aplica o bom gosto — dentro do agente que você já usa.',
  },
  roleEngineering: {
    title: 'Artifact OS para engenheiros',
    description:
      'Pule o repasse de design. O Artifact OS transforma um DESIGN.md em front-end de verdade que seu agente de código escreve direto — UI dentro do sistema, protótipos e dashboards, no repositório, sem idas e vindas ao Figma.',
    ...
    tldrTitle: 'Em uma linha',
    tldrBody:
      'O Artifact OS fecha a lacuna de designer para engenheiro tornando o design system legível por máquina: o mesmo agente que escreve seu código aplica o sistema e renderiza UI de verdade.',
    stepsTitle: 'Como um engenheiro usa o Artifact OS',
    steps: [
      {
    ...
    tableTitle: 'Front-end com o Artifact OS vs. o jeito do repasse',
    tableColCapability: 'O que você precisa',
    tableColWithOd: 'Com o Artifact OS',
    ...
    galleryTitle: 'Construído por engenheiros com o Artifact OS',
    galleryLead:
    ...
    ctaBody:
      'Dê uma estrela ao repositório, instale o Artifact OS e transforme um DESIGN.md em front-end — dentro do agente que você já usa.',
  },
  roleProductManagers: {
    title: 'Artifact OS para product managers',
    description:
      'Pare de esperar pela banda de design para comunicar uma ideia. O Artifact OS deixa um PM transformar um prompt em um protótipo clicável ou wireframe — para alinhar stakeholders e orientar o time, sem um ticket de design.',
    ...
    tldrTitle: 'Em uma linha',
    tldrBody:
      'O Artifact OS dá ao PM um jeito sem design de tornar ideias tangíveis: do prompt ao protótipo para alinhamento e orientação, sem gastar o orçamento de design do time.',
    stepsTitle: 'Como um PM usa o Artifact OS',
    steps: [
      {
        title: 'Descreva o fluxo',
    ...
    tableTitle: 'Trabalho de PM com o Artifact OS vs. esperar pelo design',
    tableColCapability: 'O que você precisa',
    tableColWithOd: 'Com o Artifact OS',
    ...
    galleryTitle: 'Prototipado por PMs com o Artifact OS',
    galleryLead:
    ...
    ctaBody:
      'Dê uma estrela ao repositório, instale o Artifact OS e transforme sua próxima especificação em algo em que as pessoas possam clicar — dentro do agente que você já usa.',
  },
  roleMarketing: {
    title: 'Artifact OS para times de marketing',
    description:
      'Entregue campanhas na velocidade do conteúdo. O Artifact OS deixa seu agente produzir landing pages, cards para redes e visuais de campanha a partir de um prompt — dentro da marca, sob demanda, sem entrar na fila do design.',
    ...
    tldrTitle: 'Em uma linha',
    tldrBody:
      'O Artifact OS é o recurso de design sempre disponível para o marketing: do prompt ao ativo para landing pages e redes, dentro da marca, para que as campanhas saiam na velocidade em que você escreve o texto.',
    stepsTitle: 'Como um time de marketing usa o Artifact OS',
    steps: [
      {
        title: 'Trave a marca',
    ...
    tableTitle: 'Marketing com o Artifact OS vs. a correria de sempre',
    tableColCapability: 'O que você precisa',
    tableColWithOd: 'Com o Artifact OS',
    tableColWithout: 'Sem ele hoje',
    tableRows: [
    ...
    galleryTitle: 'Entregue pelo marketing com o Artifact OS',
    galleryLead:
    ...
    ctaBody:
      'Dê uma estrela ao repositório, instale o Artifact OS e transforme briefings em ativos dentro da marca — dentro do agente que você já usa.',
  },
};
