...
export interface HomeExtra {
  ...
  stepDesc4: string;
  capTitle: string;
  labsPre: string; // before <em>Artifact OS</em>
  labsPost: string; // after <em>Artifact OS</em> (incl. punctuation)
  // Lead paragraph under the "What can you make with Artifact OS?" heading.
...
const en: HomeExtra = {
  ...
  heroSub:
    'Artifact OS is the open-source, local vibe design workspace — it turns the coding agents you already run into a design engine that carries you from idea to prototype, web, slides, and HTML video, all finished on your own machine. Agent-native, with 21 coding agents, {systems} design systems, and an Apache-2.0 license.',
  aboutKicker: 'Why Artifact OS?',
  aboutStatement:
    'Artifact OS is the open-source, agentic vibe design workspace — it turns the coding agent you already run into a design engine whose output you fully own. When an LLM first proved it can truly design — real design work, not just copy — that capability arrived closed, hosted, and model-locked. Artifact OS opens it up: local, BYOK, Apache-2.0.',
  ...
  labsPost: '?',
  labsLead:
    'Prototypes, landing pages, slide decks, dashboards, brand and design systems — even HTML video. Artifact OS turns each into real, runnable files, driven by your own coding agent and ready to ship or hand off to engineering.',
  ...
  testiPost: 'are building Artifact OS together',
  newsTitle: 'The Artifact OS newsletter',
  newsDesc:
  ...
  faqTitle: 'Artifact OS FAQ — open source, local-first, and Claude Design alternative',
  footProduct: 'Product',
...
const zh: HomeExtra = {
  ...
  heroSub:
    'Artifact OS 是开源、本地的 vibe design workspace——把你已经在用的 coding agent 变成设计引擎，从想法到原型、网页、Slides、HTML 视频，全流程在你自己的设备上完成。\nAgent-native，接入 21 个 Coding Agent、{systems} 个 Design System，Apache-2.0。',
  aboutKicker: '为什么选择 Artifact OS？',
  aboutStatement:
    'Artifact OS 是开源、agentic 的 vibe design workspace——把你已经在用的 coding agent 变成一台产出完全归你的设计引擎。当 LLM 第一次证明它能真正做设计——是真的设计稿，不是写文案——这份能力却是闭源、托管、锁模型的。Artifact OS 把它打开：本地、BYOK、Apache-2.0。',
  aboutTab1: '桌面端原生',
  aboutTab2: '不造 Agent，接入 Agent',
  aboutTab3: '越用越懂你',
  aboutCap1: '设计在桌面端发生。\n本地文件、Figma 导出、代码仓库直接可读，Agent 拥有终端执行全部能力',
  aboutCap2: '你电脑上的 Claude Code / Codex / Cursor 已经够强。\nArtifact OS 做的是把它们接进完整设计工作流',
  ...
  labsPost: ' 能产出什么？',
  labsLead:
    '原型、落地页、Slides、仪表盘、品牌与设计系统——甚至 HTML 视频。Artifact OS 把每一样都变成可运行的真实文件，由你自己的 coding agent 驱动，随时交付或交接给工程。',
  methodTitle: '接入 21+ Coding Agent，零配置',
  ctaTitle: '让最前沿的 AI 设计能力回到每一个创作者的桌上',
  testiPre: '来自全球，',
  testiMid: ' 贡献者',
  testiPost: '正在一起构建 Artifact OS',
  newsTitle: 'Artifact OS 订阅',
  newsDesc: '新模板、设计系统更新、大使活动与产品动态，直接发到你的邮箱。',
  newsBtn: '订阅',
  newsDone: '已收到，感谢关注！',
  newsError: '订阅失败，请稍后重试。',
  faqTitle: 'Artifact OS 常见问题 —— 开源、本地优先、Claude Design 替代',
  footProduct: '产品',
  footCommunity: '社区',
  footLegal: '法律',
  footPartners: '伙伴',
...
const zhTw: HomeExtra = {
  ...
  aboutKicker: '為什麼選擇 Artifact OS？',
  aboutStatement:
    '2026 年 4 月，Claude Design 首次證明 LLM 能真正做設計，不是寫文章，而是直接產出設計稿。但它閉源、付費、只跑在雲端，模型鎖 Anthropic，換 Agent、自部署、BYOK 全做不到。Artifact OS 讓這套能力變得開放。',
  aboutTab1: '桌面端原生',
  aboutTab2: '不造 Agent，接入 Agent',
  aboutTab3: '越用越懂你',
  aboutCap1: '設計在桌面端發生。\n本地檔案、Figma 匯出、程式碼倉庫直接可讀，Agent 擁有終端執行全部能力',
  aboutCap2: '你電腦上的 Claude Code / Codex / Cursor 已經夠強。\nArtifact OS 做的是把它們接進完整設計工作流',
  ...
  testiPre: '來自全球，',
  testiMid: ' 貢獻者',
  testiPost: '正在一起打造 Artifact OS',
  newsTitle: 'Artifact OS 訂閱',
...
const ja: HomeExtra = {
  ...
  heroSub:
    'Artifact OS はオープンソースでローカルな vibe design workspace——すでに使っているコーディングエージェントを設計エンジンに変え、アイデアからプロトタイプ、Web、スライド、HTML 動画まで、すべて自分のマシン上で完結します。\nエージェントネイティブ、21 のコーディングエージェント、{systems} のデザインシステム、Apache-2.0。',
  aboutKicker: 'なぜ Artifact OS なのか？',
  aboutStatement:
    'Artifact OS はオープンソースで agentic な vibe design workspace です。すでに使っているコーディングエージェントを、成果物が完全に自分のものになる設計エンジンに変えます。LLM が初めて本当に設計できる——コピーではなく本物の設計——と証明したとき、その能力はクローズドでホスト型、モデル固定でした。Artifact OS はそれを開きます：ローカル、BYOK、Apache-2.0。',
  ...
  labsPost: ' で何が作れる？',
  labsLead:
    'プロトタイプ、ランディングページ、スライド、ダッシュボード、ブランド／デザインシステム、さらに HTML 動画まで。Artifact OS はそれぞれを実際に動くファイルに変換し、自分の coding agent で駆動、そのまま納品や開発への引き継ぎができます。',
  methodTitle: '21+ のコーディングエージェントを設定ゼロで接続',
  ctaTitle: '最先端の AI デザイン能力を、すべての作り手の手元へ',
  testiPre: '世界中から、',
  testiMid: ' 人のコントリビューター',
  testiPost: 'が一緒に Artifact OS を作っています',
  newsTitle: 'Artifact OS ニュースレター',
  newsDesc:
    '新しいテンプレート、デザインシステムの更新、アンバサダーイベント、プロダクトの最新情報を、あなたの受信箱へ直接お届けします。',
  newsBtn: '購読する',
  newsDone: 'ご登録ありがとうございます！',
  faqTitle: 'Artifact OS のよくある質問 — オープンソース・ローカルファースト・Claude Design 代替',
  footProduct: '製品',
...
const ko: HomeExtra = {
  ...
  heroSub:
    'Artifact OS는 오픈소스이자 로컬로 동작하는 vibe design workspace입니다——이미 사용 중인 코딩 에이전트를 디자인 엔진으로 바꿔, 아이디어에서 프로토타입, 웹, 슬라이드, HTML 비디오까지 전 과정을 내 컴퓨터에서 끝냅니다.\n에이전트 네이티브, 21개 코딩 에이전트, {systems}개 디자인 시스템, Apache-2.0.',
  aboutKicker: '왜 Artifact OS인가?',
  aboutStatement:
    'Artifact OS은 오픈소스이자 agentic한 vibe design workspace입니다. 이미 쓰는 코딩 에이전트를, 결과물이 온전히 내 것이 되는 디자인 엔진으로 바꿉니다. LLM이 처음으로 진짜 디자인을——카피가 아니라 실제 디자인을——해낼 수 있음을 증명했을 때, 그 능력은 폐쇄적이고 호스팅형이며 모델에 묶여 있었습니다. Artifact OS은 그것을 엽니다: 로컬, BYOK, Apache-2.0.',
  aboutTab1: '데스크톱 네이티브',
  ...
  labsLead:
    '프로토타입, 랜딩 페이지, 슬라이드, 대시보드, 브랜드 및 디자인 시스템, 그리고 HTML 비디오까지. Artifact OS은 각각을 실제로 실행되는 파일로 만들며, 내 coding agent로 구동해 바로 배포하거나 엔지니어링에 넘길 수 있습니다.',
  methodTitle: '21개 이상의 코딩 에이전트를 설정 없이 연결',
  ctaTitle: '최첨단 AI 디자인 역량을 모든 창작자의 책상으로',
  testiPre: '전 세계에서, ',
  testiMid: '명의 기여자',
  testiPost: '가 함께 Artifact OS을 만들고 있습니다',
  newsTitle: 'Artifact OS 뉴스레터',
  newsDesc:
    '새 템플릿, 디자인 시스템 업데이트, 앰배서더 이벤트, 제품 소식을 받은편지함으로 바로 보내드립니다.',
  newsBtn: '구독',
  newsDone: '구독해 주셔서 감사합니다!',
  faqTitle: 'Artifact OS FAQ — 오픈소스, 로컬 우선, Claude Design 대안',
  footProduct: '제품',
  footCommunity: '커뮤니티',
  footLegal: '법적 고지',
  footPartners: '파트너',
...
const de: HomeExtra = {
  ...
  heroSub:
    'Artifact OS ist der quelloffene, lokale vibe design workspace — er verwandelt die Coding-Agents, die du bereits nutzt, in eine Design-Engine, die dich von der Idee bis zu Prototyp, Web, Slides und HTML-Video bringt, alles auf deinem eigenen Rechner.\nAgent-native, mit 21 Coding-Agents, {systems} Design-Systemen und Apache-2.0-Lizenz.',
  aboutKicker: 'Warum Artifact OS?',
  aboutStatement:
    'Artifact OS ist der quelloffene, agentische Vibe Design Workspace – er verwandelt den Coding-Agent, den du bereits nutzt, in eine Design-Engine, deren Ergebnisse ganz dir gehören. Als ein LLM erstmals bewies, dass es wirklich gestalten kann – echte Designarbeit, nicht nur Text –, kam diese Fähigkeit geschlossen, gehostet und modellgebunden. Artifact OS öffnet sie: lokal, BYOK, Apache-2.0.',
  ...
  labsPost: ' erstellen?',
  labsLead:
    'Prototypen, Landingpages, Slides, Dashboards, Marken- und Design-Systeme – sogar HTML-Video. Artifact OS macht daraus echte, lauffähige Dateien, angetrieben von deinem eigenen Coding-Agent, bereit zum Ausliefern oder zur Übergabe an die Entwicklung.',
  ...
  testiPost: 'gemeinsam an Artifact OS',
  ...
  faqTitle: 'Artifact OS FAQ – Open Source, lokal und Claude-Design-Alternative',
  footProduct: 'Produkt',
  footCommunity: 'Community',
...
const fr: HomeExtra = {
  ...
  heroSub:
    'Artifact OS est le vibe design workspace open source et local — il transforme les agents de code que vous utilisez déjà en moteur de design, de l’idée au prototype, au web, aux slides et à la vidéo HTML, le tout sur votre propre machine.\nAgent-native, avec 21 agents de code, {systems} design systems et une licence Apache-2.0.',
  aboutKicker: 'Pourquoi Artifact OS ?',
  aboutStatement:
    'Artifact OS est le vibe design workspace open source et agentique — il transforme l’agent de code que vous utilisez déjà en un moteur de design dont vous possédez entièrement le résultat. Quand un LLM a prouvé pour la première fois qu’il pouvait vraiment concevoir — du vrai design, pas juste du texte —, cette capacité est arrivée fermée, hébergée et verrouillée à un modèle. Artifact OS l’ouvre : local, BYOK, Apache-2.0.',
  ...
  labsPost: ' ?',
  labsLead:
    'Prototypes, landing pages, slides, dashboards, systèmes de marque et de design — et même vidéo HTML. Artifact OS transforme chacun en fichiers réels et exécutables, pilotés par votre propre agent de code, prêts à livrer ou à transmettre à l’ingénierie.',
  ...
  testiPost: 'construisent Artifact OS ensemble',
  newsTitle: 'La newsletter Artifact OS',
  newsDesc:
  ...
  faqTitle: 'FAQ Artifact OS — open source, local-first et alternative à Claude Design',
  footProduct: 'Produit',
...
const ru: HomeExtra = {
  ...
  heroSub:
    'Artifact OS — это открытый локальный vibe design workspace: он превращает кодинг-агентов, которыми вы уже пользуетесь, в движок дизайна, ведущий от идеи к прототипу, вебу, слайдам и HTML-видео — всё на вашей машине.\nAgent-native, 21 кодинг-агент, {systems} дизайн-систем, лицензия Apache-2.0.',
  aboutKicker: 'Почему Artifact OS?',
  aboutStatement:
    'Artifact OS — это открытый, агентный vibe design workspace: он превращает кодинг-агента, которым вы уже пользуетесь, в движок дизайна, результат которого полностью принадлежит вам. Когда LLM впервые доказал, что действительно умеет проектировать — настоящий дизайн, а не просто текст, — эта способность пришла закрытой, облачной и привязанной к модели. Artifact OS открывает её: локально, BYOK, Apache-2.0.',
  ...
  labsPost: '?',
  labsLead:
    'Прототипы, лендинги, слайды, дашборды, бренд- и дизайн-системы — и даже HTML-видео. Artifact OS превращает каждый в реальные рабочие файлы на вашем кодинг-агенте, готовые к сдаче или передаче разработке.',
  ...
  testiMid: ' участников',
  testiPost: 'вместе создают Artifact OS',
  newsTitle: 'Рассылка Artifact OS',
  newsDesc:
  ...
  faqTitle: 'FAQ Artifact OS — open source, локальный и альтернатива Claude Design',
  footProduct: 'Продукт',
...
const es: HomeExtra = {
  ...
  heroSub:
    'Artifact OS es el vibe design workspace open source y local: convierte los agentes de código que ya usas en un motor de diseño que te lleva de la idea al prototipo, la web, las slides y el vídeo HTML, todo en tu propia máquina.\nAgent-native, con 21 agentes de código, {systems} design systems y licencia Apache-2.0.',
  aboutKicker: '¿Por qué Artifact OS?',
  aboutStatement:
    'Artifact OS es el vibe design workspace open source y agéntico: convierte el agente de código que ya usas en un motor de diseño cuyo resultado es totalmente tuyo. Cuando un LLM demostró por primera vez que podía diseñar de verdad —diseño real, no solo texto—, esa capacidad llegó cerrada, alojada y atada a un modelo. Artifact OS la abre: local, BYOK, Apache-2.0.',
  ...
  labsPost: '?',
  labsLead:
    'Prototipos, landing pages, slides, dashboards, sistemas de marca y de diseño — incluso vídeo HTML. Artifact OS convierte cada uno en archivos reales y ejecutables, impulsados por tu propio agente de código, listos para entregar o pasar a ingeniería.',
  ...
  testiPost: 'construyen Artifact OS juntos',
  newsTitle: 'La newsletter de Artifact OS',
  newsDesc:
  ...
  faqTitle: 'FAQ de Artifact OS — open source, local-first y alternativa a Claude Design',
...
const ptBr: HomeExtra = {
  ...
  heroSub:
    'Artifact OS é o vibe design workspace open source e local: transforma os agentes de código que você já usa em um motor de design que vai da ideia ao protótipo, web, slides e vídeo HTML, tudo na sua própria máquina.\nAgent-native, com 21 agentes de código, {systems} design systems e licença Apache-2.0.',
  aboutKicker: 'Por que Artifact OS?',
  aboutStatement:
    'O Artifact OS é o vibe design workspace open source e agêntico: transforma o coding agent que você já usa em um motor de design cujo resultado é totalmente seu. Quando um LLM provou pela primeira vez que sabia projetar de verdade — design real, não só texto —, essa capacidade chegou fechada, hospedada e presa a um modelo. O Artifact OS a abre: local, BYOK, Apache-2.0.',
  ...
  labsPost: '?',
  labsLead:
    'Protótipos, landing pages, slides, dashboards, sistemas de marca e de design — até vídeo HTML. O Artifact OS transforma cada um em arquivos reais e executáveis, movidos pelo seu próprio coding agent, prontos para entregar ou repassar à engenharia.',
  ...
  testiMid: ' colaboradores',
  testiPost: 'constroem o Artifact OS juntos',
  newsTitle: 'A newsletter do Artifact OS',
  newsDesc:
  ...
  faqTitle: 'FAQ do Artifact OS — open source, local-first e alternativa ao Claude Design',
  footProduct: 'Produto',
...
const it: HomeExtra = {
  ...
  heroSub:
    'Artifact OS è il vibe design workspace open source e locale: trasforma i coding agent che già usi in un motore di design che ti porta dall’idea al prototipo, al web, alle slide e al video HTML, tutto sulla tua macchina.\nAgent-native, con 21 coding agent, {systems} design system e licenza Apache-2.0.',
  aboutKicker: 'Perché Artifact OS?',
  aboutStatement:
    'Artifact OS è il vibe design workspace open source e agentico: trasforma il coding agent che già usi in un motore di design il cui risultato è interamente tuo. Quando un LLM ha dimostrato per la prima volta di saper progettare davvero — vero design, non solo testo —, quella capacità è arrivata chiusa, ospitata e legata a un modello. Artifact OS la apre: locale, BYOK, Apache-2.0.',
  ...
  labsPost: '?',
  labsLead:
    'Prototipi, landing page, slide, dashboard, sistemi di marca e di design — persino video HTML. Artifact OS trasforma ciascuno in file reali ed eseguibili, guidati dal tuo coding agent, pronti da consegnare o passare all’ingegneria.',
  ...
  testiPost: 'costruiscono Artifact OS insieme',
  newsTitle: 'La newsletter di Artifact OS',
  newsDesc:
  ...
  faqTitle: 'FAQ di Artifact OS — open source, local-first e alternativa a Claude Design',
...
const vi: HomeExtra = {
  ...
  aboutKicker: 'Vì sao chọn Artifact OS?',
  aboutStatement:
    'Tháng 4 năm 2026, Claude Design lần đầu chứng minh rằng LLM có thể thực sự thiết kế — không phải viết chữ, mà tạo ra sản phẩm thiết kế thật. Nhưng nó đóng mã nguồn, trả phí và chỉ chạy trên đám mây, khóa vào mô hình Anthropic — không đổi agent, không self-host, không BYOK. Artifact OS mở khả năng đó ra.',
  ...
  aboutCap2:
    'Claude Code / Codex / Cursor trên máy bạn đã đủ mạnh.\nArtifact OS kết nối chúng vào một quy trình thiết kế hoàn chỉnh.',
  ...
  testiPost: 'đang cùng xây dựng Artifact OS',
  newsTitle: 'Bản tin Artifact OS',
  newsDesc:
...
const pl: HomeExtra = {
  ...
  testiPost: 'wspólnie buduje Artifact OS',
  newsTitle: 'Newsletter Artifact OS',
  newsDesc:
...
const id: HomeExtra = {
  ...
  aboutKicker: 'Mengapa Artifact OS?',
  aboutStatement:
    'Pada April 2026, Claude Design pertama kali membuktikan bahwa LLM benar-benar bisa mendesain — bukan menulis teks, melainkan menghasilkan karya desain nyata. Tapi ia tertutup, berbayar, dan hanya cloud, terkunci pada model Anthropic — tanpa ganti agen, tanpa self-hosting, tanpa BYOK. Artifact OS membuka kemampuan itu.',
  ...
  aboutCap2:
    'Claude Code / Codex / Cursor di mesin Anda sudah cukup kuat.\nArtifact OS menyambungkannya ke alur desain yang lengkap.',
  ...
  testiPost: 'membangun Artifact OS bersama',
  newsTitle: 'Newsletter Artifact OS',
  newsDesc:
...
const nl: HomeExtra = {
  ...
  aboutKicker: 'Waarom Artifact OS?',
  aboutStatement:
    'In april 2026 bewees Claude Design voor het eerst dat een LLM echt kan ontwerpen — geen teksten schrijven, maar echt designwerk maken. Maar het is closed-source, betaald en alleen cloud, vastgezet op Anthropic-modellen — geen agent wisselen, geen self-hosting, geen BYOK. Artifact OS opent die mogelijkheid.',
  aboutTab1: 'Desktop-native',
  ...
  testiMid: ' bijdragers',
  testiPost: 'samen aan Artifact OS',
  newsTitle: 'De Artifact OS-nieuwsbrief',
  newsDesc:
...
const ar: HomeExtra = {
  ...
  aboutKicker: 'لماذا Artifact OS؟',
  aboutStatement:
    'في أبريل 2026، أثبت Claude Design لأول مرة أن نموذج اللغة يمكنه التصميم فعلاً — لا كتابة النصوص، بل إنتاج عمل تصميمي حقيقي. لكنه مغلق المصدر ومدفوع وسحابي فقط، مقيّد بنماذج Anthropic — لا تبديل للوكيل، ولا استضافة ذاتية، ولا BYOK. يفتح Artifact OS هذه القدرة.',
  ...
  testiMid: ' مساهماً',
  testiPost: 'يبنون Artifact OS معاً',
  newsTitle: 'نشرة Artifact OS البريدية',
  newsDesc:
...
const tr: HomeExtra = {
  ...
  heroSub:
    'Artifact OS, açık kaynaklı ve yerel çalışan vibe design workspace’tir — hâlihazırda kullandığın kodlama ajanlarını, fikirden prototipe, web’e, slaytlara ve HTML videoya kadar her şeyi kendi makinende tamamlayan bir tasarım motoruna dönüştürür.\nAgent-native; 21 kodlama ajanı, {systems} tasarım sistemi ve Apache-2.0 lisansı.',
  aboutKicker: 'Neden Artifact OS?',
  aboutStatement:
    'Artifact OS, açık kaynaklı ve agentic bir vibe design workspace’tir: hâlihazırda kullandığın kodlama ajanını, çıktısı tamamen sana ait olan bir tasarım motoruna dönüştürür. Bir LLM ilk kez gerçekten tasarlayabildiğini — metin değil, gerçek tasarım — kanıtladığında, bu yetenek kapalı, barındırılan ve modele kilitli geldi. Artifact OS onu açar: yerel, BYOK, Apache-2.0.',
  ...
  labsLead:
    'Prototipler, açılış sayfaları, slaytlar, dashboardlar, marka ve tasarım sistemleri — hatta HTML video. Artifact OS her birini kendi kodlama ajanınla çalışan gerçek, çalıştırılabilir dosyalara dönüştürür; teslime ya da mühendisliğe devretmeye hazır.',
  ...
  testiMid: ' katkıcı',
  testiPost: 'birlikte Artifact OS’ı inşa ediyor',
  newsTitle: 'Artifact OS bülteni',
  newsDesc:
  ...
  faqTitle: 'Artifact OS SSS — açık kaynak, yerel öncelikli ve Claude Design alternatifi',
  footProduct: 'Ürün',
...
const uk: HomeExtra = {
  ...
  aboutKicker: 'Чому Artifact OS?',
  aboutStatement:
    'У квітні 2026 року Claude Design уперше довів, що LLM може справді проєктувати — не писати тексти, а створювати реальну дизайн-роботу. Але він закритий, платний і лише в хмарі, прив’язаний до моделей Anthropic — без зміни агента, без self-hosting, без BYOK. Artifact OS відкриває цю можливість.',
  ...
  testiMid: ' учасників',
  testiPost: 'разом будують Artifact OS',
  newsTitle: 'Розсилка Artifact OS',
  newsDesc:
