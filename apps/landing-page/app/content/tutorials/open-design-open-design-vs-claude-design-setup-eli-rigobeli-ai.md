...
This is the standout workflow. You don't have to write a deck from scratch — feed Artifact OS content you already have:
...
3. Paste that into Artifact OS and send. It runs a short **discovery** pass (audience, visual tone — e.g. "editorial magazine," animation level) and a **visual direction**, then builds.
...
![A real prototype generated in Artifact OS.](/tutorials/open-design-open-design-vs-claude-design-setup-eli-rigobeli-ai/generated-prototype.webp)
*A real generated prototype rendered in the preview — Artifact OS also builds full interactive pages, not just decks.*

## Step 3 — More inputs: sketches, references, and Claude Design ZIPs

Artifact OS accepts several starting points beyond a text prompt:
...
- **Claude Design ZIP import** — already have a design system in Claude Design? Export it as a ZIP, import it, and Artifact OS builds new artifacts that follow your existing tokens and brand.

![The HyperFrames motion and video gallery in Artifact OS.](/tutorials/open-design-open-design-vs-claude-design-setup-eli-rigobeli-ai/motion-gallery.webp)
...
**Can Artifact OS make presentations, not just web pages?**
