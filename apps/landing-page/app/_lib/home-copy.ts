...
const en: HomeCopy = {
  ...
  aboutCaptionCredit: '(Artifact OS, MMXXVI)',
  ...
  testimonialQuotePre: '“Artifact OS helped us turn vague',
...
const zhCN: Partial<HomeCopy> = {
  ...
  testimonialQuotePre: '“Artifact OS 帮我们把模糊的',
...
const ja: Partial<HomeCopy> = {
  ...
  testimonialQuotePre: '「Artifact OS は私たちの曖昧な',
...
const ko: Partial<HomeCopy> = {
  ...
  testimonialQuotePre: '"Artifact OS 은 우리의 모호한',
...
const zhTW: Partial<HomeCopy> = {
  ...
  testimonialLabel: '合作者 · Nº 06',
  testimonialQuotePre: '「Artifact OS 幫我們把模糊的',
  testimonialQuoteEm1: 'AI 想法',
...
const de: Partial<HomeCopy> = {
  ...
  testimonialQuotePre: '„Artifact OS hat uns geholfen, vage',
...
const fr: Partial<HomeCopy> = {
  ...
  testimonialQuotePre: '« Artifact OS nous a aidés à transformer de vagues',
...
const esES: Partial<HomeCopy> = {
  ...
  testimonialQuotePre: '«Artifact OS nos ayudó a convertir',
...
const ptBR: Partial<HomeCopy> = {
  ...
  testimonialLabel: 'Colaboradores · Nº 06',
  testimonialQuotePre: '"O Artifact OS nos ajudou a transformar',
