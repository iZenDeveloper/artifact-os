...
> = {
  fr: homeFallbackCopy({
    railRight: 'Artifact OS — vol. 01 · no 26 · Apache-2.0',
    railLeft: 'Skills · systèmes · agents · BYOK · local d’abord',
    discordAria: 'Rejoindre le Discord Artifact OS',
    ...
    heroLead: (skills, systems) =>
      `Artifact OS est l’alternative officielle, local-first, à Claude Design. Votre agent de code — Claude Code, Codex, Cursor, Gemini, OpenCode ou Qwen — devient un moteur de design avec ${skills} skills composables et ${systems} systèmes DESIGN.md portables.`,
    ...
    officialAria: 'Source officielle Artifact OS',
    ...
    about: {
      ...
      caption: 'Études de forme · perception · imagination machinique. (Artifact OS, MMXXVI)',
    },
    capabilities: {
    ...
    work: {
      ...
      editedBy: 'Édité par Artifact OS',
    ...
    testimonial: {
      ...
      quote: '« Artifact OS a transformé des idées IA floues en un système visuel net, crédible et réellement nouveau. »',
  ...
  ru: homeFallbackCopy({
    railRight: 'Artifact OS — том 01 · выпуск № 26 · Apache-2.0',
    railLeft: 'Skills · системы · агенты · BYOK · local-first',
    discordAria: 'Присоединиться к Discord Artifact OS',
    ...
    heroLead: (skills, systems) =>
      `Artifact OS — официальная local-first альтернатива Claude Design. Ваш coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode или Qwen — становится дизайн-движком с ${skills} составными skills и ${systems} переносимыми DESIGN.md-системами.`,
    ...
    officialAria: 'Официальный источник Artifact OS',
    ...
    about: {
      ...
      caption: 'Исследования формы · восприятия · машинного воображения. (Artifact OS, MMXXVI)',
    },
    capabilities: {
    ...
    testimonial: {
      ...
      label: 'Соавторы',
      quote: '«Artifact OS помог превратить расплывчатые AI-идеи в четкую, надежную и действительно новую визуальную систему.»',
  ...
  es: homeFallbackCopy({
    railRight: 'Artifact OS — vol. 01 · número 26 · Apache-2.0',
    railLeft: 'Skills · sistemas · agentes · BYOK · local-first',
    discordAria: 'Unirse al Discord de Artifact OS',
    ...
    heroLead: (skills, systems) =>
      `Artifact OS es la alternativa oficial, local-first, a Claude Design. Tu agente de código — Claude Code, Codex, Cursor, Gemini, OpenCode o Qwen — se convierte en un motor de diseño con ${skills} skills componibles y ${systems} sistemas DESIGN.md portables.`,
    ...
    officialAria: 'Fuente oficial de Artifact OS',
    ...
    about: {
      ...
      caption: 'Estudios de forma · percepción · imaginación maquínica. (Artifact OS, MMXXVI)',
    },
    capabilities: {
    ...
    work: {
      ...
      editedBy: 'Editado por Artifact OS',
    ...
    testimonial: {
      ...
      label: 'Colaboradores',
      quote: '«Artifact OS convirtió ideas de IA borrosas en un sistema visual nítido, creíble y realmente nuevo.»',
  ...
  'pt-br': homeFallbackCopy({
    railRight: 'Artifact OS — vol. 01 · edição nº 26 · Apache-2.0',
    railLeft: 'Skills · sistemas · agentes · BYOK · local-first',
    discordAria: 'Entrar no Discord do Artifact OS',
    ...
    heroLead: (skills, systems) =>
      `Artifact OS é a alternativa oficial, local-first, ao Claude Design. Seu agente de código — Claude Code, Codex, Cursor, Gemini, OpenCode ou Qwen — vira um motor de design com ${skills} skills componíveis e ${systems} sistemas DESIGN.md portáteis.`,
    ...
    officialAria: 'Fonte oficial do Artifact OS',
    ...
    about: {
      ...
      caption: 'Estudos de forma · percepção · imaginação maquínica. (Artifact OS, MMXXVI)',
    },
    capabilities: {
      rule: 'Capacidades · skills · sistemas',
    ...
    testimonial: {
      ...
      label: 'Colaboradores',
      quote: '“Artifact OS transformou ideias vagas de IA em um sistema visual nítido, confiável e realmente novo.”',
  ...
  it: homeFallbackCopy({
    railRight: 'Artifact OS — vol. 01 · numero 26 · Apache-2.0',
    railLeft: 'Skill · sistemi · agenti · BYOK · local-first',
    discordAria: 'Entra nel Discord di Artifact OS',
    ...
    heroLead: (skills, systems) =>
      `Artifact OS è l’alternativa ufficiale, local-first, a Claude Design. Il tuo agente di codice — Claude Code, Codex, Cursor, Gemini, OpenCode o Qwen — diventa un motore di design con ${skills} skill componibili e ${systems} sistemi DESIGN.md portabili.`,
    ...
    officialAria: 'Fonte ufficiale Artifact OS',
    ...
    about: {
      ...
      caption: 'Studi di forma · percezione · immaginazione macchinica. (Artifact OS, MMXXVI)',
    },
    capabilities: {
    ...
    work: {
      ...
      editedBy: 'Redazione Artifact OS',
    ...
    testimonial: {
      ...
      label: 'Collaboratori',
      quote: '“Artifact OS ha trasformato idee AI vaghe in un sistema visivo nitido, credibile e davvero nuovo.”',
  ...
  vi: homeFallbackCopy({
    railRight: 'Artifact OS — tập 01 · số 26 · Apache-2.0',
    railLeft: 'Skill · hệ thống · agent · BYOK · ưu tiên local',
    discordAria: 'Tham gia Discord Artifact OS',
    ...
    heroLead: (skills, systems) =>
      `Artifact OS là lựa chọn chính thức, ưu tiên local, thay Claude Design. Agent viết code bạn đang dùng — Claude Code, Codex, Cursor, Gemini, OpenCode hoặc Qwen — trở thành engine thiết kế với ${skills} skill có thể ghép và ${systems} hệ DESIGN.md di động.`,
    ...
    officialAria: 'Nguồn chính thức của Artifact OS',
    ...
    about: {
      ...
      caption: 'Nghiên cứu hình thái · tri giác · tưởng tượng máy. (Artifact OS, MMXXVI)',
    },
    capabilities: {
    ...
    work: {
      ...
      editedBy: 'Biên tập bởi Artifact OS',
    ...
    testimonial: {
      ...
      label: 'Cộng tác viên',
      quote: '“Artifact OS biến ý tưởng AI mơ hồ thành một hệ thị giác sắc nét, đáng tin và thật sự mới.”',
  ...
  pl: homeFallbackCopy({
    railRight: 'Artifact OS — tom 01 · wydanie nr 26 · Apache-2.0',
    railLeft: 'Skills · systemy · agenci · BYOK · lokalnie najpierw',
    discordAria: 'Dołącz do Discorda Artifact OS',
    ...
    heroLead: (skills, systems) =>
      `Artifact OS to oficjalna, lokalna z założenia alternatywa dla Claude Design. Twój agent do kodu — Claude Code, Codex, Cursor, Gemini, OpenCode albo Qwen — staje się silnikiem designu z ${skills} kompozycyjnymi skills i ${systems} przenośnymi systemami DESIGN.md.`,
    ...
    officialAria: 'Oficjalne źródło Artifact OS',
    ...
    about: {
      ...
      caption: 'Studia formy · percepcji · wyobraźni maszynowej. (Artifact OS, MMXXVI)',
    },
    capabilities: {
    ...
    testimonial: {
      ...
      quote: '„Artifact OS zmienił niejasne idee AI w ostry, wiarygodny i naprawdę nowy system wizualny.”',
  ...
  id: homeFallbackCopy({
    railRight: 'Artifact OS — vol. 01 · edisi nº 26 · Apache-2.0',
    railLeft: 'Skill · sistem · agent · BYOK · local-first',
    discordAria: 'Bergabung ke Discord Artifact OS',
    ...
    heroLead: (skills, systems) =>
      `Artifact OS adalah alternatif resmi, local-first, untuk Claude Design. Agent coding yang sudah Anda pakai — Claude Code, Codex, Cursor, Gemini, OpenCode, atau Qwen — menjadi mesin desain dengan ${skills} skill komposable dan ${systems} sistem DESIGN.md portabel.`,
    ...
    officialAria: 'Sumber resmi Artifact OS',
    ...
    about: {
      ...
      caption: 'Studi bentuk · persepsi · imajinasi mesin. (Artifact OS, MMXXVI)',
    },
    capabilities: {
    ...
    work: {
      ...
      editedBy: 'Disunting Artifact OS',
      label: 'Karya pilihan',
    ...
    testimonial: {
      ...
      label: 'Kolaborator',
      quote: '“Artifact OS mengubah ide AI yang samar menjadi sistem visual yang tajam, dapat dipercaya, dan benar-benar baru.”',
  ...
  nl: homeFallbackCopy({
    railRight: 'Artifact OS — deel 01 · nummer 26 · Apache-2.0',
    railLeft: 'Skills · systemen · agents · BYOK · local-first',
    discordAria: 'Word lid van Artifact OS Discord',
    ...
    heroLead: (skills, systems) =>
      `Artifact OS is het officiële local-first alternatief voor Claude Design. Je bestaande code-agent — Claude Code, Codex, Cursor, Gemini, OpenCode of Qwen — wordt een design-engine met ${skills} combineerbare skills en ${systems} draagbare DESIGN.md-systemen.`,
    ...
    officialAria: 'Officiële bron van Artifact OS',
    ...
    about: {
      ...
      caption: 'Studies naar vorm · perceptie · machinale verbeelding. (Artifact OS, MMXXVI)',
    },
    capabilities: {
    ...
    testimonial: {
      ...
      label: 'Samenwerkers',
      quote: '“Artifact OS veranderde vage AI-ideeën in een scherp, geloofwaardig en echt nieuw visueel systeem.”',
  ...
  ar: homeFallbackCopy({
    railRight: 'Artifact OS — المجلد 01 · العدد 26 · Apache-2.0',
    railLeft: 'Skills · أنظمة · Agents · BYOK · محلي أولاً',
    discordAria: 'الانضمام إلى Discord الخاص بـ Artifact OS',
    ...
    heroLead: (skills, systems) =>
      `Artifact OS هو البديل الرسمي المحلي أولاً لـ Claude Design. يتحول agent البرمجة الذي تستخدمه — Claude Code أو Codex أو Cursor أو Gemini أو OpenCode أو Qwen — إلى محرك تصميم يعتمد على ${skills} skills قابلة للتركيب و ${systems} أنظمة DESIGN.md قابلة للنقل.`,
    ...
    officialAria: 'المصدر الرسمي لـ Artifact OS',
    ...
    about: {
      ...
      caption: 'دراسات في الشكل · الإدراك · الخيال الآلي. (Artifact OS, MMXXVI)',
    },
    capabilities: {
    ...
    testimonial: {
      ...
      label: 'المتعاونون',
      quote: '“حوّل Artifact OS أفكار AI الغامضة إلى نظام بصري حاد وموثوق وجديد فعلاً.”',
    ...
    faqSection: {
      ...
      label: 'أسئلة Artifact OS الشائعة',
  ...
  tr: homeFallbackCopy({
    railRight: 'Artifact OS — cilt 01 · sayı nº 26 · Apache-2.0',
    railLeft: 'Skill · sistem · agent · BYOK · local-first',
    discordAria: 'Artifact OS Discord’a katıl',
    ...
    heroLead: (skills, systems) =>
      `Artifact OS, Claude Design’ın resmi local-first alternatifidir. Kullandığın coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode veya Qwen — ${skills} birleştirilebilir skill ve ${systems} taşınabilir DESIGN.md sistemiyle bir tasarım motoruna dönüşür.`,
    ...
    officialAria: 'Artifact OS resmi kaynağı',
    ...
    about: {
      ...
      caption: 'Form · algı · makine imgelemi çalışmaları. (Artifact OS, MMXXVI)',
    },
    capabilities: {
    ...
    work: {
      ...
      editedBy: 'Artifact OS editörlüğü',
    ...
    testimonial: {
      ...
      label: 'İşbirlikçiler',
      quote: '“Artifact OS belirsiz AI fikirlerini keskin, güvenilir ve gerçekten yeni bir görsel sisteme dönüştürdü.”',
  ...
  uk: homeFallbackCopy({
    railRight: 'Artifact OS — том 01 · випуск № 26 · Apache-2.0',
    railLeft: 'Skills · системи · агенти · BYOK · local-first',
    discordAria: 'Приєднатися до Discord Artifact OS',
    ...
    heroLead: (skills, systems) =>
      `Artifact OS — офіційна local-first альтернатива Claude Design. Ваш coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode або Qwen — стає design engine із ${skills} composable skills та ${systems} portable DESIGN.md systems.`,
    ...
    officialAria: 'Офіційне джерело Artifact OS',
    ...
    about: {
      ...
      caption: 'Дослідження форми · сприйняття · машинної уяви. (Artifact OS, MMXXVI)',
    },
    capabilities: {
    ...
    testimonial: {
      ...
      label: 'Співтворці',
      quote: '«Artifact OS допоміг перетворити нечіткі AI-ідеї на гостру, надійну й справді нову візуальну систему.»',
