...
# od-contribute — first-contribution flow for Artifact OS
...
- The user wants to *generate* a Skill / Design System from scratch → that's Artifact OS itself. Run OD first, get an artifact, then come back here to ship it.
