...
## Current Artifact OS scope

Artifact OS currently ships this entry as discovery metadata only. If this `SKILL.md`
...
If those upstream files are not installed, explain that Artifact OS only has the
catalog entry for this skill and ask whether to continue with Artifact OS's
