...
## Artifact OS orchestration mode

When this skill is invoked inside Artifact OS, treat it as the design-flow
...
3. Search across every available Artifact OS resource, not only this skill:
