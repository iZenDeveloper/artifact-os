# Artifact OS Web Clipper — Privacy Policy

_Last updated: 2026-06-16_

**Short version: the Artifact OS Web Clipper does not collect, store, or transmit
your data to us or to any third party. Everything you clip goes only to the
Artifact OS app running on your own computer.**
...
viewing and sends it to the Artifact OS application running locally on your own
...
Nothing. The developer (Artifact OS / nexu-io) operates **no servers** that
...
- **Access to websites you clip (`<all_urls>`)** — to read and screenshot the
  ...
  reach your local Artifact OS app. The extension acts only on the page you
...
- **Context menus** — the right-click "Save image to Artifact OS Library" entry.
...
All captured content is stored by the Artifact OS app in its local Library on your
