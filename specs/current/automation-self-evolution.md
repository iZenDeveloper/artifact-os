...
Automations should become the product-wide loop that lets Artifact OS improve
...
Artifact OS becomes a self-evolving design agent when every useful run can
