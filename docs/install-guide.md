...
Deploy Artifact OS on Linux or macOS with a single command. The installer wraps the existing Docker Compose stack — no build step required.
...
[open-design] Starting Artifact OS...
