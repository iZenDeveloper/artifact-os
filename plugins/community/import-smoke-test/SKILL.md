...
description: A portable community plugin for validating Artifact OS plugin import flows.
---

# Community Import Smoke Test

Use this plugin when validating that Artifact OS can import community plugins
