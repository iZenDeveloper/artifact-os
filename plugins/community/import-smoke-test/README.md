...
A small community plugin for exercising the Artifact OS import UI. It is meant
...
Artifact OS should install the plugin as a user/community plugin, preserve the
