...
**v2.2 add-on** (see `content-repurposer` SKILL): strategy block + **ready-to-post** fields are ship gates alongside this craft bar.

**MVP output scope:** text + visual direction + script — **not** rendered video. See `mvp-output-scope.md`. TikTok “peak 10/10” means a **described, filmable peak frame** + shot list, not an MP4.
...
## 1. Nguyên tắc chung (mọi platform)

| Rule | Standard |
|------|----------|
| **Hook ≤ 1–2s / first line** | **Shock, extreme curiosity, or tension** — not a flat fact |
| **Spine** | Core idea → Proof → **Insight with drama** → **CTA with offer** |
| **Story &gt; Fact list** | Facts only fail. Must feel like a story with stakes |
| **Emotion** | Reader feels surprise / awe / recognition — not just “interesting” |
| **Insight depth** | Not a slogan. Must be **applicable** (life / business / nature lesson with teeth) |
| **Tone** | Active Brand DESIGN.md **§8 Voice & Tone** (see `brand-voice.md`). Personal Minimal = clean + trustworthy — **still allowed to punch**. Clean ≠ weak |
| **Length** | Shorter than you think |
| **CTA** | Keyword **+ concrete value** (series, PDF, next 5 facts, checklist…) |
| **Visual** | High contrast + **one strong focal accent** — clean but not “safe boring” |

### Flat-hook ban (auto-fail)

These patterns **fail QA** even if factually correct:

- “X has Y interesting facts”  
- “Did you know X has Z?” with no twist  
- Stating the fact without **cost / death / trade-off / contradiction**  
- Soft academic tone on cover  

**Rewrite pattern (required):**  
`[Unexpected fact] + [cost / almost-death / paradox] + [open loop]`

**Examples of pass-level hooks:**

| Weak (fail) | Strong (pass) |
|-------------|----------------|
| “Bạch tuộc có 3 trái tim” | “3 trái tim… và 1 trái **gần như chết** mỗi khi bơi” |
| “Octopuses have three hearts” | “This animal has three hearts. When it swims… one heart **almost shuts off**.” |

### Storytelling mandate

Every pack must answer:

1. What is at **stake**?  
2. What is the **paradox / trade-off**?  
3. What does the audience **do differently** after the insight?  
...
| Layer | Required |
|-------|----------|
| Keyword / action | e.g. comment `BẠCH TUỘC`, reply `SERIES` |
| **Offer** | Concrete deliverable: “mình gửi ngay 5 fact tiếp theo” / PDF / checklist / part-2 link |
| Why now | One line of value |

Vague CTAs fail: “Follow for more”, “Like if you agree” (as sole CTA).

### Visual (clean ≠ boring)

| Requirement | Detail |
|-------------|--------|
| Hierarchy | One dominant headline; secondary line max |
| Focal accent | One high-contrast accent moment (not all-muted UI) |
| Negative space | Yes — but leave room for **one dramatic visual** |
| B-roll / collage | **Mandatory shot list** for video; optional collage direction for XHS |
| Motion notes | Pulse, freeze, slow-mo, cut-on-impact — not “nice stock clip” |

**Collage / B-roll direction template (always fill for TikTok; recommend for XHS):**

- Palette / mood (e.g. underwater dark, teal blood, ink black)  
- Hero motion (heart pulsing → almost stop)  
- Texture (grain, water caustics, paper tear if collage)  
- Cut rhythm (beat every 3–5s)  
- Forbidden: generic flat diagrams, stock handshake, random AI mush  
...
## 3. TikTok — target ≥ 8.5 (viral-ready)
...
## 5. Threads — target ≥ 8.0

| Spec | Pro standard |
|------|----------------|
| Format | **4–8** posts |
| P1 | Strongest hook (same bar as TikTok/XHS) |
| Body | 1–3 sentences; chain with tension |
| End | Clear CTA + offer |
| North star | Replies |
...
| Spec | Pro standard |
|------|----------------|
| Subject | **4–8 words**, curiosity/benefit; **3–4 variants** (at least one paradox-led) |
| Body | **120–250 words**; story → insight → **one** primary offer CTA |
| Design | Mobile-first; one strong accent |
| North star | Open + click |

---

## 7. HTML pack deliverable requirements
...
## 8. Universal QA gate (all must pass)

### A. Hook

- [ ] Cover / first line would **stop a stranger mid-scroll**  
...
- [ ] Keyword **and** concrete offer  
- [ ] User knows what they get by commenting/following  
...
## 8b. Polish freeze (blocking — regression residual)

Previously “minor”; now **ship blockers** for flagship + regression suite:

| Gate | Fail | Pass |
|------|------|------|
| **P1 Caption length** | Long tail after CTA; double soft CTAs | After offer line ≤2 short supports (prefer 0) |
| **P2 Peak specificity** | “Cinematic B-roll”, “stock”, “illustrative chart” | Named subject + action + camera + freeze; unique to pack |
| **P3 Hook lab parity** | Personal-brand lab weaker than business/science | ≥3 strong pairs; primary on C1 or TT 0–3s |

Full checklist: `pre-ship-qa.md`. Suite: `regression-suite.md`.
