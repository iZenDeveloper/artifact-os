---
name: od-default
description: Hidden fallback scenario for free-form Home prompts. Ask the task type first, then continue through the matching Artifact OS flow.
od:
...
{
  "lang": "en",
  "description": "I will route the free-form prompt through the right Artifact OS workflow.",
  "questions": [
    {
      "id": "taskType",
...
- `Other`: ask only the minimum follow-up needed, then choose the closest
  Artifact OS workflow and continue.
