...
The Artifact OS skill bundle (`SKILL.md`, `example.html`, `assets/template.html`,
and references in this folder) is contributed under Artifact OS's repository
