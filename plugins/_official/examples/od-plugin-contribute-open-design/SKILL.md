...
description: Open a pull request adding a local Artifact OS plugin to the Artifact OS community catalog using gh CLI.
triggers:
  - contribute plugin
  - open design pr
  - github pull request
...
# Contribute Plugin to Artifact OS

Use this workflow when the active project contains a copied plugin folder and the user wants to propose it for the Artifact OS community catalog.
...
Keep the pull request focused. Do not modify unrelated Artifact OS files unless a manifest validation issue requires a tiny supporting change.
