  ...
  return {
    ...
    platforms: {
      mac: {
        arch: "arm64",
        artifacts: {
          dmg: artifact("Artifact OS.dmg"),
          zip: artifact("Artifact OS-mac-arm64.zip"),
        },
        enabled: true,
        signed: true,
      },
      macIntel: {
        arch: "x64",
        artifacts: {
          dmg: artifact("Artifact OS Intel.dmg"),
          zip: artifact("Artifact OS-mac-x64.zip"),
        },
        enabled: true,
        signed: true,
      },
      win: {
        arch: "x64",
        artifacts: {
          installer: artifact("Artifact OS Setup.exe"),
        },
        enabled: true,
      },
    },
